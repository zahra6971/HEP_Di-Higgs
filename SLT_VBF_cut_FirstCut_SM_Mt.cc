...
void SLT_VBF_cut_FirstCut_SM_Mt(){
  ...
  string smp_names[n_smp] = { "SM_H", "diboson", "DY", "Fake", "Zll", "W", "Ztautau1", "singletop", "ttbar", "VBF.hh_bbtt_vbf_lh_l1cvv1cv1." };
  ...
  string h_titles[n_smp] = { "SM H", "diboson", "DY", "Fake", "Z", "Wl#nu", "Z#tau#tau", "single top", "ttbar", "VBFSM x 255613.527" };  // only for legend
  ...
  string hist_draw[n_smp];
    ...
    TCut factor = "255613.527";
    TCut mMMC = "mMMC<160000";
    TCut mBB = "mBB>70000";
    TCut dRHH = "dRHH>1.2";
    TCut dEtaLepTau = "abs(TauEta-LepEta)<1.8";
    TCut MtW = "MtW<110000";
    TCut Mhh = "Mhh>290000";
    TCut Mvis = "Mvis<120000";
    TCut dEtaBB = "dEtaBB<2.4";
    ...
    for (int k=0;k<n_cut1;k++) {
      ...
      h_hist[9]->SetLineColor(kRed); h_hist[9]->SetMarkerColor(kRed); //VBFSM
      ...
      for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut1_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut1_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut1_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut1_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut1_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut1_1[k]), "SAMEHIST");} //VBFSM
        }
    ...
    TH1F *h11 = new TH1F("h11","Quadratic Sum from left",40,0,2000); //left
     ...
     float Sum_l_1 = 0;
      ...
      for (int j=1; j<=40; j++) {
         ...
         S_l_1 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    TH1F *h12 = new TH1F("h12","Quadratic Sum from right",40,0,2000); //right
     ...
     float Sum_r_1 = 0;
      ...
      for (int j=40; j>=1; j--) {
        ...
        S_r_1 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut2_2[n_cut2] = { "dEtaHBB>0.2", "dEtaHBB>0.4", "dEtaHBB>0.6", "dEtaHBB>0.8", "dEtaHBB>1 ", "dEtaHBB>1.2", "dEtaHBB>1.4", "dEtaHBB>1.6", "dEtaHBB>1.8", "dEtaHBB>2", "dEtaHBB>2.2", "dEtaHBB>2.4", "dEtaHBB>2.6", "dEtaHBB>2.8", "dEtaHBB>3", "dEtaHBB>3.2", "dEtaHBB>3.4", "dEtaHBB>3.6", "dEtaHBB>3.8", "dEtaHBB>4", "dEtaHBB>4.2", "dEtaHBB>4.4", "dEtaHBB>4.6","dEtaHBB>4.8", "dEtaHBB>5",  "dEtaHBB>5.2" };
      ...
      for (int k=0;k<n_cut2;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut2_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut2_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut2_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut2_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut2_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut2_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h21 = new TH1F("h21","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_2 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_2 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h22 = new TH1F("h22","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_2 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_2 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut3_2[n_cut3] = { "dEtaLepTau<0.2", "dEtaLepTau<0.4", "dEtaLepTau<0.6", "dEtaLepTau<0.8", "dEtaLepTau<1 ", "dEtaLepTau<1.2", "dEtaLepTau<1.4", "dEtaLepTau<1.6", "dEtaLepTau<1.8", "dEtaLepTau<2", "dEtaLepTau<2.2", "dEtaLepTau<2.4", "dEtaLepTau<2.6", "dEtaLepTau<2.8", "dEtaLepTau<3", "dEtaLepTau<3.2", "dEtaLepTau<3.4", "dEtaLepTau<3.6", "dEtaLepTau<3.8", "dEtaLepTau<4", "dEtaLepTau<4.2", "dEtaLepTau<4.4", "dEtaLepTau<4.6","dEtaLepTau<4.8" };
      ...
      for (int k=0;k<n_cut3;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut3_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut3_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut3_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut3_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut3_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut3_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h31 = new TH1F("h31","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_3 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_3 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h32 = new TH1F("h32","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_3 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_3 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut4_2[n_cut4] = { "dEtaVBFjj>1 ", "dEtaVBFjj>1.2", "dEtaVBFjj>1.4", "dEtaVBFjj>1.6", "dEtaVBFjj>1.8", "dEtaVBFjj>2", "dEtaVBFjj>2.2", "dEtaVBFjj>2.4", "dEtaVBFjj>2.6", "dEtaVBFjj>2.8", "dEtaVBFjj>3", "dEtaVBFjj>3.2", "dEtaVBFjj>3.4", "dEtaVBFjj>3.6", "dEtaVBFjj>3.8", "dEtaVBFjj>4", "dEtaVBFjj>4.2", "dEtaVBFjj>4.4", "dEtaVBFjj>4.6","dEtaVBFjj>4.8", "dEtaVBFjj>5", "dEtaVBFjj>5.2", "dEtaVBFjj>5.4", "dEtaVBFjj>5.6", "dEtaVBFjj>5.8", "dEtaVBFjj>6" };
      ...
      for (int k=0;k<n_cut4;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut4_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut4_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut4_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut4_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut4_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut4_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h41 = new TH1F("h41","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_4 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_4 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h42 = new TH1F("h42","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_4 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_4 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut5_2[n_cut5] = { "dPhiBB<0.2", "dPhiBB<0.4", "dPhiBB<0.6", "dPhiBB<0.8", "dPhiBB<1", "dPhiBB<1.2", "dPhiBB<1.4", "dPhiBB<1.6", "dPhiBB<1.8", "dPhiBB<2", "dPhiBB<2.2", "dPhiBB<2.4", "dPhiBB<2.6", "dPhiBB<2.8", "dPhiBB<3", "dPhiBB<3.2" };
      ...
      for (int k=0;k<n_cut5;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut5_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut5_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut5_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut5_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut5_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut5_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h51 = new TH1F("h51","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_5 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_5 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h52 = new TH1F("h52","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_5 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_5 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut6_2[n_cut6] = { "dPhiHBB>0.2", "dPhiHBB>0.4", "dPhiHBB>0.6", "dPhiHBB>0.8", "dPhiHBB>1", "dPhiHBB>1.2", "dPhiHBB>1.4", "dPhiHBB>1.6", "dPhiHBB>1.8", "dPhiHBB>2", "dPhiHBB>2.2", "dPhiHBB>2.4", "dPhiHBB>2.6", "dPhiHBB>2.8", "dPhiHBB>3", "dPhiHBB>3.2" };
      ...
      for (int k=0;k<n_cut6;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut6_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut6_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut6_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut6_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut6_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut6_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h61 = new TH1F("h61","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_6 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_6 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h62 = new TH1F("h62","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_6 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_6 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut7_2[n_cut7] = { "dPhiHbbMET>0.2", "dPhiHbbMET>0.4", "dPhiHbbMET>0.6", "dPhiHbbMET>0.8", "dPhiHbbMET>1", "dPhiHbbMET>1.2", "dPhiHbbMET>1.4", "dPhiHbbMET>1.6", "dPhiHbbMET>1.8", "dPhiHbbMET>2", "dPhiHbbMET>2.2", "dPhiHbbMET>2.4", "dPhiHbbMET>2.6", "dPhiHbbMET>2.8", "dPhiHbbMET>3", "dPhiHbbMET>3.2" };
      ...
      for (int k=0;k<n_cut7;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut7_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut7_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut7_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut7_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut7_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut7_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h71 = new TH1F("h71","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_7 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_7 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h72 = new TH1F("h72","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_7 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_7 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut8_2[n_cut8] = { "dPhiHttMET<0.2", "dPhiHttMET<0.4", "dPhiHttMET<0.6", "dPhiHttMET<0.8", "dPhiHttMET<1", "dPhiHttMET<1.2", "dPhiHttMET<1.4", "dPhiHttMET<1.6", "dPhiHttMET<1.8", "dPhiHttMET<2", "dPhiHttMET<2.2", "dPhiHttMET<2.4", "dPhiHttMET<2.6", "dPhiHttMET<2.8", "dPhiHttMET<3", "dPhiHttMET<3.2" };
      ...
      for (int k=0;k<n_cut8;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut8_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut8_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut8_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut8_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut8_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut8_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h81 = new TH1F("h81","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_8 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_8 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h82 = new TH1F("h82","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_8 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_8 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut9_2[n_cut9] = { "dPhiLep0MET<0.2", "dPhiLep0MET<0.4", "dPhiLep0MET<0.6", "dPhiLep0MET<0.8", "dPhiLep0MET<1", "dPhiLep0MET<1.2", "dPhiLep0MET<1.4", "dPhiLep0MET<1.6", "dPhiLep0MET<1.8", "dPhiLep0MET<2", "dPhiLep0MET<2.2", "dPhiLep0MET<2.4", "dPhiLep0MET<2.6", "dPhiLep0MET<2.8", "dPhiLep0MET<3", "dPhiLep0MET<3.2" };
      ...
      for (int k=0;k<n_cut9;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut9_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut9_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut9_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut9_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut9_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut9_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h91 = new TH1F("h91","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_9 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_9 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h92 = new TH1F("h92","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_9 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_9 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut10_2[n_cut10] = { "dPhiLep1MET<0.2", "dPhiLep1MET<0.4", "dPhiLep1MET<0.6", "dPhiLep1MET<0.8", "dPhiLep1MET<1", "dPhiLep1MET<1.2", "dPhiLep1MET<1.4", "dPhiLep1MET<1.6", "dPhiLep1MET<1.8", "dPhiLep1MET<2", "dPhiLep1MET<2.2", "dPhiLep1MET<2.4", "dPhiLep1MET<2.6", "dPhiLep1MET<2.8", "dPhiLep1MET<3", "dPhiLep1MET<3.2" };
      ...
      for (int k=0;k<n_cut10;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut10_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut10_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut10_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut10_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut10_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut10_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h101 = new TH1F("h101","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_10 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_10 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h102 = new TH1F("h102","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_10 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_10 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut11_2[n_cut11] = { "abs(dPhiLepTau)<0.2", "abs(dPhiLepTau)<0.4", "abs(dPhiLepTau)<0.6", "abs(dPhiLepTau)<0.8", "abs(dPhiLepTau)<1", "abs(dPhiLepTau)<1.2", "abs(dPhiLepTau)<1.4", "abs(dPhiLepTau)<1.6", "abs(dPhiLepTau)<1.8", "abs(dPhiLepTau)<2", "abs(dPhiLepTau)<2.2", "abs(dPhiLepTau)<2.4", "abs(dPhiLepTau)<2.6", "abs(dPhiLepTau)<2.8", "abs(dPhiLepTau)<3", "abs(dPhiLepTau)<3.2" };
      ...
      for (int k=0;k<n_cut11;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut11_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut11_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut11_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut11_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut11_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut11_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h111 = new TH1F("h111","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_11 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_11 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h112 = new TH1F("h112","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_11 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_11 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut13_2[n_cut13] = { "dPtLepTau<10GeV", "dPtLepTau<20GeV", "dPtLepTau<30GeV", "dPtLepTau<40GeV", "dPtLepTau<50GeV", "dPtLepTau<60GeV", "dPtLepTau<70GeV", "dPtLepTau<80GeV", "dPtLepTau<90GeV", "dPtLepTau<100GeV", "dPtLepTau<110GeV", "dPtLepTau<120GeV", "dPtLepTau<130GeV", "dPtLepTau<140GeV", "dPtLepTau<150GeV", "dPtLepTau<160GeV", "dPtLepTau<170GeV", "dPtLepTau<180GeV", "dPtLepTau<190GeV","dPtLepTau<200GeV", "dPtLepTau<210GeV", "dPtLepTau<220GeV", "dPtLepTau<230GeV", "dPtLepTau<240GeV", "dPtLepTau<250GeV", "dPtLepTau<260GeV" };
      ...
      for (int k=0;k<n_cut13;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut13_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut13_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut13_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut13_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut13_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut13_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h131 = new TH1F("h131","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_13 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_13 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h132 = new TH1F("h132","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_13 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_13 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    const int n_cut14 = 26;
    TCut cut14_1[n_cut14] = { "dRB1J3<1 ", "dRB1J3<1.2", "dRB1J3<1.4", "dRB1J3<1.6", "dRB1J3<1.8", "dRB1J3<2", "dRB1J3<2.2", "dRB1J3<2.4", "dRB1J3<2.6", "dRB1J3<2.8", "dRB1J3<3", "dRB1J3<3.2", "dRB1J3<3.4", "dRB1J3<3.6", "dRB1J3<3.8", "dRB1J3<4", "dRB1J3<4.2", "dRB1J3<4.4", "dRB1J3<4.6","dRB1J3<4.8", "dRB1J3<5", "dRB1J3<5.2", "dRB1J3<5.4", "dRB1J3<5.6", "dRB1J3<5.8", "dRB1J3<6" };
    string cut14_2[n_cut14] = { "dRB1J3<1 ", "dRB1J3<1.2", "dRB1J3<1.4", "dRB1J3<1.6", "dRB1J3<1.8", "dRB1J3<2", "dRB1J3<2.2", "dRB1J3<2.4", "dRB1J3<2.6", "dRB1J3<2.8", "dRB1J3<3", "dRB1J3<3.2", "dRB1J3<3.4", "dRB1J3<3.6", "dRB1J3<3.8", "dRB1J3<4", "dRB1J3<4.2", "dRB1J3<4.4", "dRB1J3<4.6","dRB1J3<4.8", "dRB1J3<5", "dRB1J3<5.2", "dRB1J3<5.4", "dRB1J3<5.6", "dRB1J3<5.8", "dRB1J3<6" };
    

      TCanvas *canvas14[n_cut14] ;
      canvas14[0] = new TCanvas ("c0", "Mhh",980,580);
      canvas14[1] = new TCanvas ("c1", "Mhh",980,580);
      canvas14[2] = new TCanvas ("c2", "Mhh",980,580);
      canvas14[3] = new TCanvas ("c3", "Mhh",980,580);
      canvas14[4] = new TCanvas ("c4", "Mhh",980,580);
      canvas14[5] = new TCanvas ("c5", "Mhh",980,580);
      canvas14[6] = new TCanvas ("c6", "Mhh",980,580);
      canvas14[7] = new TCanvas ("c7", "Mhh",980,580);
      canvas14[8] = new TCanvas ("c8", "Mhh",980,580);
      canvas14[9] = new TCanvas ("c9", "Mhh",980,580);
      canvas14[10] = new TCanvas ("c10", "Mhh",980,580);
      canvas14[11] = new TCanvas ("c11", "Mhh",980,580);
      canvas14[12] = new TCanvas ("c12", "Mhh",980,580);
      canvas14[13] = new TCanvas ("c13", "Mhh",980,580);
      canvas14[14] = new TCanvas ("c14", "Mhh",980,580);
      canvas14[15] = new TCanvas ("c15", "Mhh",980,580);
      canvas14[16] = new TCanvas ("c16", "Mhh",980,580);
      canvas14[17] = new TCanvas ("c17", "Mhh",980,580);
      canvas14[18] = new TCanvas ("c18", "Mhh",980,580);
      canvas14[19] = new TCanvas ("c19", "Mhh",980,580);
      canvas14[20] = new TCanvas ("c20", "Mhh",980,580);
      canvas14[21] = new TCanvas ("c21", "Mhh",980,580);
      canvas14[22] = new TCanvas ("c22", "Mhh",980,580);
      canvas14[23] = new TCanvas ("c23", "Mhh",980,580);
      canvas14[24] = new TCanvas ("c24", "Mhh",980,580);
      canvas14[25] = new TCanvas ("c25", "Mhh",980,580);
    
      TPad *pad141[n_cut14];
      pad141[0] = new TPad ("pad0", "", 0,0,0.75,1);
      pad141[1] = new TPad ("pad1", "", 0,0,0.75,1);
      pad141[2] = new TPad ("pad2", "", 0,0,0.75,1);
      pad141[3] = new TPad ("pad3", "", 0,0,0.75,1);
      pad141[4] = new TPad ("pad4", "", 0,0,0.75,1);
      pad141[5] = new TPad ("pad5", "", 0,0,0.75,1);
      pad141[6] = new TPad ("pad6", "", 0,0,0.75,1);
      pad141[7] = new TPad ("pad7", "", 0,0,0.75,1);
      pad141[8] = new TPad ("pad8", "", 0,0,0.75,1);
      pad141[9] = new TPad ("pad9", "", 0,0,0.75,1);
      pad141[10] = new TPad ("pad10", "", 0,0,0.75,1);
      pad141[11] = new TPad ("pad11", "", 0,0,0.75,1);
      pad141[12] = new TPad ("pad12", "", 0,0,0.75,1);
      pad141[13] = new TPad ("pad13", "", 0,0,0.75,1);
      pad141[14] = new TPad ("pad14", "", 0,0,0.75,1);
      pad141[15] = new TPad ("pad15", "", 0,0,0.75,1);
      pad141[16] = new TPad ("pad16", "", 0,0,0.75,1);
      pad141[17] = new TPad ("pad17", "", 0,0,0.75,1);
      pad141[18] = new TPad ("pad18", "", 0,0,0.75,1);
      pad141[19] = new TPad ("pad19", "", 0,0,0.75,1);
      pad141[20] = new TPad ("pad20", "", 0,0,0.75,1);
      pad141[21] = new TPad ("pad21", "", 0,0,0.75,1);
      pad141[22] = new TPad ("pad22", "", 0,0,0.75,1);
      pad141[23] = new TPad ("pad23", "", 0,0,0.75,1);
      pad141[24] = new TPad ("pad24", "", 0,0,0.75,1);
      pad141[25] = new TPad ("pad25", "", 0,0,0.75,1);
    
      TPad *pad142[n_cut14];
      pad142[0] = new TPad ("pad0", "",0.73,0,1,1);
      pad142[1] = new TPad ("pad1", "",0.73,0,1,1);
      pad142[2] = new TPad ("pad2", "",0.73,0,1,1);
      pad142[3] = new TPad ("pad3", "",0.73,0,1,1);
      pad142[4] = new TPad ("pad4", "",0.73,0,1,1);
      pad142[5] = new TPad ("pad5", "",0.73,0,1,1);
      pad142[6] = new TPad ("pad6", "",0.73,0,1,1);
      pad142[7] = new TPad ("pad7", "",0.73,0,1,1);
      pad142[8] = new TPad ("pad8", "",0.73,0,1,1);
      pad142[9] = new TPad ("pad9", "",0.73,0,1,1);
      pad142[10] = new TPad ("pad10", "",0.73,0,1,1);
      pad142[11] = new TPad ("pad11", "",0.73,0,1,1);
      pad142[12] = new TPad ("pad12", "",0.73,0,1,1);
      pad142[13] = new TPad ("pad13", "",0.73,0,1,1);
      pad142[14] = new TPad ("pad14", "",0.73,0,1,1);
      pad142[15] = new TPad ("pad15", "",0.73,0,1,1);
      pad142[16] = new TPad ("pad16", "",0.73,0,1,1);
      pad142[17] = new TPad ("pad17", "",0.73,0,1,1);
      pad142[18] = new TPad ("pad18", "",0.73,0,1,1);
      pad142[19] = new TPad ("pad19", "",0.73,0,1,1);
      pad142[20] = new TPad ("pad20", "",0.73,0,1,1);
      pad142[21] = new TPad ("pad21", "",0.73,0,1,1);
      pad142[22] = new TPad ("pad22", "",0.73,0,1,1);
      pad142[23] = new TPad ("pad23", "",0.73,0,1,1);
      pad142[24] = new TPad ("pad24", "",0.73,0,1,1);
      pad142[25] = new TPad ("pad25", "",0.73,0,1,1);
      
      for (int k=0;k<n_cut14;k++) {
           canvas14[k]->cd();
           pad141[k]->Draw();
           pad142[k]->Draw();
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut14_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut14_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut14_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut14_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut14_1[k]),  "SAMEHIST");
        }
        
        THStack *hs14 = new THStack("hs14", "");
        for(int i= 0; i<9 ; i++){ hs14->Add(h_hist[i], "hist1"); }
        hs14->Draw("SAMEHIST");
      
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut14_1[k]), "SAMEHIST");} //VBFSM
        }

       //cout << " ============== significance From left ============== " << endl;
       //cout << " " << endl;
        
      TH1F *h141 = new TH1F("h141","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_14 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_14 = h_hist[9]->GetBinContent(j); //VBFSM
           //cout << " S of each bin = " << S_l_14 << endl;
           B_l_14_8 = h_hist[8]->GetBinContent(j);
           //cout << " B of ttbar of each bin = " << B_l_14_8 << endl;
           B_l_14_7 = h_hist[7]->GetBinContent(j);
           //cout << " B of single top of each bin = " << B_l_14_7 << endl;
           B_l_14_6 = h_hist[6]->GetBinContent(j);
           //cout << " B of Ztt of each bin = " << B_l_14_6 << endl;
           B_l_14_5 = h_hist[5]->GetBinContent(j);
           //cout << " B of Wlv of each bin = " << B_l_14_5 << endl;
           B_l_14_4 = h_hist[4]->GetBinContent(j);
           //cout << " B of Z of each bin = " << B_l_14_4 << endl;
           B_l_14_3 = h_hist[3]->GetBinContent(j);
           //cout << " B of Fake of each bin = " << B_l_14_3 << endl;
           ...
           float B_l_14 = 0;
           for(int i = 0; i<9; i++) { B_l_14 += h_hist[i]->GetBinContent(j); }
           ...
           h141->SetBinContent(j,QuadraticSum_l_14);
           h141->SetLineColor(kBlue-9);
           h141->SetLineStyle(2);
      ...
      TH1F *h142 = new TH1F("h142","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_14 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_14 = h_hist[9]->GetBinContent(j); //VBFSM
          //cout << " S of each bin = " << S_r_14 << endl;
          B_r_14_8 = h_hist[8]->GetBinContent(j);
          //cout << " B of ttbar of each bin = " << B_r_14_8 << endl;
          B_r_14_7 = h_hist[7]->GetBinContent(j);
          //cout << " B of single top of each bin = " << B_r_14_7 << endl;
          B_r_14_6 = h_hist[6]->GetBinContent(j);
          //cout << " B of Ztt of each bin = " << B_r_14_6 << endl;
          B_r_14_5 = h_hist[5]->GetBinContent(j);
          //cout << " B of Wlv of each bin = " << B_r_14_5 << endl;
          B_r_14_4 = h_hist[4]->GetBinContent(j);
          //cout << " B of Z of each bin = " << B_r_14_4 << endl;
          B_r_14_3 = h_hist[3]->GetBinContent(j);
          //cout << " B of Fake of each bin = " << B_r_14_3 << endl;
          ...
          float B_r_14 = 0;
          for(int i = 0; i<9; i++) { B_r_14 += h_hist[i]->GetBinContent(j); }
          ...
          h142->SetBinContent(j,QuadraticSum_r_14);
          h142->SetLineColor(kGreen-9);
          h142->SetLineStyle(2);
          
          //cout << " ************************************ " << endl;
       }
       
    float rightmax14 = 1.1*h141->GetMaximum();
    float scale14 = 5000 / rightmax14;
    h141->Scale(scale14);
    h141->Draw("SAMEHIST");
    ...
    TGaxis*axis14 = new TGaxis(2000,0,2000,5000,0,rightmax14,510,"+L");
    ...
    leg14->AddEntry(h141, "Quadratic Sum of #frac{S}{#sqrt{B}} from left");
    leg14->AddEntry(h142, "Quadratic Sum of #frac{S}{#sqrt{B}} from right");
    leg14->Draw();
        ...
        cout << "" << endl;
        cout << cut14_2[k] << endl;
        cout << "Mt =" << QuadraticSum_l_14 << endl;
        cout << "" << endl;
    ...
    const int n_cut15 = 26;
    TCut cut15_1[n_cut15] = { "dRB2J3<1 ", "dRB2J3<1.2", "dRB2J3<1.4", "dRB2J3<1.6", "dRB2J3<1.8", "dRB2J3<2", "dRB2J3<2.2", "dRB2J3<2.4", "dRB2J3<2.6", "dRB2J3<2.8", "dRB2J3<3", "dRB2J3<3.2", "dRB2J3<3.4", "dRB2J3<3.6", "dRB2J3<3.8", "dRB2J3<4", "dRB2J3<4.2", "dRB2J3<4.4", "dRB2J3<4.6","dRB2J3<4.8", "dRB2J3<5", "dRB2J3<5.2", "dRB2J3<5.4", "dRB2J3<5.6", "dRB2J3<5.8", "dRB2J3<6" };
    string cut15_2[n_cut15] = { "dRB2J3<1 ", "dRB2J3<1.2", "dRB2J3<1.4", "dRB2J3<1.6", "dRB2J3<1.8", "dRB2J3<2", "dRB2J3<2.2", "dRB2J3<2.4", "dRB2J3<2.6", "dRB2J3<2.8", "dRB2J3<3", "dRB2J3<3.2", "dRB2J3<3.4", "dRB2J3<3.6", "dRB2J3<3.8", "dRB2J3<4", "dRB2J3<4.2", "dRB2J3<4.4", "dRB2J3<4.6","dRB2J3<4.8", "dRB2J3<5", "dRB2J3<5.2", "dRB2J3<5.4", "dRB2J3<5.6", "dRB2J3<5.8", "dRB2J3<6" };
    

      TCanvas *canvas15[n_cut15] ;
      canvas15[0] = new TCanvas ("c0", "Mhh",980,580);
      canvas15[1] = new TCanvas ("c1", "Mhh",980,580);
      canvas15[2] = new TCanvas ("c2", "Mhh",980,580);
      canvas15[3] = new TCanvas ("c3", "Mhh",980,580);
      canvas15[4] = new TCanvas ("c4", "Mhh",980,580);
      canvas15[5] = new TCanvas ("c5", "Mhh",980,580);
      canvas15[6] = new TCanvas ("c6", "Mhh",980,580);
      canvas15[7] = new TCanvas ("c7", "Mhh",980,580);
      canvas15[8] = new TCanvas ("c8", "Mhh",980,580);
      canvas15[9] = new TCanvas ("c9", "Mhh",980,580);
      canvas15[10] = new TCanvas ("c10", "Mhh",980,580);
      canvas15[11] = new TCanvas ("c11", "Mhh",980,580);
      canvas15[12] = new TCanvas ("c12", "Mhh",980,580);
      canvas15[13] = new TCanvas ("c13", "Mhh",980,580);
      canvas15[14] = new TCanvas ("c14", "Mhh",980,580);
      canvas15[15] = new TCanvas ("c15", "Mhh",980,580);
      canvas15[16] = new TCanvas ("c16", "Mhh",980,580);
      canvas15[17] = new TCanvas ("c17", "Mhh",980,580);
      canvas15[18] = new TCanvas ("c18", "Mhh",980,580);
      canvas15[19] = new TCanvas ("c19", "Mhh",980,580);
      canvas15[20] = new TCanvas ("c20", "Mhh",980,580);
      canvas15[21] = new TCanvas ("c21", "Mhh",980,580);
      canvas15[22] = new TCanvas ("c22", "Mhh",980,580);
      canvas15[23] = new TCanvas ("c23", "Mhh",980,580);
      canvas15[24] = new TCanvas ("c24", "Mhh",980,580);
      canvas15[25] = new TCanvas ("c25", "Mhh",980,580);
    
      TPad *pad151[n_cut15];
      pad151[0] = new TPad ("pad0", "", 0,0,0.75,1);
      pad151[1] = new TPad ("pad1", "", 0,0,0.75,1);
      pad151[2] = new TPad ("pad2", "", 0,0,0.75,1);
      pad151[3] = new TPad ("pad3", "", 0,0,0.75,1);
      pad151[4] = new TPad ("pad4", "", 0,0,0.75,1);
      pad151[5] = new TPad ("pad5", "", 0,0,0.75,1);
      pad151[6] = new TPad ("pad6", "", 0,0,0.75,1);
      pad151[7] = new TPad ("pad7", "", 0,0,0.75,1);
      pad151[8] = new TPad ("pad8", "", 0,0,0.75,1);
      pad151[9] = new TPad ("pad9", "", 0,0,0.75,1);
      pad151[10] = new TPad ("pad10", "", 0,0,0.75,1);
      pad151[11] = new TPad ("pad11", "", 0,0,0.75,1);
      pad151[12] = new TPad ("pad12", "", 0,0,0.75,1);
      pad151[13] = new TPad ("pad13", "", 0,0,0.75,1);
      pad151[14] = new TPad ("pad14", "", 0,0,0.75,1);
      pad151[15] = new TPad ("pad15", "", 0,0,0.75,1);
      pad151[16] = new TPad ("pad16", "", 0,0,0.75,1);
      pad151[17] = new TPad ("pad17", "", 0,0,0.75,1);
      pad151[18] = new TPad ("pad18", "", 0,0,0.75,1);
      pad151[19] = new TPad ("pad19", "", 0,0,0.75,1);
      pad151[20] = new TPad ("pad20", "", 0,0,0.75,1);
      pad151[21] = new TPad ("pad21", "", 0,0,0.75,1);
      pad151[22] = new TPad ("pad22", "", 0,0,0.75,1);
      pad151[23] = new TPad ("pad23", "", 0,0,0.75,1);
      pad151[24] = new TPad ("pad24", "", 0,0,0.75,1);
      pad151[25] = new TPad ("pad25", "", 0,0,0.75,1);
    
      TPad *pad152[n_cut15];
      pad152[0] = new TPad ("pad0", "",0.73,0,1,1);
      pad152[1] = new TPad ("pad1", "",0.73,0,1,1);
      pad152[2] = new TPad ("pad2", "",0.73,0,1,1);
      pad152[3] = new TPad ("pad3", "",0.73,0,1,1);
      pad152[4] = new TPad ("pad4", "",0.73,0,1,1);
      pad152[5] = new TPad ("pad5", "",0.73,0,1,1);
      pad152[6] = new TPad ("pad6", "",0.73,0,1,1);
      pad152[7] = new TPad ("pad7", "",0.73,0,1,1);
      pad152[8] = new TPad ("pad8", "",0.73,0,1,1);
      pad152[9] = new TPad ("pad9", "",0.73,0,1,1);
      pad152[10] = new TPad ("pad10", "",0.73,0,1,1);
      pad152[11] = new TPad ("pad11", "",0.73,0,1,1);
      pad152[12] = new TPad ("pad12", "",0.73,0,1,1);
      pad152[13] = new TPad ("pad13", "",0.73,0,1,1);
      pad152[14] = new TPad ("pad14", "",0.73,0,1,1);
      pad152[15] = new TPad ("pad15", "",0.73,0,1,1);
      pad152[16] = new TPad ("pad16", "",0.73,0,1,1);
      pad152[17] = new TPad ("pad17", "",0.73,0,1,1);
      pad152[18] = new TPad ("pad18", "",0.73,0,1,1);
      pad152[19] = new TPad ("pad19", "",0.73,0,1,1);
      pad152[20] = new TPad ("pad20", "",0.73,0,1,1);
      pad152[21] = new TPad ("pad21", "",0.73,0,1,1);
      pad152[22] = new TPad ("pad22", "",0.73,0,1,1);
      pad152[23] = new TPad ("pad23", "",0.73,0,1,1);
      pad152[24] = new TPad ("pad24", "",0.73,0,1,1);
      pad152[25] = new TPad ("pad25", "",0.73,0,1,1);
      
      for (int k=0;k<n_cut15;k++) {
           canvas15[k]->cd();
           pad151[k]->Draw();
           pad152[k]->Draw();
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut15_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut15_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut15_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut15_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut15_1[k]),  "SAMEHIST");
        }
        
        THStack *hs15 = new THStack("hs15", "");
        for(int i= 0; i<9 ; i++){ hs15->Add(h_hist[i], "hist1"); }
        hs15->Draw("SAMEHIST");
      
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut15_1[k]), "SAMEHIST");} //VBFSM
        }

       //cout << " ============== significance From left ============== " << endl;
       //cout << " " << endl;
        
      TH1F *h151 = new TH1F("h151","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_15 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_15 = h_hist[9]->GetBinContent(j); //VBFSM
           //cout << " S of each bin = " << S_l_15 << endl;
           B_l_15_8 = h_hist[8]->GetBinContent(j);
           //cout << " B of ttbar of each bin = " << B_l_15_8 << endl;
           B_l_15_7 = h_hist[7]->GetBinContent(j);
           //cout << " B of single top of each bin = " << B_l_15_7 << endl;
           B_l_15_6 = h_hist[6]->GetBinContent(j);
           //cout << " B of Ztt of each bin = " << B_l_15_6 << endl;
           B_l_15_5 = h_hist[5]->GetBinContent(j);
           //cout << " B of Wlv of each bin = " << B_l_15_5 << endl;
           B_l_15_4 = h_hist[4]->GetBinContent(j);
           //cout << " B of Z of each bin = " << B_l_15_4 << endl;
           B_l_15_3 = h_hist[3]->GetBinContent(j);
           //cout << " B of Fake of each bin = " << B_l_15_3 << endl;
           ...
           float B_l_15 = 0;
           for(int i = 0; i<9; i++) { B_l_15 += h_hist[i]->GetBinContent(j); }
           ...
           h151->SetBinContent(j,QuadraticSum_l_15);
           h151->SetLineColor(kBlue-9);
           h151->SetLineStyle(2);
      ...
      TH1F *h152 = new TH1F("h152","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_15 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_15 = h_hist[9]->GetBinContent(j); //VBFSM
          //cout << " S of each bin = " << S_r_15 << endl;
          B_r_15_8 = h_hist[8]->GetBinContent(j);
          //cout << " B of ttbar of each bin = " << B_r_15_8 << endl;
          B_r_15_7 = h_hist[7]->GetBinContent(j);
          //cout << " B of single top of each bin = " << B_r_15_7 << endl;
          B_r_15_6 = h_hist[6]->GetBinContent(j);
          //cout << " B of Ztt of each bin = " << B_r_15_6 << endl;
          B_r_15_5 = h_hist[5]->GetBinContent(j);
          //cout << " B of Wlv of each bin = " << B_r_15_5 << endl;
          B_r_15_4 = h_hist[4]->GetBinContent(j);
          //cout << " B of Z of each bin = " << B_r_15_4 << endl;
          B_r_15_3 = h_hist[3]->GetBinContent(j);
          //cout << " B of Fake of each bin = " << B_r_15_3 << endl;
          ...
          float B_r_15 = 0;
          for(int i = 0; i<9; i++) { B_r_15 += h_hist[i]->GetBinContent(j); }
          ...
          h152->SetBinContent(j,QuadraticSum_r_15);
          h152->SetLineColor(kGreen-9);
          h152->SetLineStyle(2);
          
          //cout << " ************************************ " << endl;
       }
       
    float rightmax15 = 1.1*h151->GetMaximum();
    ...
    TGaxis*axis15 = new TGaxis(2000,0,2000,5000,0,rightmax15,510,"+L");
    ...
    leg15->AddEntry(h151, "Quadratic Sum of #frac{S}{#sqrt{B}} from left");
    leg15->AddEntry(h152, "Quadratic Sum of #frac{S}{#sqrt{B}} from right");
    leg15->Draw();
        ...
        cout << "" << endl;
        cout << cut15_2[k] << endl;
        cout << "Mt =" << QuadraticSum_l_15 << endl;
        cout << "" << endl;
    ...
    string cut16_2[n_cut16] = { "dRBB<1 ", "dRBB<1.2", "dRBB<1.4", "dRBB<1.6", "dRBB<1.8", "dRBB<2", "dRBB<2.2", "dRBB<2.4", "dRBB<2.6", "dRBB<2.8", "dRBB<3", "dRBB<3.2", "dRBB<3.4", "dRBB<3.6", "dRBB<3.8" };
      ...
      for (int k=0;k<n_cut16;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut16_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut16_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut16_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut16_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut16_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut16_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h161 = new TH1F("h161","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_16 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_16 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h162 = new TH1F("h162","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_16 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_16 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut17_2[n_cut17] = { "dRHH>1 ", "dRHH>1.2", "dRHH>1.4", "dRHH>1.6", "dRHH>1.8", "dRHH>2", "dRHH>2.2", "dRHH>2.4", "dRHH>2.6", "dRHH>2.8", "dRHH>3", "dRHH>3.2", "dRHH>3.4", "dRHH>3.6", "dRHH>3.8", "dRHH>4", "dRHH>4.2", "dRHH>4.4", "dRHH>4.6","dRHH>4.8", "dRHH>5", "dRHH>5.2", "dRHH>5.4", "dRHH>5.6", "dRHH>5.8", "dRHH>6" };
      ...
      for (int k=0;k<n_cut17;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut17_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut17_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut17_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut17_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut17_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut17_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h171 = new TH1F("h171","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_17 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_17 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h172 = new TH1F("h172","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_17 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_17 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut18_2[n_cut18] = { "dRLepTau<1 ", "dRLepTau<1.2", "dRLepTau<1.4", "dRLepTau<1.6", "dRLepTau<1.8", "dRLepTau<2", "dRLepTau<2.2", "dRLepTau<2.4", "dRLepTau<2.6", "dRLepTau<2.8", "dRLepTau<3", "dRLepTau<3.2", "dRLepTau<3.4", "dRLepTau<3.6", "dRLepTau<3.8", "dRLepTau<4", "dRLepTau<4.2", "dRLepTau<4.4", "dRLepTau<4.6","dRLepTau<4.8", "dRLepTau<5", "dRLepTau<5.2", "dRLepTau<5.4", "dRLepTau<5.6", "dRLepTau<5.8", "dRLepTau<6" };
      ...
      for (int k=0;k<n_cut18;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut18_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut18_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut18_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut18_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut18_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut18_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h181 = new TH1F("h181","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_18 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_18 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h182 = new TH1F("h182","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_18 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_18 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut19_2[n_cut19] = { "dRVBFjj>1 ", "dRVBFjj>1.2", "dRVBFjj>1.4", "dRVBFjj>1.6", "dRVBFjj>1.8", "dRVBFjj>2", "dRVBFjj>2.2", "dRVBFjj>2.4", "dRVBFjj>2.6", "dRVBFjj>2.8", "dRVBFjj>3", "dRVBFjj>3.2", "dRVBFjj>3.4", "dRVBFjj>3.6", "dRVBFjj>3.8", "dRVBFjj>4", "dRVBFjj>4.2", "dRVBFjj>4.4", "dRVBFjj>4.6","dRVBFjj>4.8", "dRVBFjj>5", "dRVBFjj>5.2", "dRVBFjj>5.4", "dRVBFjj>5.6", "dRVBFjj>5.8", "dRVBFjj>6" };
      ...
      for (int k=0;k<n_cut19;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut19_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut19_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut19_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut19_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut19_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut19_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h191 = new TH1F("h191","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_19 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_19 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h192 = new TH1F("h192","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_19 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_19 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut21_2[n_cut21] = { "abs(etaVBFj1)>0.2", "abs(etaVBFj1)>0.4", "abs(etaVBFj1)>0.6", "abs(etaVBFj1)>0.8", "abs(etaVBFj1)>1", "abs(etaVBFj1)>1.2", "abs(etaVBFj1)>1.4", "abs(etaVBFj1)>1.6", "abs(etaVBFj1)>1.8", "abs(etaVBFj1)>2", "abs(etaVBFj1)>2.2", "abs(etaVBFj1)>2.4", "abs(etaVBFj1)>2.6", "abs(etaVBFj1)>2.8", "abs(etaVBFj1)>3" };
      ...
      for (int k=0;k<n_cut21;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut21_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut21_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut21_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut21_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut21_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut21_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h211 = new TH1F("h211","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_21 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_21 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h212 = new TH1F("h212","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_21 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_21 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut24_2[n_cut24] = { "abs(etaVBFj2)>0.2", "abs(etaVBFj2)>0.4", "abs(etaVBFj2)>0.6", "abs(etaVBFj2)>0.8", "abs(etaVBFj2)>1", "abs(etaVBFj2)>1.2", "abs(etaVBFj2)>1.4", "abs(etaVBFj2)>1.6", "abs(etaVBFj2)>1.8", "abs(etaVBFj2)>2", "abs(etaVBFj2)>2.2", "abs(etaVBFj2)>2.4", "abs(etaVBFj2)>2.6", "abs(etaVBFj2)>2.8", "abs(etaVBFj2)>3" };
      ...
      for (int k=0;k<n_cut24;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut24_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut24_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut24_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut24_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut24_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut24_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h241 = new TH1F("h241","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_24 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_24 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h242 = new TH1F("h242","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_24 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_24 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut27_2[n_cut27] = { "HT>200GeV", "HT>210GeV", "HT>220GeV", "HT>230GeV", "HT>240GeV", "HT>250GeV", "HT>260GeV", "HT>270GeV", "HT>280GeV", "HT>290GeV", "HT>300GeV", "HT>310GeV", "HT>320GeV", "HT>330GeV", "HT>340GeV", "HT>350GeV", "HT>360GeV", "HT>370GeV", "HT>380GeV","HT>390GeV", "HT>400GeV", "HT>410GeV", "HT>420GeV", "HT>430GeV", "HT>440GeV", "HT>450GeV" };
      ...
      for (int k=0;k<n_cut27;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut27_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut27_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut27_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut27_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut27_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut27_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h271 = new TH1F("h271","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_27 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_27 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h272 = new TH1F("h272","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_27 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_27 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut28_2[n_cut28] = { "abs(LepEta)<0.2", "abs(LepEta)<0.4", "abs(LepEta)<0.6", "abs(LepEta)<0.8", "abs(LepEta)<1", "abs(LepEta)<1.2", "abs(LepEta)<1.4", "abs(LepEta)<1.6", "abs(LepEta)<1.8", "abs(LepEta)<2", "abs(LepEta)<2.2", "abs(LepEta)<2.4", "abs(LepEta)<2.6", "abs(LepEta)<2.8", "abs(LepEta)<3" };
      ...
      for (int k=0;k<n_cut28;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut28_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut28_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut28_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut28_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut28_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut28_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h281 = new TH1F("h281","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_28 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_28 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h282 = new TH1F("h282","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_28 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_28 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut31_2[n_cut31] = { "LepPhi>0.2", "LepPhi>0.4", "LepPhi>0.6", "LepPhi>0.8", "LepPhi>1", "LepPhi>1.2", "LepPhi>1.4", "LepPhi>1.6", "LepPhi>1.8", "LepPhi>2", "LepPhi>2.2", "LepPhi>2.4", "LepPhi>2.6", "LepPhi>2.8", "LepPhi>3" };
      ...
      for (int k=0;k<n_cut31;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut31_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut31_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut31_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut31_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut31_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut31_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h311 = new TH1F("h311","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_31 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_31 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h312 = new TH1F("h312","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_31 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_31 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut32_2[n_cut32] = { "LepPt<10GeV", "LepPt<20GeV", "LepPt<30GeV", "LepPt<40GeV", "LepPt<50GeV", "LepPt<60GeV", "LepPt<70GeV", "LepPt<80GeV", "LepPt<90GeV", "LepPt<100GeV", "LepPt<110GeV", "LepPt<120GeV", "LepPt<130GeV", "LepPt<140GeV", "LepPt<150GeV", "LepPt<160GeV", "LepPt<170GeV", "LepPt<180GeV", "LepPt<190GeV","LepPt<200GeV", "LepPt<210GeV", "LepPt<220GeV", "LepPt<230GeV", "LepPt<240GeV", "LepPt<250GeV", "LepPt<260GeV" };
      ...
      for (int k=0;k<n_cut32;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut32_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut32_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut32_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut32_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut32_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut32_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h321 = new TH1F("h321","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_32 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_32 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h322 = new TH1F("h322","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_32 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_32 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut33_2[n_cut33] = { "mBB>10GeV", "mBB>20GeV", "mBB>30GeV", "mBB>40GeV", "mBB>50GeV", "mBB>60GeV", "mBB>70GeV", "mBB>80GeV", "mBB>90GeV", "mBB>100GeV", "mBB>110GeV", "mBB>120GeV", "mBB>130GeV", "mBB>140GeV", "mBB>150GeV" };
      ...
      for (int k=0;k<n_cut33;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut33_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut33_1[k]),  "SAMEHIST");} //Wlv
          else if( i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut33_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut33_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut33_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut33_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h331 = new TH1F("h331","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_33 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_33 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h332 = new TH1F("h332","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_33 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_33 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut35_2[n_cut35] = { "MET>10GeV", "MET>20GeV", "MET>30GeV", "MET>40GeV", "MET>50GeV", "MET>60GeV", "MET>70GeV", "MET>80GeV", "MET>90GeV", "MET>100GeV", "MET>110GeV", "MET>120GeV", "MET>130GeV", "MET>140GeV", "MET>150GeV", "MET>160GeV", "MET>170GeV", "MET>180GeV", "MET>190GeV","MET>200GeV", "MET>210GeV", "MET>220GeV", "MET>230GeV", "MET>240GeV", "MET>250GeV", "MET>260GeV" };
      ...
      for (int k=0;k<n_cut35;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut35_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut35_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut35_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut35_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut35_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut35_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h351 = new TH1F("h351","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_35 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_35 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h352 = new TH1F("h352","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_35 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_35 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut36_2[n_cut36] = { "METCent>-1.5", "METCent>-1.3", "METCent>-1.1", "METCent>-0.9", "METCent>-0.7", "METCent>-0.5", "METCent>-0.3", "METCent>-0.1", "METCent>0.1", "METCent>0.3", "METCent>0.5", "METCent>0.7", "METCent>0.9", "METCent>1.1", "METCent>1.3" };
      ...
      for (int k=0;k<n_cut36;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut36_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut36_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut36_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut36_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut36_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut36_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h361 = new TH1F("h361","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_36 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_36 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h362 = new TH1F("h362","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_36 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_36 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut37_2[n_cut37] = { "mMMC<80GeV", "mMMC<90GeV", "mMMC<100GeV", "mMMC<110GeV", "mMMC<120GeV", "mMMC<130GeV", "mMMC<140GeV", "mMMC<150GeV", "mMMC<160GeV", "mMMC<170GeV", "mMMC<180GeV", "mMMC<190GeV","mMMC<200GeV" };
      ...
      for (int k=0;k<n_cut37;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut37_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut37_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut37_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut37_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut37_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut37_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h371 = new TH1F("h371","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_37 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_37 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h372 = new TH1F("h372","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_37 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_37 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut38_2[n_cut38] = { "Mhh>200GeV", "Mhh>210GeV", "Mhh>220GeV", "Mhh>230GeV", "Mhh>240GeV", "Mhh>250GeV", "Mhh>260GeV", "Mhh>270GeV", "Mhh>280GeV", "Mhh>290GeV", "Mhh>300GeV", "Mhh>310GeV", "Mhh>320GeV", "Mhh>330GeV", "Mhh>340GeV", "Mhh>350GeV", "Mhh>360GeV", "Mhh>370GeV", "Mhh>380GeV", "Mhh>390GeV", "Mhh>400GeV", "Mhh>410GeV", "Mhh>420GeV", "Mhh>430GeV", "Mhh>440GeV", "Mhh>450GeV" };
      ...
      for (int k=0;k<n_cut38;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut38_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut38_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut38_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut38_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut38_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut38_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h381 = new TH1F("h381","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_38 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_38 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h382 = new TH1F("h382","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_38 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_38 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut39_2[n_cut39] = { "MT2>10GeV", "MT2>110GeV", "MT2>120GeV", "MT2>130GeV", "MT2>140GeV", "MT2>150GeV", "MT2>160GeV", "MT2>170GeV", "MT2>180GeV", "MT2>190GeV", "MT2>200GeV", "MT2>210GeV", "MT2>220GeV", "MT2>230GeV", "MT2>240GeV", "MT2>250GeV", "MT2>260GeV", "MT2>270GeV", "MT2>280GeV", "MT2>290GeV", "MT2>300GeV", "MT2>310GeV", "MT2>320GeV", "MT2>330GeV" };
      ...
      for (int k=0;k<n_cut39;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut39_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut39_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut39_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut39_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut39_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut39_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h391 = new TH1F("h391","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_39 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_39 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h392 = new TH1F("h392","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_39 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_39 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut40_2[n_cut40] = { "MtW<30GeV", "MtW<40GeV", "MtW<50GeV", "MtW<60GeV", "MtW<70GeV", "MtW<80GeV", "MtW<90GeV", "MtW<100GeV", "MtW<110GeV", "MtW<120GeV", "MtW<130GeV", "MtW<140GeV", "MtW<150GeV", "MtW<160GeV", "MtW<170GeV", "MtW<180GeV", "MtW<190GeV","MtW<200GeV", "MtW<210GeV", "MtW<220GeV", "MtW<230GeV", "MtW<240GeV", "MtW<250GeV", "MtW<260GeV" };
      ...
      for (int k=0;k<n_cut40;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut40_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut40_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut40_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut40_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut40_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut40_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h401 = new TH1F("h401","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_40 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_40 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h402 = new TH1F("h402","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_40 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_40 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut41_2[n_cut41] = { "mVBFjj>50GeV", "mVBFjj>100GeV", "mVBFjj>150GeV", "mVBFjj>200GeV", "mVBFjj>250GeV", "mVBFjj>300GeV", "mVBFjj>350GeV", "mVBFjj>400GeV", "mVBFjj>450GeV", "mVBFjj>500GeV", "mVBFjj>550GeV", "mVBFjj>600GeV", "mVBFjj>650GeV", "mVBFjj>700GeV", "mVBFjj>750GeV", "mVBFjj>800GeV", "mVBFjj>850GeV", "mVBFjj>900GeV", "mVBFjj>950GeV","mVBFjj>1000GeV", "mVBFjj>1050GeV", "mVBFjj>1100GeV", "mVBFjj>1150GeV", "mVBFjj>1200GeV", "mVBFjj>1250GeV", "mVBFjj>1300GeV" };
      ...
      for (int k=0;k<n_cut41;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut41_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut41_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut41_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut41_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut41_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut41_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h411 = new TH1F("h411","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_41 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_41 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h412 = new TH1F("h412","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_41 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_41 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut42_2[n_cut42] = { "Mvis<10GeV", "Mvis<20GeV", "Mvis<30GeV", "Mvis<40GeV", "Mvis<50GeV", "Mvis<60GeV", "Mvis<70GeV", "Mvis<80GeV", "Mvis<90GeV", "Mvis<100GeV", "Mvis<110GeV", "Mvis<120GeV", "Mvis<130GeV", "Mvis<140GeV", "Mvis<150GeV", "Mvis<160GeV", "Mvis<170GeV", "Mvis<180GeV", "Mvis<190GeV","Mvis<200GeV", "Mvis<210GeV", "Mvis<220GeV", "Mvis<230GeV", "Mvis<240GeV", "Mvis<250GeV", "Mvis<260GeV" };
      ...
      for (int k=0;k<n_cut42;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut42_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut42_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut42_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut42_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut42_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut42_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h421 = new TH1F("h421","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_42 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_42 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h422 = new TH1F("h422","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_42 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_42 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut43_2[n_cut43] = { "Mw>10GeV", "Mw>20GeV", "Mw>30GeV", "Mw>40GeV", "Mw>50GeV", "Mw>60GeV", "Mw>70GeV", "Mw>80GeV", "Mw>90GeV", "Mw>100GeV", "Mw>110GeV", "Mw>120GeV", "Mw>130GeV", "Mw>140GeV", "Mw>150GeV", "Mw>160GeV", "Mw>170GeV", "Mw>180GeV", "Mw>190GeV","Mw>200GeV", "Mw>210GeV", "Mw>220GeV", "Mw>230GeV", "Mw>240GeV", "Mw>250GeV", "Mw>260GeV" };
      ...
      for (int k=0;k<n_cut43;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut43_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut43_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut43_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut43_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut43_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut43_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h431 = new TH1F("h431","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_43 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_43 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h432 = new TH1F("h432","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_43 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_43 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    const int n_cut44 = 31;
    TCut cut44_1[n_cut44] = { "phiVBFj1<-3", "phiVBFj1<-2.8", "phiVBFj1<-2.6", "phiVBFj1<-2.4", "phiVBFj1<-2.2", "phiVBFj1<-2", "phiVBFj1<-1.8", "phiVBFj1<-1.6", "phiVBFj1<-1.4", "phiVBFj1<-1.2", "phiVBFj1<-1", "phiVBFj1<-0.8", "phiVBFj1<-0.6", "phiVBFj1<-0.4", "phiVBFj1<-0.2", "phiVBFj1<0", "phiVBFj1<0.2", "phiVBFj1<0.4", "phiVBFj1<0.6", "phiVBFj1<0.8", "phiVBFj1<1", "phiVBFj1<1.2", "phiVBFj1<1.4", "phiVBFj1<1.6", "phiVBFj1<1.8", "phiVBFj1<2", "phiVBFj1<2.2", "phiVBFj1<2.4", "phiVBFj1<2.6", "phiVBFj1<2.8", "phiVBFj1<3" };
    string cut44_2[n_cut44] = { "phiVBFj1<-3", "phiVBFj1<-2.8", "phiVBFj1<-2.6", "phiVBFj1<-2.4", "phiVBFj1<-2.2", "phiVBFj1<-2", "phiVBFj1<-1.8", "phiVBFj1<-1.6", "phiVBFj1<-1.4", "phiVBFj1<-1.2", "phiVBFj1<-1", "phiVBFj1<-0.8", "phiVBFj1<-0.6", "phiVBFj1<-0.4", "phiVBFj1<-0.2", "phiVBFj1<0", "phiVBFj1<0.2", "phiVBFj1<0.4", "phiVBFj1<0.6", "phiVBFj1<0.8", "phiVBFj1<1", "phiVBFj1<1.2", "phiVBFj1<1.4", "phiVBFj1<1.6", "phiVBFj1<1.8", "phiVBFj1<2", "phiVBFj1<2.2", "phiVBFj1<2.4", "phiVBFj1<2.6", "phiVBFj1<2.8", "phiVBFj1<3" };
    

      TCanvas *canvas44[n_cut44] ;
      canvas44[0] = new TCanvas ("c0", "Mhh",980,580);
      canvas44[1] = new TCanvas ("c1", "Mhh",980,580);
      canvas44[2] = new TCanvas ("c2", "Mhh",980,580);
      canvas44[3] = new TCanvas ("c3", "Mhh",980,580);
      canvas44[4] = new TCanvas ("c4", "Mhh",980,580);
      canvas44[5] = new TCanvas ("c5", "Mhh",980,580);
      canvas44[6] = new TCanvas ("c6", "Mhh",980,580);
      canvas44[7] = new TCanvas ("c7", "Mhh",980,580);
      canvas44[8] = new TCanvas ("c8", "Mhh",980,580);
      canvas44[9] = new TCanvas ("c9", "Mhh",980,580);
      canvas44[10] = new TCanvas ("c10", "Mhh",980,580);
      canvas44[11] = new TCanvas ("c11", "Mhh",980,580);
      canvas44[12] = new TCanvas ("c12", "Mhh",980,580);
      canvas44[13] = new TCanvas ("c13", "Mhh",980,580);
      canvas44[14] = new TCanvas ("c14", "Mhh",980,580);
      canvas44[15] = new TCanvas ("c15", "Mhh",980,580);
      canvas44[16] = new TCanvas ("c16", "Mhh",980,580);
      canvas44[17] = new TCanvas ("c17", "Mhh",980,580);
      canvas44[18] = new TCanvas ("c18", "Mhh",980,580);
      canvas44[19] = new TCanvas ("c19", "Mhh",980,580);
      canvas44[20] = new TCanvas ("c20", "Mhh",980,580);
      canvas44[21] = new TCanvas ("c21", "Mhh",980,580);
      canvas44[22] = new TCanvas ("c22", "Mhh",980,580);
      canvas44[23] = new TCanvas ("c23", "Mhh",980,580);
      canvas44[24] = new TCanvas ("c24", "Mhh",980,580);
      canvas44[25] = new TCanvas ("c25", "Mhh",980,580);
      canvas44[26] = new TCanvas ("c26", "Mhh",980,580);
      canvas44[27] = new TCanvas ("c27", "Mhh",980,580);
      canvas44[28] = new TCanvas ("c28", "Mhh",980,580);
      canvas44[29] = new TCanvas ("c29", "Mhh",980,580);
      canvas44[30] = new TCanvas ("c30", "Mhh",980,580);
    
      TPad *pad441[n_cut44];
      pad441[0] = new TPad ("pad0", "", 0,0,0.75,1);
      pad441[1] = new TPad ("pad1", "", 0,0,0.75,1);
      pad441[2] = new TPad ("pad2", "", 0,0,0.75,1);
      pad441[3] = new TPad ("pad3", "", 0,0,0.75,1);
      pad441[4] = new TPad ("pad4", "", 0,0,0.75,1);
      pad441[5] = new TPad ("pad5", "", 0,0,0.75,1);
      pad441[6] = new TPad ("pad6", "", 0,0,0.75,1);
      pad441[7] = new TPad ("pad7", "", 0,0,0.75,1);
      pad441[8] = new TPad ("pad8", "", 0,0,0.75,1);
      pad441[9] = new TPad ("pad9", "", 0,0,0.75,1);
      pad441[10] = new TPad ("pad10", "", 0,0,0.75,1);
      pad441[11] = new TPad ("pad11", "", 0,0,0.75,1);
      pad441[12] = new TPad ("pad12", "", 0,0,0.75,1);
      pad441[13] = new TPad ("pad13", "", 0,0,0.75,1);
      pad441[14] = new TPad ("pad14", "", 0,0,0.75,1);
      pad441[15] = new TPad ("pad15", "", 0,0,0.75,1);
      pad441[16] = new TPad ("pad16", "", 0,0,0.75,1);
      pad441[17] = new TPad ("pad17", "", 0,0,0.75,1);
      pad441[18] = new TPad ("pad18", "", 0,0,0.75,1);
      pad441[19] = new TPad ("pad19", "", 0,0,0.75,1);
      pad441[20] = new TPad ("pad20", "", 0,0,0.75,1);
      pad441[21] = new TPad ("pad21", "", 0,0,0.75,1);
      pad441[22] = new TPad ("pad22", "", 0,0,0.75,1);
      pad441[23] = new TPad ("pad23", "", 0,0,0.75,1);
      pad441[24] = new TPad ("pad24", "", 0,0,0.75,1);
      pad441[25] = new TPad ("pad25", "", 0,0,0.75,1);
      pad441[26] = new TPad ("pad26", "", 0,0,0.75,1);
      pad441[27] = new TPad ("pad27", "", 0,0,0.75,1);
      pad441[28] = new TPad ("pad28", "", 0,0,0.75,1);
      pad441[29] = new TPad ("pad29", "", 0,0,0.75,1);
      pad441[30] = new TPad ("pad30", "", 0,0,0.75,1);
    
      TPad *pad442[n_cut44];
      pad442[0] = new TPad ("pad0", "",0.73,0,1,1);
      pad442[1] = new TPad ("pad1", "",0.73,0,1,1);
      pad442[2] = new TPad ("pad2", "",0.73,0,1,1);
      pad442[3] = new TPad ("pad3", "",0.73,0,1,1);
      pad442[4] = new TPad ("pad4", "",0.73,0,1,1);
      pad442[5] = new TPad ("pad5", "",0.73,0,1,1);
      pad442[6] = new TPad ("pad6", "",0.73,0,1,1);
      pad442[7] = new TPad ("pad7", "",0.73,0,1,1);
      pad442[8] = new TPad ("pad8", "",0.73,0,1,1);
      pad442[9] = new TPad ("pad9", "",0.73,0,1,1);
      pad442[10] = new TPad ("pad10", "",0.73,0,1,1);
      pad442[11] = new TPad ("pad11", "",0.73,0,1,1);
      pad442[12] = new TPad ("pad12", "",0.73,0,1,1);
      pad442[13] = new TPad ("pad13", "",0.73,0,1,1);
      pad442[14] = new TPad ("pad14", "",0.73,0,1,1);
      pad442[15] = new TPad ("pad15", "",0.73,0,1,1);
      pad442[16] = new TPad ("pad16", "",0.73,0,1,1);
      pad442[17] = new TPad ("pad17", "",0.73,0,1,1);
      pad442[18] = new TPad ("pad18", "",0.73,0,1,1);
      pad442[19] = new TPad ("pad19", "",0.73,0,1,1);
      pad442[20] = new TPad ("pad20", "",0.73,0,1,1);
      pad442[21] = new TPad ("pad21", "",0.73,0,1,1);
      pad442[22] = new TPad ("pad22", "",0.73,0,1,1);
      pad442[23] = new TPad ("pad23", "",0.73,0,1,1);
      pad442[24] = new TPad ("pad24", "",0.73,0,1,1);
      pad442[25] = new TPad ("pad25", "",0.73,0,1,1);
      pad442[26] = new TPad ("pad26", "",0.73,0,1,1);
      pad442[27] = new TPad ("pad27", "",0.73,0,1,1);
      pad442[28] = new TPad ("pad28", "",0.73,0,1,1);
      pad442[29] = new TPad ("pad29", "",0.73,0,1,1);
      pad442[30] = new TPad ("pad30", "",0.73,0,1,1);
      
      for (int k=0;k<n_cut44;k++) {
           canvas44[k]->cd();
           pad441[k]->Draw();
           pad442[k]->Draw();
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut44_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut44_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut44_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut44_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut44_1[k]),  "SAMEHIST");
        }
        
        THStack *hs44 = new THStack("hs44", "");
        for(int i= 0; i<9 ; i++){ hs44->Add(h_hist[i], "hist1"); }
        hs44->Draw("SAMEHIST");
      
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut44_1[k]), "SAMEHIST");} //VBFSM
        }

       //cout << " ============== significance From left ============== " << endl;
       //cout << " " << endl;
        
      TH1F *h441 = new TH1F("h441","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_44 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_44 = h_hist[9]->GetBinContent(j); //VBFSM
           //cout << " S of each bin = " << S_l_44 << endl;
           B_l_44_8 = h_hist[8]->GetBinContent(j);
           //cout << " B of ttbar of each bin = " << B_l_44_8 << endl;
           B_l_44_7 = h_hist[7]->GetBinContent(j);
           //cout << " B of single top of each bin = " << B_l_44_7 << endl;
           B_l_44_6 = h_hist[6]->GetBinContent(j);
           //cout << " B of Ztt of each bin = " << B_l_44_6 << endl;
           B_l_44_5 = h_hist[5]->GetBinContent(j);
           //cout << " B of Wlv of each bin = " << B_l_44_5 << endl;
           B_l_44_4 = h_hist[4]->GetBinContent(j);
           //cout << " B of Z of each bin = " << B_l_44_4 << endl;
           B_l_44_3 = h_hist[3]->GetBinContent(j);
           //cout << " B of Fake of each bin = " << B_l_44_3 << endl;
           ...
           float B_l_44 = 0;
           for(int i = 0; i<9; i++) { B_l_44 += h_hist[i]->GetBinContent(j); }
           ...
           h441->SetBinContent(j,QuadraticSum_l_44);
           h441->SetLineColor(kBlue-9);
           h441->SetLineStyle(2);
      ...
      TH1F *h442 = new TH1F("h442","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_44 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_44 = h_hist[9]->GetBinContent(j); //VBFSM
          //cout << " S of each bin = " << S_r_44 << endl;
          B_r_44_8 = h_hist[8]->GetBinContent(j);
          //cout << " B of ttbar of each bin = " << B_r_44_8 << endl;
          B_r_44_7 = h_hist[7]->GetBinContent(j);
          //cout << " B of single top of each bin = " << B_r_44_7 << endl;
          B_r_44_6 = h_hist[6]->GetBinContent(j);
          //cout << " B of Ztt of each bin = " << B_r_44_6 << endl;
          B_r_44_5 = h_hist[5]->GetBinContent(j);
          //cout << " B of Wlv of each bin = " << B_r_44_5 << endl;
          B_r_44_4 = h_hist[4]->GetBinContent(j);
          //cout << " B of Z of each bin = " << B_r_44_4 << endl;
          ...
          float B_r_44 = 0;
          for(int i = 0; i<9; i++) { B_r_44 += h_hist[i]->GetBinContent(j); }
          //cout << " B of each bin = " << B_r_44 << endl;
          
          float Bin_r_44 = 0;
          if (B_r_44 > 0){
              Bin_r_44 =  2* ( (S_r_44 + B_r_44) * log(1+S_r_44/B_r_44) - S_r_44 );
              //Bin_r_44 = (S_r_44/sqrt(B_r_44))*(S_r_44/sqrt(B_r_44));
              }
          //cout << " Bin = " << j << endl;
          ...
          h442->SetBinContent(j,QuadraticSum_r_44);
          h442->SetLineColor(kGreen-9);
          h442->SetLineStyle(2);
          
          //cout << " ************************************ " << endl;
       }
       
    float rightmax44 = 1.1*h441->GetMaximum();
    ...
    leg44->AddEntry(h441, "Quadratic Sum of #frac{S}{#sqrt{B}} from left");
    leg44->AddEntry(h442, "Quadratic Sum of #frac{S}{#sqrt{B}} from right");
    leg44->Draw();
    ...
    const int n_cut45 = 31;
    TCut cut45_1[n_cut45] = { "phiVBFj1>-3", "phiVBFj1>-2.8", "phiVBFj1>-2.6", "phiVBFj1>-2.4", "phiVBFj1>-2.2", "phiVBFj1>-2", "phiVBFj1>-1.8", "phiVBFj1>-1.6", "phiVBFj1>-1.4", "phiVBFj1>-1.2", "phiVBFj1>-1", "phiVBFj1>-0.8", "phiVBFj1>-0.6", "phiVBFj1>-0.4", "phiVBFj1>-0.2", "phiVBFj1>0", "phiVBFj1>0.2", "phiVBFj1>0.4", "phiVBFj1>0.6", "phiVBFj1>0.8", "phiVBFj1>1", "phiVBFj1>1.2", "phiVBFj1>1.4", "phiVBFj1>1.6", "phiVBFj1>1.8", "phiVBFj1>2", "phiVBFj1>2.2", "phiVBFj1>2.4", "phiVBFj1>2.6", "phiVBFj1>2.8", "phiVBFj1>3" };
    string cut45_2[n_cut45] = { "phiVBFj1>-3", "phiVBFj1>-2.8", "phiVBFj1>-2.6", "phiVBFj1>-2.4", "phiVBFj1>-2.2", "phiVBFj1>-2", "phiVBFj1>-1.8", "phiVBFj1>-1.6", "phiVBFj1>-1.4", "phiVBFj1>-1.2", "phiVBFj1>-1", "phiVBFj1>-0.8", "phiVBFj1>-0.6", "phiVBFj1>-0.4", "phiVBFj1>-0.2", "phiVBFj1>0", "phiVBFj1>0.2", "phiVBFj1>0.4", "phiVBFj1>0.6", "phiVBFj1>0.8", "phiVBFj1>1", "phiVBFj1>1.2", "phiVBFj1>1.4", "phiVBFj1>1.6", "phiVBFj1>1.8", "phiVBFj1>2", "phiVBFj1>2.2", "phiVBFj1>2.4", "phiVBFj1>2.6", "phiVBFj1>2.8", "phiVBFj1>3" };
    

      TCanvas *canvas45[n_cut45] ;
      canvas45[0] = new TCanvas ("c0", "Mhh",980,580);
      canvas45[1] = new TCanvas ("c1", "Mhh",980,580);
      canvas45[2] = new TCanvas ("c2", "Mhh",980,580);
      canvas45[3] = new TCanvas ("c3", "Mhh",980,580);
      canvas45[4] = new TCanvas ("c4", "Mhh",980,580);
      canvas45[5] = new TCanvas ("c5", "Mhh",980,580);
      canvas45[6] = new TCanvas ("c6", "Mhh",980,580);
      canvas45[7] = new TCanvas ("c7", "Mhh",980,580);
      canvas45[8] = new TCanvas ("c8", "Mhh",980,580);
      canvas45[9] = new TCanvas ("c9", "Mhh",980,580);
      canvas45[10] = new TCanvas ("c10", "Mhh",980,580);
      canvas45[11] = new TCanvas ("c11", "Mhh",980,580);
      canvas45[12] = new TCanvas ("c12", "Mhh",980,580);
      canvas45[13] = new TCanvas ("c13", "Mhh",980,580);
      canvas45[14] = new TCanvas ("c14", "Mhh",980,580);
      canvas45[15] = new TCanvas ("c15", "Mhh",980,580);
      canvas45[16] = new TCanvas ("c16", "Mhh",980,580);
      canvas45[17] = new TCanvas ("c17", "Mhh",980,580);
      canvas45[18] = new TCanvas ("c18", "Mhh",980,580);
      canvas45[19] = new TCanvas ("c19", "Mhh",980,580);
      canvas45[20] = new TCanvas ("c20", "Mhh",980,580);
      canvas45[21] = new TCanvas ("c21", "Mhh",980,580);
      canvas45[22] = new TCanvas ("c22", "Mhh",980,580);
      canvas45[23] = new TCanvas ("c23", "Mhh",980,580);
      canvas45[24] = new TCanvas ("c24", "Mhh",980,580);
      canvas45[25] = new TCanvas ("c25", "Mhh",980,580);
      canvas45[26] = new TCanvas ("c26", "Mhh",980,580);
      canvas45[27] = new TCanvas ("c27", "Mhh",980,580);
      canvas45[28] = new TCanvas ("c28", "Mhh",980,580);
      canvas45[29] = new TCanvas ("c29", "Mhh",980,580);
      canvas45[30] = new TCanvas ("c30", "Mhh",980,580);
    
      TPad *pad451[n_cut45];
      pad451[0] = new TPad ("pad0", "", 0,0,0.75,1);
      pad451[1] = new TPad ("pad1", "", 0,0,0.75,1);
      pad451[2] = new TPad ("pad2", "", 0,0,0.75,1);
      pad451[3] = new TPad ("pad3", "", 0,0,0.75,1);
      pad451[4] = new TPad ("pad4", "", 0,0,0.75,1);
      pad451[5] = new TPad ("pad5", "", 0,0,0.75,1);
      pad451[6] = new TPad ("pad6", "", 0,0,0.75,1);
      pad451[7] = new TPad ("pad7", "", 0,0,0.75,1);
      pad451[8] = new TPad ("pad8", "", 0,0,0.75,1);
      pad451[9] = new TPad ("pad9", "", 0,0,0.75,1);
      pad451[10] = new TPad ("pad10", "", 0,0,0.75,1);
      pad451[11] = new TPad ("pad11", "", 0,0,0.75,1);
      pad451[12] = new TPad ("pad12", "", 0,0,0.75,1);
      pad451[13] = new TPad ("pad13", "", 0,0,0.75,1);
      pad451[14] = new TPad ("pad14", "", 0,0,0.75,1);
      pad451[15] = new TPad ("pad15", "", 0,0,0.75,1);
      pad451[16] = new TPad ("pad16", "", 0,0,0.75,1);
      pad451[17] = new TPad ("pad17", "", 0,0,0.75,1);
      pad451[18] = new TPad ("pad18", "", 0,0,0.75,1);
      pad451[19] = new TPad ("pad19", "", 0,0,0.75,1);
      pad451[20] = new TPad ("pad20", "", 0,0,0.75,1);
      pad451[21] = new TPad ("pad21", "", 0,0,0.75,1);
      pad451[22] = new TPad ("pad22", "", 0,0,0.75,1);
      pad451[23] = new TPad ("pad23", "", 0,0,0.75,1);
      pad451[24] = new TPad ("pad24", "", 0,0,0.75,1);
      pad451[25] = new TPad ("pad25", "", 0,0,0.75,1);
      pad451[26] = new TPad ("pad26", "", 0,0,0.75,1);
      pad451[27] = new TPad ("pad27", "", 0,0,0.75,1);
      pad451[28] = new TPad ("pad28", "", 0,0,0.75,1);
      pad451[29] = new TPad ("pad29", "", 0,0,0.75,1);
      pad451[30] = new TPad ("pad30", "", 0,0,0.75,1);
    
      TPad *pad452[n_cut45];
      pad452[0] = new TPad ("pad0", "",0.73,0,1,1);
      pad452[1] = new TPad ("pad1", "",0.73,0,1,1);
      pad452[2] = new TPad ("pad2", "",0.73,0,1,1);
      pad452[3] = new TPad ("pad3", "",0.73,0,1,1);
      pad452[4] = new TPad ("pad4", "",0.73,0,1,1);
      pad452[5] = new TPad ("pad5", "",0.73,0,1,1);
      pad452[6] = new TPad ("pad6", "",0.73,0,1,1);
      pad452[7] = new TPad ("pad7", "",0.73,0,1,1);
      pad452[8] = new TPad ("pad8", "",0.73,0,1,1);
      pad452[9] = new TPad ("pad9", "",0.73,0,1,1);
      pad452[10] = new TPad ("pad10", "",0.73,0,1,1);
      pad452[11] = new TPad ("pad11", "",0.73,0,1,1);
      pad452[12] = new TPad ("pad12", "",0.73,0,1,1);
      pad452[13] = new TPad ("pad13", "",0.73,0,1,1);
      pad452[14] = new TPad ("pad14", "",0.73,0,1,1);
      pad452[15] = new TPad ("pad15", "",0.73,0,1,1);
      pad452[16] = new TPad ("pad16", "",0.73,0,1,1);
      pad452[17] = new TPad ("pad17", "",0.73,0,1,1);
      pad452[18] = new TPad ("pad18", "",0.73,0,1,1);
      pad452[19] = new TPad ("pad19", "",0.73,0,1,1);
      pad452[20] = new TPad ("pad20", "",0.73,0,1,1);
      pad452[21] = new TPad ("pad21", "",0.73,0,1,1);
      pad452[22] = new TPad ("pad22", "",0.73,0,1,1);
      pad452[23] = new TPad ("pad23", "",0.73,0,1,1);
      pad452[24] = new TPad ("pad24", "",0.73,0,1,1);
      pad452[25] = new TPad ("pad25", "",0.73,0,1,1);
      pad452[26] = new TPad ("pad26", "",0.73,0,1,1);
      pad452[27] = new TPad ("pad27", "",0.73,0,1,1);
      pad452[28] = new TPad ("pad28", "",0.73,0,1,1);
      pad452[29] = new TPad ("pad29", "",0.73,0,1,1);
      pad452[30] = new TPad ("pad30", "",0.73,0,1,1);
      
      for (int k=0;k<n_cut45;k++) {
           canvas45[k]->cd();
           pad451[k]->Draw();
           pad452[k]->Draw();
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut45_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut45_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut45_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut45_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut45_1[k]),  "SAMEHIST");
        }
        
        THStack *hs45 = new THStack("hs45", "");
        for(int i= 0; i<9 ; i++){ hs45->Add(h_hist[i], "hist1"); }
        hs45->Draw("SAMEHIST");
      
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut45_1[k]), "SAMEHIST");} //VBFSM
        }

       //cout << " ============== significance From left ============== " << endl;
       //cout << " " << endl;
        
      TH1F *h451 = new TH1F("h451","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_45 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_45 = h_hist[9]->GetBinContent(j); //VBFSM
           //cout << " S of each bin = " << S_l_45 << endl;
           B_l_45_8 = h_hist[8]->GetBinContent(j);
           //cout << " B of ttbar of each bin = " << B_l_45_8 << endl;
           B_l_45_7 = h_hist[7]->GetBinContent(j);
           //cout << " B of single top of each bin = " << B_l_45_7 << endl;
           B_l_45_6 = h_hist[6]->GetBinContent(j);
           //cout << " B of Ztt of each bin = " << B_l_45_6 << endl;
           B_l_45_5 = h_hist[5]->GetBinContent(j);
           //cout << " B of Wlv of each bin = " << B_l_45_5 << endl;
           B_l_45_4 = h_hist[4]->GetBinContent(j);
           //cout << " B of Z of each bin = " << B_l_45_4 << endl;
           B_l_45_3 = h_hist[3]->GetBinContent(j);
           //cout << " B of Fake of each bin = " << B_l_45_3 << endl;
           ...
           float B_l_45 = 0;
           for(int i = 0; i<9; i++) { B_l_45 += h_hist[i]->GetBinContent(j); }
           ...
           h451->SetBinContent(j,QuadraticSum_l_45);
           h451->SetLineColor(kBlue-9);
           h451->SetLineStyle(2);
      ...
      TH1F *h452 = new TH1F("h452","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_45 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_45 = h_hist[9]->GetBinContent(j); //VBFSM
          //cout << " S of each bin = " << S_r_45 << endl;
          B_r_45_8 = h_hist[8]->GetBinContent(j);
          //cout << " B of ttbar of each bin = " << B_r_45_8 << endl;
          B_r_45_7 = h_hist[7]->GetBinContent(j);
          //cout << " B of single top of each bin = " << B_r_45_7 << endl;
          B_r_45_6 = h_hist[6]->GetBinContent(j);
          //cout << " B of Ztt of each bin = " << B_r_45_6 << endl;
          B_r_45_5 = h_hist[5]->GetBinContent(j);
          //cout << " B of Wlv of each bin = " << B_r_45_5 << endl;
          B_r_45_4 = h_hist[4]->GetBinContent(j);
          //cout << " B of Z of each bin = " << B_r_45_4 << endl;
          B_r_45_3 = h_hist[3]->GetBinContent(j);
          //cout << " B of Fake of each bin = " << B_r_45_3 << endl;
          ...
          //cout << " B of SM H of each bin = " << B_r_45_0 << endl;
          
          float B_r_45 = 0;
          for(int i = 0; i<9; i++) { B_r_45 += h_hist[i]->GetBinContent(j); }
          ...
          h452->SetBinContent(j,QuadraticSum_r_45);
          h452->SetLineColor(kGreen-9);
          h452->SetLineStyle(2);
          
          //cout << " ************************************ " << endl;
       }
       
    float rightmax45 = 1.1*h451->GetMaximum();
    float scale45 = 5000 / rightmax45;
    h451->Scale(scale45);
    h451->Draw("SAMEHIST");
    ...
    TGaxis*axis45 = new TGaxis(2000,0,2000,5000,0,rightmax45,510,"+L");
    ...
    leg45->AddEntry(h451, "Quadratic Sum of #frac{S}{#sqrt{B}} from left");
    leg45->AddEntry(h452, "Quadratic Sum of #frac{S}{#sqrt{B}} from right");
    leg45->Draw();
        ...
        cout << "" << endl;
        cout << cut45_2[k] << endl;
        cout << "Mt =" << QuadraticSum_l_45 << endl;
        cout << "" << endl;
    ...
    const int n_cut46 = 31;
    TCut cut46_1[n_cut46] = { "phiVBFj2<-3", "phiVBFj2<-2.8", "phiVBFj2<-2.6", "phiVBFj2<-2.4", "phiVBFj2<-2.2", "phiVBFj2<-2", "phiVBFj2<-1.8", "phiVBFj2<-1.6", "phiVBFj2<-1.4", "phiVBFj2<-1.2", "phiVBFj2<-1", "phiVBFj2<-0.8", "phiVBFj2<-0.6", "phiVBFj2<-0.4", "phiVBFj2<-0.2", "phiVBFj2<0", "phiVBFj2<0.2", "phiVBFj2<0.4", "phiVBFj2<0.6", "phiVBFj2<0.8", "phiVBFj2<1", "phiVBFj2<1.2", "phiVBFj2<1.4", "phiVBFj2<1.6", "phiVBFj2<1.8", "phiVBFj2<2", "phiVBFj2<2.2", "phiVBFj2<2.4", "phiVBFj2<2.6", "phiVBFj2<2.8", "phiVBFj2<3" };
    string cut46_2[n_cut46] = { "phiVBFj2<-3", "phiVBFj2<-2.8", "phiVBFj2<-2.6", "phiVBFj2<-2.4", "phiVBFj2<-2.2", "phiVBFj2<-2", "phiVBFj2<-1.8", "phiVBFj2<-1.6", "phiVBFj2<-1.4", "phiVBFj2<-1.2", "phiVBFj2<-1", "phiVBFj2<-0.8", "phiVBFj2<-0.6", "phiVBFj2<-0.4", "phiVBFj2<-0.2", "phiVBFj2<0", "phiVBFj2<0.2", "phiVBFj2<0.4", "phiVBFj2<0.6", "phiVBFj2<0.8", "phiVBFj2<1", "phiVBFj2<1.2", "phiVBFj2<1.4", "phiVBFj2<1.6", "phiVBFj2<1.8", "phiVBFj2<2", "phiVBFj2<2.2", "phiVBFj2<2.4", "phiVBFj2<2.6", "phiVBFj2<2.8", "phiVBFj2<3" };
    

      TCanvas *canvas46[n_cut46] ;
      canvas46[0] = new TCanvas ("c0", "Mhh",980,580);
      canvas46[1] = new TCanvas ("c1", "Mhh",980,580);
      canvas46[2] = new TCanvas ("c2", "Mhh",980,580);
      canvas46[3] = new TCanvas ("c3", "Mhh",980,580);
      canvas46[4] = new TCanvas ("c4", "Mhh",980,580);
      canvas46[5] = new TCanvas ("c5", "Mhh",980,580);
      canvas46[6] = new TCanvas ("c6", "Mhh",980,580);
      canvas46[7] = new TCanvas ("c7", "Mhh",980,580);
      canvas46[8] = new TCanvas ("c8", "Mhh",980,580);
      canvas46[9] = new TCanvas ("c9", "Mhh",980,580);
      canvas46[10] = new TCanvas ("c10", "Mhh",980,580);
      canvas46[11] = new TCanvas ("c11", "Mhh",980,580);
      canvas46[12] = new TCanvas ("c12", "Mhh",980,580);
      canvas46[13] = new TCanvas ("c13", "Mhh",980,580);
      canvas46[14] = new TCanvas ("c14", "Mhh",980,580);
      canvas46[15] = new TCanvas ("c15", "Mhh",980,580);
      canvas46[16] = new TCanvas ("c16", "Mhh",980,580);
      canvas46[17] = new TCanvas ("c17", "Mhh",980,580);
      canvas46[18] = new TCanvas ("c18", "Mhh",980,580);
      canvas46[19] = new TCanvas ("c19", "Mhh",980,580);
      canvas46[20] = new TCanvas ("c20", "Mhh",980,580);
      canvas46[21] = new TCanvas ("c21", "Mhh",980,580);
      canvas46[22] = new TCanvas ("c22", "Mhh",980,580);
      canvas46[23] = new TCanvas ("c23", "Mhh",980,580);
      canvas46[24] = new TCanvas ("c24", "Mhh",980,580);
      canvas46[25] = new TCanvas ("c25", "Mhh",980,580);
      canvas46[26] = new TCanvas ("c26", "Mhh",980,580);
      canvas46[27] = new TCanvas ("c27", "Mhh",980,580);
      canvas46[28] = new TCanvas ("c28", "Mhh",980,580);
      canvas46[29] = new TCanvas ("c29", "Mhh",980,580);
      canvas46[30] = new TCanvas ("c30", "Mhh",980,580);
    
      TPad *pad461[n_cut46];
      pad461[0] = new TPad ("pad0", "", 0,0,0.75,1);
      pad461[1] = new TPad ("pad1", "", 0,0,0.75,1);
      pad461[2] = new TPad ("pad2", "", 0,0,0.75,1);
      pad461[3] = new TPad ("pad3", "", 0,0,0.75,1);
      pad461[4] = new TPad ("pad4", "", 0,0,0.75,1);
      pad461[5] = new TPad ("pad5", "", 0,0,0.75,1);
      pad461[6] = new TPad ("pad6", "", 0,0,0.75,1);
      pad461[7] = new TPad ("pad7", "", 0,0,0.75,1);
      pad461[8] = new TPad ("pad8", "", 0,0,0.75,1);
      pad461[9] = new TPad ("pad9", "", 0,0,0.75,1);
      pad461[10] = new TPad ("pad10", "", 0,0,0.75,1);
      pad461[11] = new TPad ("pad11", "", 0,0,0.75,1);
      pad461[12] = new TPad ("pad12", "", 0,0,0.75,1);
      pad461[13] = new TPad ("pad13", "", 0,0,0.75,1);
      pad461[14] = new TPad ("pad14", "", 0,0,0.75,1);
      pad461[15] = new TPad ("pad15", "", 0,0,0.75,1);
      pad461[16] = new TPad ("pad16", "", 0,0,0.75,1);
      pad461[17] = new TPad ("pad17", "", 0,0,0.75,1);
      pad461[18] = new TPad ("pad18", "", 0,0,0.75,1);
      pad461[19] = new TPad ("pad19", "", 0,0,0.75,1);
      pad461[20] = new TPad ("pad20", "", 0,0,0.75,1);
      pad461[21] = new TPad ("pad21", "", 0,0,0.75,1);
      pad461[22] = new TPad ("pad22", "", 0,0,0.75,1);
      pad461[23] = new TPad ("pad23", "", 0,0,0.75,1);
      pad461[24] = new TPad ("pad24", "", 0,0,0.75,1);
      pad461[25] = new TPad ("pad25", "", 0,0,0.75,1);
      pad461[26] = new TPad ("pad26", "", 0,0,0.75,1);
      pad461[27] = new TPad ("pad27", "", 0,0,0.75,1);
      pad461[28] = new TPad ("pad28", "", 0,0,0.75,1);
      pad461[29] = new TPad ("pad29", "", 0,0,0.75,1);
      pad461[30] = new TPad ("pad30", "", 0,0,0.75,1);
    
      TPad *pad462[n_cut46];
      pad462[0] = new TPad ("pad0", "",0.73,0,1,1);
      pad462[1] = new TPad ("pad1", "",0.73,0,1,1);
      pad462[2] = new TPad ("pad2", "",0.73,0,1,1);
      pad462[3] = new TPad ("pad3", "",0.73,0,1,1);
      pad462[4] = new TPad ("pad4", "",0.73,0,1,1);
      pad462[5] = new TPad ("pad5", "",0.73,0,1,1);
      pad462[6] = new TPad ("pad6", "",0.73,0,1,1);
      pad462[7] = new TPad ("pad7", "",0.73,0,1,1);
      pad462[8] = new TPad ("pad8", "",0.73,0,1,1);
      pad462[9] = new TPad ("pad9", "",0.73,0,1,1);
      pad462[10] = new TPad ("pad10", "",0.73,0,1,1);
      pad462[11] = new TPad ("pad11", "",0.73,0,1,1);
      pad462[12] = new TPad ("pad12", "",0.73,0,1,1);
      pad462[13] = new TPad ("pad13", "",0.73,0,1,1);
      pad462[14] = new TPad ("pad14", "",0.73,0,1,1);
      pad462[15] = new TPad ("pad15", "",0.73,0,1,1);
      pad462[16] = new TPad ("pad16", "",0.73,0,1,1);
      pad462[17] = new TPad ("pad17", "",0.73,0,1,1);
      pad462[18] = new TPad ("pad18", "",0.73,0,1,1);
      pad462[19] = new TPad ("pad19", "",0.73,0,1,1);
      pad462[20] = new TPad ("pad20", "",0.73,0,1,1);
      pad462[21] = new TPad ("pad21", "",0.73,0,1,1);
      pad462[22] = new TPad ("pad22", "",0.73,0,1,1);
      pad462[23] = new TPad ("pad23", "",0.73,0,1,1);
      pad462[24] = new TPad ("pad24", "",0.73,0,1,1);
      pad462[25] = new TPad ("pad25", "",0.73,0,1,1);
      pad462[26] = new TPad ("pad26", "",0.73,0,1,1);
      pad462[27] = new TPad ("pad27", "",0.73,0,1,1);
      pad462[28] = new TPad ("pad28", "",0.73,0,1,1);
      pad462[29] = new TPad ("pad29", "",0.73,0,1,1);
      pad462[30] = new TPad ("pad30", "",0.73,0,1,1);
      
      for (int k=0;k<n_cut46;k++) {
           canvas46[k]->cd();
           pad461[k]->Draw();
           pad462[k]->Draw();
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut46_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut46_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut46_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut46_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut46_1[k]),  "SAMEHIST");
        }
        
        THStack *hs46 = new THStack("hs46", "");
        for(int i= 0; i<9 ; i++){ hs46->Add(h_hist[i], "hist1"); }
        hs46->Draw("SAMEHIST");
      
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut46_1[k]), "SAMEHIST");} //VBFSM
        }

       //cout << " ============== significance From left ============== " << endl;
       //cout << " " << endl;
        
      TH1F *h461 = new TH1F("h461","Quadratic Sum from left",40,0,2000); //left
       ...
       float QuadraticSum_l_46 = 0;
       float Sum_l_46 = 0;
         
        for (int j=1; j<=40; j++) {
            
           S_l_46 = h_hist[9]->GetBinContent(j); //VBFSM
           //cout << " S of each bin = " << S_l_46 << endl;
           B_l_46_8 = h_hist[8]->GetBinContent(j);
           //cout << " B of ttbar of each bin = " << B_l_46_8 << endl;
           B_l_46_7 = h_hist[7]->GetBinContent(j);
           //cout << " B of single top of each bin = " << B_l_46_7 << endl;
           B_l_46_6 = h_hist[6]->GetBinContent(j);
           //cout << " B of Ztt of each bin = " << B_l_46_6 << endl;
           B_l_46_5 = h_hist[5]->GetBinContent(j);
           //cout << " B of Wlv of each bin = " << B_l_46_5 << endl;
           B_l_46_4 = h_hist[4]->GetBinContent(j);
           //cout << " B of Z of each bin = " << B_l_46_4 << endl;
           B_l_46_3 = h_hist[3]->GetBinContent(j);
           //cout << " B of Fake of each bin = " << B_l_46_3 << endl;
           B_l_46_2 = h_hist[2]->GetBinContent(j);
           //cout << " B of DY of each bin = " << B_l_46_2 << endl;
           B_l_46_1 = h_hist[1]->GetBinContent(j);
           //cout << " B of diboson of each bin = " << B_l_46_1 << endl;
           B_l_46_0 = h_hist[0]->GetBinContent(j);
           //cout << " B of SMH of each bin = " << B_l_46_0 << endl;
           
           float B_l_46 = 0;
           for(int i = 0; i<9; i++) { B_l_46 += h_hist[i]->GetBinContent(j); }
           //cout << " B of each bin = " << B_l_46 << endl;
           
           float Bin_l_46 = 0;
           if (B_l_46 > 0){
               Bin_l_46 =  2* ( (S_l_46 + B_l_46) * log(1+S_l_46/B_l_46) - S_l_46 );
               //Bin_l_46 = (S_l_46/sqrt(B_l_46))*(S_l_46/sqrt(B_l_46));
               }
           //cout << " Bin = " << j << endl;
           //cout << " significance of each bin = " << sqrt(Bin_l_46) << endl; //
           

           Sum_l_46 += Bin_l_46 ;
           QuadraticSum_l_46 = sqrt(Sum_l_46);
           //cout << " Quadratic sum from left = " << QuadraticSum_l_46 << endl; //

           h461->SetBinContent(j,QuadraticSum_l_46);
           h461->SetLineColor(kBlue-9);
           h461->SetLineStyle(2);
      ...
      TH1F *h462 = new TH1F("h462","Quadratic Sum from right",40,0,2000); //right
       ...
       float QuadraticSum_r_46 = 0;
       float Sum_r_46 = 0;
        
        for (int j=40; j>=1; j--) {
            
          S_r_46 = h_hist[9]->GetBinContent(j); //VBFSM
          //cout << " S of each bin = " << S_r_46 << endl;
          B_r_46_8 = h_hist[8]->GetBinContent(j);
          //cout << " B of ttbar of each bin = " << B_r_46_8 << endl;
          B_r_46_7 = h_hist[7]->GetBinContent(j);
          //cout << " B of single top of each bin = " << B_r_46_7 << endl;
          B_r_46_6 = h_hist[6]->GetBinContent(j);
          //cout << " B of Ztt of each bin = " << B_r_46_6 << endl;
          B_r_46_5 = h_hist[5]->GetBinContent(j);
          //cout << " B of Wlv of each bin = " << B_r_46_5 << endl;
          B_r_46_4 = h_hist[4]->GetBinContent(j);
          //cout << " B of Z of each bin = " << B_r_46_4 << endl;
          B_r_46_3 = h_hist[3]->GetBinContent(j);
          //cout << " B of Fake of each bin = " << B_r_46_3 << endl;
          B_r_46_2 = h_hist[2]->GetBinContent(j);
          //cout << " B of DY of each bin = " << B_r_46_2 << endl;
          B_r_46_1 = h_hist[1]->GetBinContent(j);
          //cout << " B of diboson of each bin = " << B_r_46_1 << endl;
          B_r_46_0 = h_hist[0]->GetBinContent(j);
          //cout << " B of SM H of each bin = " << B_r_46_0 << endl;
          
          float B_r_46 = 0;
          for(int i = 0; i<9; i++) { B_r_46 += h_hist[i]->GetBinContent(j); }
          //cout << " B of each bin = " << B_r_46 << endl;
          
          float Bin_r_46 = 0;
          if (B_r_46 > 0){
              Bin_r_46 =  2* ( (S_r_46 + B_r_46) * log(1+S_r_46/B_r_46) - S_r_46 );
              //Bin_r_46 = (S_r_46/sqrt(B_r_46))*(S_r_46/sqrt(B_r_46));
              }
          //cout << " Bin = " << j << endl;
          //cout << " significance of each bin = " << sqrt(Bin_r_46) << endl;
          

          Sum_r_46 += Bin_r_46 ;
          QuadraticSum_r_46 = sqrt(Sum_r_46);
          //cout << " Quadratic sum from right = " << QuadraticSum_r_46 << endl;

          h462->SetBinContent(j,QuadraticSum_r_46);
          h462->SetLineColor(kGreen-9);
          h462->SetLineStyle(2);
          
          //cout << " ************************************ " << endl;
       }
       
    float rightmax46 = 1.1*h461->GetMaximum();
    float scale46 = 5000 / rightmax46;
    h461->Scale(scale46);
    h461->Draw("SAMEHIST");
    ...
    TGaxis*axis46 = new TGaxis(2000,0,2000,5000,0,rightmax46,510,"+L");
    axis46->SetTitle("Quadratic Sum of significance");
    axis46->SetTitleSize(0.03);
    axis46->SetLabelSize(0.025);
    axis46->Draw();
    
    pad462[k]->cd();
    TLegend *leg46 = new TLegend(0.008, 0.1, 0.985,0.9);
    leg46->SetBorderSize(1);
    leg46->SetFillColor(0);
    leg46->SetTextFont(42);
    leg46->SetTextSize(0.053);
    
    for(int i= 9; i>=0 ; i--)
    {
        leg46->AddEntry(h_hist[i], h_titles[i].c_str());
    }
    leg46->AddEntry(h461, "Quadratic Sum of #frac{S}{#sqrt{B}} from left");
    leg46->AddEntry(h462, "Quadratic Sum of #frac{S}{#sqrt{B}} from right");
    leg46->Draw();
        ...
        cout << "" << endl;
        cout << cut46_2[k] << endl;
        cout << "Mt =" << QuadraticSum_l_46 << endl;
        cout << "" << endl;
    ...
    const int n_cut47 = 31;
    TCut cut47_1[n_cut47] = { "phiVBFj2>-3", "phiVBFj2>-2.8", "phiVBFj2>-2.6", "phiVBFj2>-2.4", "phiVBFj2>-2.2", "phiVBFj2>-2", "phiVBFj2>-1.8", "phiVBFj2>-1.6", "phiVBFj2>-1.4", "phiVBFj2>-1.2", "phiVBFj2>-1", "phiVBFj2>-0.8", "phiVBFj2>-0.6", "phiVBFj2>-0.4", "phiVBFj2>-0.2", "phiVBFj2>0", "phiVBFj2>0.2", "phiVBFj2>0.4", "phiVBFj2>0.6", "phiVBFj2>0.8", "phiVBFj2>1", "phiVBFj2>1.2", "phiVBFj2>1.4", "phiVBFj2>1.6", "phiVBFj2>1.8", "phiVBFj2>2", "phiVBFj2>2.2", "phiVBFj2>2.4", "phiVBFj2>2.6", "phiVBFj2>2.8", "phiVBFj2>3" };
    string cut47_2[n_cut47] = { "phiVBFj2>-3", "phiVBFj2>-2.8", "phiVBFj2>-2.6", "phiVBFj2>-2.4", "phiVBFj2>-2.2", "phiVBFj2>-2", "phiVBFj2>-1.8", "phiVBFj2>-1.6", "phiVBFj2>-1.4", "phiVBFj2>-1.2", "phiVBFj2>-1", "phiVBFj2>-0.8", "phiVBFj2>-0.6", "phiVBFj2>-0.4", "phiVBFj2>-0.2", "phiVBFj2>0", "phiVBFj2>0.2", "phiVBFj2>0.4", "phiVBFj2>0.6", "phiVBFj2>0.8", "phiVBFj2>1", "phiVBFj2>1.2", "phiVBFj2>1.4", "phiVBFj2>1.6", "phiVBFj2>1.8", "phiVBFj2>2", "phiVBFj2>2.2", "phiVBFj2>2.4", "phiVBFj2>2.6", "phiVBFj2>2.8", "phiVBFj2>3" };
    

      TCanvas *canvas47[n_cut47] ;
      canvas47[0] = new TCanvas ("c0", "Mhh",980,580);
      canvas47[1] = new TCanvas ("c1", "Mhh",980,580);
      canvas47[2] = new TCanvas ("c2", "Mhh",980,580);
      canvas47[3] = new TCanvas ("c3", "Mhh",980,580);
      canvas47[4] = new TCanvas ("c4", "Mhh",980,580);
      canvas47[5] = new TCanvas ("c5", "Mhh",980,580);
      canvas47[6] = new TCanvas ("c6", "Mhh",980,580);
      canvas47[7] = new TCanvas ("c7", "Mhh",980,580);
      canvas47[8] = new TCanvas ("c8", "Mhh",980,580);
      canvas47[9] = new TCanvas ("c9", "Mhh",980,580);
      canvas47[10] = new TCanvas ("c10", "Mhh",980,580);
      canvas47[11] = new TCanvas ("c11", "Mhh",980,580);
      canvas47[12] = new TCanvas ("c12", "Mhh",980,580);
      canvas47[13] = new TCanvas ("c13", "Mhh",980,580);
      canvas47[14] = new TCanvas ("c14", "Mhh",980,580);
      canvas47[15] = new TCanvas ("c15", "Mhh",980,580);
      canvas47[16] = new TCanvas ("c16", "Mhh",980,580);
      canvas47[17] = new TCanvas ("c17", "Mhh",980,580);
      canvas47[18] = new TCanvas ("c18", "Mhh",980,580);
      canvas47[19] = new TCanvas ("c19", "Mhh",980,580);
      canvas47[20] = new TCanvas ("c20", "Mhh",980,580);
      canvas47[21] = new TCanvas ("c21", "Mhh",980,580);
      canvas47[22] = new TCanvas ("c22", "Mhh",980,580);
      canvas47[23] = new TCanvas ("c23", "Mhh",980,580);
      canvas47[24] = new TCanvas ("c24", "Mhh",980,580);
      canvas47[25] = new TCanvas ("c25", "Mhh",980,580);
      canvas47[26] = new TCanvas ("c26", "Mhh",980,580);
      canvas47[27] = new TCanvas ("c27", "Mhh",980,580);
      canvas47[28] = new TCanvas ("c28", "Mhh",980,580);
      canvas47[29] = new TCanvas ("c29", "Mhh",980,580);
      canvas47[30] = new TCanvas ("c30", "Mhh",980,580);
    
      TPad *pad471[n_cut47];
      pad471[0] = new TPad ("pad0", "", 0,0,0.75,1);
      pad471[1] = new TPad ("pad1", "", 0,0,0.75,1);
      pad471[2] = new TPad ("pad2", "", 0,0,0.75,1);
      pad471[3] = new TPad ("pad3", "", 0,0,0.75,1);
      pad471[4] = new TPad ("pad4", "", 0,0,0.75,1);
      pad471[5] = new TPad ("pad5", "", 0,0,0.75,1);
      pad471[6] = new TPad ("pad6", "", 0,0,0.75,1);
      pad471[7] = new TPad ("pad7", "", 0,0,0.75,1);
      pad471[8] = new TPad ("pad8", "", 0,0,0.75,1);
      pad471[9] = new TPad ("pad9", "", 0,0,0.75,1);
      pad471[10] = new TPad ("pad10", "", 0,0,0.75,1);
      pad471[11] = new TPad ("pad11", "", 0,0,0.75,1);
      pad471[12] = new TPad ("pad12", "", 0,0,0.75,1);
      pad471[13] = new TPad ("pad13", "", 0,0,0.75,1);
      pad471[14] = new TPad ("pad14", "", 0,0,0.75,1);
      pad471[15] = new TPad ("pad15", "", 0,0,0.75,1);
      pad471[16] = new TPad ("pad16", "", 0,0,0.75,1);
      pad471[17] = new TPad ("pad17", "", 0,0,0.75,1);
      pad471[18] = new TPad ("pad18", "", 0,0,0.75,1);
      pad471[19] = new TPad ("pad19", "", 0,0,0.75,1);
      pad471[20] = new TPad ("pad20", "", 0,0,0.75,1);
      pad471[21] = new TPad ("pad21", "", 0,0,0.75,1);
      pad471[22] = new TPad ("pad22", "", 0,0,0.75,1);
      pad471[23] = new TPad ("pad23", "", 0,0,0.75,1);
      pad471[24] = new TPad ("pad24", "", 0,0,0.75,1);
      pad471[25] = new TPad ("pad25", "", 0,0,0.75,1);
      pad471[26] = new TPad ("pad26", "", 0,0,0.75,1);
      pad471[27] = new TPad ("pad27", "", 0,0,0.75,1);
      pad471[28] = new TPad ("pad28", "", 0,0,0.75,1);
      pad471[29] = new TPad ("pad29", "", 0,0,0.75,1);
      pad471[30] = new TPad ("pad30", "", 0,0,0.75,1);
    
      TPad *pad472[n_cut47];
      pad472[0] = new TPad ("pad0", "",0.73,0,1,1);
      pad472[1] = new TPad ("pad1", "",0.73,0,1,1);
      pad472[2] = new TPad ("pad2", "",0.73,0,1,1);
      pad472[3] = new TPad ("pad3", "",0.73,0,1,1);
      pad472[4] = new TPad ("pad4", "",0.73,0,1,1);
      pad472[5] = new TPad ("pad5", "",0.73,0,1,1);
      pad472[6] = new TPad ("pad6", "",0.73,0,1,1);
      pad472[7] = new TPad ("pad7", "",0.73,0,1,1);
      pad472[8] = new TPad ("pad8", "",0.73,0,1,1);
      pad472[9] = new TPad ("pad9", "",0.73,0,1,1);
      pad472[10] = new TPad ("pad10", "",0.73,0,1,1);
      pad472[11] = new TPad ("pad11", "",0.73,0,1,1);
      pad472[12] = new TPad ("pad12", "",0.73,0,1,1);
      pad472[13] = new TPad ("pad13", "",0.73,0,1,1);
      pad472[14] = new TPad ("pad14", "",0.73,0,1,1);
      pad472[15] = new TPad ("pad15", "",0.73,0,1,1);
      pad472[16] = new TPad ("pad16", "",0.73,0,1,1);
      pad472[17] = new TPad ("pad17", "",0.73,0,1,1);
      pad472[18] = new TPad ("pad18", "",0.73,0,1,1);
      pad472[19] = new TPad ("pad19", "",0.73,0,1,1);
      pad472[20] = new TPad ("pad20", "",0.73,0,1,1);
      pad472[21] = new TPad ("pad21", "",0.73,0,1,1);
      pad472[22] = new TPad ("pad22", "",0.73,0,1,1);
      pad472[23] = new TPad ("pad23", "",0.73,0,1,1);
      pad472[24] = new TPad ("pad24", "",0.73,0,1,1);
      pad472[25] = new TPad ("pad25", "",0.73,0,1,1);
      pad472[26] = new TPad ("pad26", "",0.73,0,1,1);
      pad472[27] = new TPad ("pad27", "",0.73,0,1,1);
      pad472[28] = new TPad ("pad28", "",0.73,0,1,1);
      pad472[29] = new TPad ("pad29", "",0.73,0,1,1);
      pad472[30] = new TPad ("pad30", "",0.73,0,1,1);
      
      for (int k=0;k<n_cut47;k++) {
           canvas47[k]->cd();
           pad471[k]->Draw();
           pad472[k]->Draw();
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut47_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut47_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut47_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut47_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut47_1[k]),  "SAMEHIST");
        }
        
        THStack *hs47 = new THStack("hs47", "");
        for(int i= 0; i<9 ; i++){ hs47->Add(h_hist[i], "hist1"); }
        hs47->Draw("SAMEHIST");
      
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut47_1[k]), "SAMEHIST");} //VBFSM
        }

       //cout << " ============== significance From left ============== " << endl;
       //cout << " " << endl;
        
      TH1F *h471 = new TH1F("h471","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_47 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_47 = h_hist[9]->GetBinContent(j); //VBFSM
           //cout << " S of each bin = " << S_l_47 << endl;
           B_l_47_8 = h_hist[8]->GetBinContent(j);
           //cout << " B of ttbar of each bin = " << B_l_47_8 << endl;
           B_l_47_7 = h_hist[7]->GetBinContent(j);
           //cout << " B of single top of each bin = " << B_l_47_7 << endl;
           B_l_47_6 = h_hist[6]->GetBinContent(j);
           //cout << " B of Ztt of each bin = " << B_l_47_6 << endl;
           B_l_47_5 = h_hist[5]->GetBinContent(j);
           //cout << " B of Wlv of each bin = " << B_l_47_5 << endl;
           B_l_47_4 = h_hist[4]->GetBinContent(j);
           //cout << " B of Z of each bin = " << B_l_47_4 << endl;
           B_l_47_3 = h_hist[3]->GetBinContent(j);
           //cout << " B of Fake of each bin = " << B_l_47_3 << endl;
           ...
           float B_l_47 = 0;
           for(int i = 0; i<9; i++) { B_l_47 += h_hist[i]->GetBinContent(j); }
           ...
           h471->SetBinContent(j,QuadraticSum_l_47);
           h471->SetLineColor(kBlue-9);
           h471->SetLineStyle(2);
      ...
      TH1F *h472 = new TH1F("h472","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_47 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_47 = h_hist[9]->GetBinContent(j); //VBFSM
          //cout << " S of each bin = " << S_r_47 << endl;
          B_r_47_8 = h_hist[8]->GetBinContent(j);
          //cout << " B of ttbar of each bin = " << B_r_47_8 << endl;
          B_r_47_7 = h_hist[7]->GetBinContent(j);
          //cout << " B of single top of each bin = " << B_r_47_7 << endl;
          B_r_47_6 = h_hist[6]->GetBinContent(j);
          //cout << " B of Ztt of each bin = " << B_r_47_6 << endl;
          B_r_47_5 = h_hist[5]->GetBinContent(j);
          //cout << " B of Wlv of each bin = " << B_r_47_5 << endl;
          B_r_47_4 = h_hist[4]->GetBinContent(j);
          //cout << " B of Z of each bin = " << B_r_47_4 << endl;
          B_r_47_3 = h_hist[3]->GetBinContent(j);
          //cout << " B of Fake of each bin = " << B_r_47_3 << endl;
          ...
          //cout << " B of SM H of each bin = " << B_r_47_0 << endl;
          
          float B_r_47 = 0;
          for(int i = 0; i<9; i++) { B_r_47 += h_hist[i]->GetBinContent(j); }
          ...
          h472->SetBinContent(j,QuadraticSum_r_47);
          h472->SetLineColor(kGreen-9);
          h472->SetLineStyle(2);
          
          //cout << " ************************************ " << endl;
       }
       
    float rightmax47 = 1.1*h471->GetMaximum();
    float scale47 = 5000 / rightmax47;
    h471->Scale(scale47);
    h471->Draw("SAMEHIST");
    ...
    TGaxis*axis47 = new TGaxis(2000,0,2000,5000,0,rightmax47,510,"+L");
    ...
    leg47->AddEntry(h471, "Quadratic Sum of #frac{S}{#sqrt{B}} from left");
    leg47->AddEntry(h472, "Quadratic Sum of #frac{S}{#sqrt{B}} from right");
    leg47->Draw();
        ...
        cout << "" << endl;
        cout << cut47_2[k] << endl;
        cout << "Mt =" << QuadraticSum_l_47 << endl;
        cout << "" << endl;
    ...
    string cut48_2[n_cut48] = { "pTB1>10GeV", "pTB1>20GeV", "pTB1>30GeV", "pTB1>40GeV", "pTB1>50GeV", "pTB1>60GeV", "pTB1>70GeV", "pTB1>80GeV", "pTB1>90GeV", "pTB1>100GeV", "pTB1>110GeV", "pTB1>120GeV", "pTB1>130GeV", "pTB1>140GeV", "pTB1>150GeV", "pTB1>160GeV", "pTB1>170GeV", "pTB1>180GeV", "pTB1>190GeV","pTB1>200GeV", "pTB1>210GeV", "pTB1>220GeV", "pTB1>230GeV", "pTB1>240GeV", "pTB1>250GeV", "pTB1>260GeV" };
      ...
      for (int k=0;k<n_cut48;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut48_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut48_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut48_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut48_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut48_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut48_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h481 = new TH1F("h481","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_48 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_48 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h482 = new TH1F("h482","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_48 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_48 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut49_2[n_cut49] = { "pTB2>30GeV", "pTB2>40GeV", "pTB2>50GeV", "pTB2>60GeV", "pTB2>70GeV", "pTB2>80GeV", "pTB2>90GeV", "pTB2>100GeV", "pTB2>110GeV", "pTB2>120GeV", "pTB2>130GeV", "pTB2>140GeV", "pTB2>150GeV", "pTB2>160GeV", "pTB2>170GeV", "pTB2>180GeV", "pTB2>190GeV","pTB2>200GeV", "pTB2>210GeV", "pTB2>220GeV", "pTB2>230GeV" };
      ...
      for (int k=0;k<n_cut49;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut49_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut49_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut49_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut49_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut49_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut49_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h491 = new TH1F("h491","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_49 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_49 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h492 = new TH1F("h492","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_49 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_49 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut50_2[n_cut50] = { "pTBB>10GeV", "pTBB>20GeV", "pTBB>30GeV", "pTBB>40GeV", "pTBB>50GeV", "pTBB>60GeV", "pTBB>70GeV", "pTBB>80GeV", "pTBB>90GeV", "pTBB>100GeV", "pTBB>110GeV", "pTBB>120GeV", "pTBB>130GeV", "pTBB>140GeV", "pTBB>150GeV", "pTBB>160GeV", "pTBB>170GeV", "pTBB>180GeV", "pTBB>190GeV","pTBB>200GeV", "pTBB>210GeV", "pTBB>220GeV", "pTBB>230GeV", "pTBB>240GeV", "pTBB>250GeV", "pTBB>260GeV" };
      ...
      for (int k=0;k<n_cut50;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut50_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut50_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut50_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut50_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut50_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut50_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h501 = new TH1F("h501","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_50 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_50 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h502 = new TH1F("h502","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_50 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_50 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut52_2[n_cut52] = { "pTtautau>30GeV", "pTtautau>40GeV", "pTtautau>50GeV", "pTtautau>60GeV", "pTtautau>70GeV", "pTtautau>80GeV", "pTtautau>90GeV", "pTtautau>100GeV", "pTtautau>110GeV", "pTtautau>120GeV", "pTtautau>130GeV", "pTtautau>140GeV", "pTtautau>150GeV", "pTtautau>160GeV", "pTtautau>170GeV", "pTtautau>180GeV", "pTtautau>190GeV","pTtautau>200GeV", "pTtautau>210GeV", "pTtautau>220GeV", "pTtautau>230GeV", "pTtautau>240GeV", "pTtautau>250GeV", "pTtautau>260GeV" };
      ...
      for (int k=0;k<n_cut52;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut52_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut52_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut52_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut52_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut52_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut52_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h521 = new TH1F("h521","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_52 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_52 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h522 = new TH1F("h522","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_52 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_52 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut53_2[n_cut53] = { "pTVBFj1>10GeV", "pTVBFj1>20GeV", "pTVBFj1>30GeV", "pTVBFj1>40GeV", "pTVBFj1>50GeV", "pTVBFj1>60GeV", "pTVBFj1>70GeV", "pTVBFj1>80GeV", "pTVBFj1>90GeV", "pTVBFj1>100GeV", "pTVBFj1>110GeV", "pTVBFj1>120GeV", "pTVBFj1>130GeV", "pTVBFj1>140GeV", "pTVBFj1>150GeV", "pTVBFj1>160GeV", "pTVBFj1>170GeV", "pTVBFj1>180GeV", "pTVBFj1>190GeV","pTVBFj1>200GeV", "pTVBFj1>210GeV", "pTVBFj1>220GeV", "pTVBFj1>230GeV", "pTVBFj1>240GeV", "pTVBFj1>250GeV", "pTVBFj1>260GeV" };
      ...
      for (int k=0;k<n_cut53;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut53_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut53_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut53_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut53_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut53_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut53_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h531 = new TH1F("h531","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_53 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_53 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h532 = new TH1F("h532","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_53 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_53 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    */
    ...
    string cut54_2[n_cut54] = { "pTVBFj2>10GeV", "pTVBFj2>20GeV", "pTVBFj2>30GeV", "pTVBFj2>40GeV", "pTVBFj2>50GeV", "pTVBFj2>60GeV", "pTVBFj2>70GeV", "pTVBFj2>80GeV", "pTVBFj2>90GeV", "pTVBFj2>100GeV", "pTVBFj2>110GeV", "pTVBFj2>120GeV", "pTVBFj2>130GeV", "pTVBFj2>140GeV", "pTVBFj2>150GeV", "pTVBFj2>160GeV", "pTVBFj2>170GeV", "pTVBFj2>180GeV", "pTVBFj2>190GeV","pTVBFj2>200GeV", "pTVBFj2>210GeV", "pTVBFj2>220GeV", "pTVBFj2>230GeV", "pTVBFj2>240GeV", "pTVBFj2>250GeV", "pTVBFj2>260GeV" };
      ...
      for (int k=0;k<n_cut54;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut54_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut54_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut54_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut54_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut54_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut54_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h541 = new TH1F("h541","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_54 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_54 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h542 = new TH1F("h542","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_54 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_54 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut55_2[n_cut55] = { "abs(TauEta)>0.2", "abs(TauEta)>0.4", "abs(TauEta)>0.6", "abs(TauEta)>0.8", "abs(TauEta)>1", "abs(TauEta)>1.2", "abs(TauEta)>1.4", "abs(TauEta)>1.6", "abs(TauEta)>1.8", "abs(TauEta)>2", "abs(TauEta)>2.2", "abs(TauEta)>2.4", "abs(TauEta)>2.6", "abs(TauEta)>2.8", "abs(TauEta)>3" };
      ...
      for (int k=0;k<n_cut55;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut55_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut55_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut55_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut55_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut55_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut55_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h551 = new TH1F("h551","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_55 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_55 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h552 = new TH1F("h552","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_55 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_55 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut58_2[n_cut58] = { "TauPhi<0.2", "TauPhi<0.4", "TauPhi<0.6", "TauPhi<0.8", "TauPhi<1", "TauPhi<1.2", "TauPhi<1.4", "TauPhi<1.6", "TauPhi<1.8", "TauPhi<2", "TauPhi<2.2", "TauPhi<2.4", "TauPhi<2.6", "TauPhi<2.8", "TauPhi<3" };
      ...
      for (int k=0;k<n_cut58;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut58_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut58_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut58_1[k]), "SAMEHIST");} //ttbar
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut58_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut58_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut58_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h581 = new TH1F("h581","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_58 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_58 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h582 = new TH1F("h582","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_58 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_58 = h_hist[9]->GetBinContent(j); //VBFSM
    ...
    string cut59_2[n_cut59] = { "TauPt<10GeV", "TauPt<20GeV", "TauPt<30GeV", "TauPt<40GeV", "TauPt<50GeV", "TauPt<60GeV", "TauPt<70GeV", "TauPt<80GeV", "TauPt<90GeV", "TauPt<100GeV", "TauPt<110GeV", "TauPt<120GeV", "TauPt<130GeV", "TauPt<140GeV", "TauPt<150GeV", "TauPt<160GeV", "TauPt<170GeV", "TauPt<180GeV", "TauPt<190GeV","TauPt<200GeV", "TauPt<210GeV", "TauPt<220GeV", "TauPt<230GeV", "TauPt<240GeV", "TauPt<250GeV", "TauPt<260GeV" };
      ...
      for (int k=0;k<n_cut59;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && cut59_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut59_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && cut59_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut59_1[k]), "SAMEHIST");} //VBFSM
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && cut59_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && cut59_1[k]), "SAMEHIST");} //VBFSM
        }
      ...
      TH1F *h591 = new TH1F("h591","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_59 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_59 = h_hist[9]->GetBinContent(j); //VBFSM
      ...
      TH1F *h592 = new TH1F("h592","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_59 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_59 = h_hist[9]->GetBinContent(j); //VBFSM
