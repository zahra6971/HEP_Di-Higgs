...
void SLT_significance_SM_ttbar(){
  ...
  //   ===========================================================   pTBB   ===========================================================
    ...
    for(int i = 0; i<n_smp; i++){
      ...
      else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "233468.068*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBFSM

    }
    
    for(int i = 0; i<n_smp; i++){
        if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "233468.068*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBFSM
    }
    ...
    */
    ...
    h_hist[1]->SetLineColor(kRed); h_hist[1]->SetMarkerColor(kRed); //VBF_SM
      ...
      for(int i = 0; i<n_smp; i++){
        ...
        if (i == 0){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )<0.4)&&(MtW<90000)&&(Mt>200000)&&(dEtaLepTau<1.8)&&(Mvis<130000)&&(sqrt( ((Mw*0.001-80.4)/(Mw*0.001)) * ((Mw*0.001-80.4)/(Mw*0.001)) + ((Mt*0.001-172.5)/(Mt*0.001)) * ((Mt*0.001-172.5)/(Mt*0.001)) )<2.6)&&(dEtaBB<2.2))", "SAMEHIST");} //ttbar
        else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )<0.4)&&(MtW<90000)&&(Mt>200000)&&(dEtaLepTau<1.8)&&(Mvis<130000)&&(sqrt( ((Mw*0.001-80.4)/(Mw*0.001)) * ((Mw*0.001-80.4)/(Mw*0.001)) + ((Mt*0.001-172.5)/(Mt*0.001)) * ((Mt*0.001-172.5)/(Mt*0.001)) )<2.6)&&(dEtaBB<2.2))", "SAMEHIST");} //VBFSM
    ...
    //   ===========================================================   Xhh   ===========================================================
      ...
      for (int i=0; i<n_smp; i++){
        ...
        //h_hist[i]->GetXaxis()->SetRangeUser(0, 510);
    ...
    ofstream myfile;
    myfile.open ("Yields_SM_ttbar.txt");
    myfile <<"---------------------------------------------------"<<endl;
    myfile <<"                                                                                    "<<endl;
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     yields_VBFSM = h_hist[1]->Integral();
