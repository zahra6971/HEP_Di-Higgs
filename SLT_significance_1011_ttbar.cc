...
void SLT_significance_1011_ttbar(){
  ...
  string h_titles[n_smp] = { "ttbar", "VBF1011 x 2923.67" };  // only for legend 2923.67
   ...
   TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      c12 -> SaveAs("dPhiLepTau_1011.pdf");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h15_2 = new TH1F("h15_2","Quadratic Sum from right",25,0,5); //right
      ...
      c15 -> SaveAs("dEtaLepTau_1011.pdf");
    ...
    TGaxis*axis32 = new TGaxis(3.5,0,3.5,3000,0,rightmax32,510,"+L");
      ...
      c32 -> SaveAs("dPhiLep0MET_1011.pdf");
    ...
    TGaxis*axis33 = new TGaxis(3.5,0,3.5,3500,0,rightmax33,510,"+L");
      ...
      c33 -> SaveAs("dPhiLep1MET_1011.pdf");
    ...
    TGaxis*axis34 = new TGaxis(3.5,0,3.5,4000,0,rightmax34,510,"+L");
      ...
      c34 -> SaveAs("dPhiHttMET_1011.pdf");
    ...
    TGaxis*axis35 = new TGaxis(3.5,0,3.5,4200,0,rightmax35,510,"+L");
      ...
      c35 -> SaveAs("dPhiHbbMET_1011.pdf");
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     entries_VBF1011 = h_hist[1]->GetEntries();
     yields_VBF1011 = h_hist[1]->Integral() / 2923.67; // multiply this factor on VBF1011 (plot)
     myfile<<"\t" <<h_title[1] <<"\t \t"<<entries_VBF1011<<"\t \t"<<yields_VBF1011<<endl;
     myfile <<"                                                                                   "<<endl;
