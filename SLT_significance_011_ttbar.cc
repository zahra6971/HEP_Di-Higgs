...
void SLT_significance_011_ttbar(){
  ...
  string h_titles[n_smp] = { "ttbar", "VBF011 x 67936.96" };  // only for legend 67936.96
  ...
  //   ===========================================================   pTBB   ===========================================================
    ...
    for(int i = 0; i<n_smp; i++){
      ...
      else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "67936.96*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF011

    }
    
    for(int i = 0; i<n_smp; i++){
        if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "67936.96*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF011
    }
   ...
   TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
    ...
    TGaxis*axis32 = new TGaxis(3.5,0,3.5,3000,0,rightmax32,510,"+L");
      ...
      c32 -> SaveAs("dPhiLep0MET_011.pdf");
    ...
    TGaxis*axis33 = new TGaxis(3.5,0,3.5,3500,0,rightmax33,510,"+L");
      ...
      c33 -> SaveAs("dPhiLep1MET_011.pdf");
    ...
    h_hist[1]->SetLineColor(kRed); h_hist[1]->SetMarkerColor(kRed); //VBF_SM
      ...
      for(int i = 0; i<n_smp; i++){
        ...
        if (i == 0){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )<0.3))", "SAMEHIST");} //ttbar
        else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )<0.3))", "SAMEHIST");} //VBF011
       
      }
    /*
    for(int i = 0; i<n_smp; i++){
        if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF011
    }*/
    ...
    float yields_VBF011;
    int sum_entries;
    int sum_entries_noVBF011;
    float sum_yields_noVBF011;
    float sum_yields;
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     entries_VBF011 = h_hist[1]->GetEntries();
     yields_VBF011 = h_hist[1]->Integral() / 67936.96; // multiply this factor on VBF011 (plot)
     myfile<<"\t" <<h_title[1] <<"\t \t"<<entries_VBF011<<"\t \t"<<yields_VBF011<<endl;
     myfile <<"                                                                                   "<<endl;
