...
void SLT_significance_131_ttbar(){
  ...
  string h_titles[n_smp] = { "ttbar", "VBF131 x 2147.21" };  // only for legend 2147.21
  ...
  //   ===========================================================   pTBB   ===========================================================
    ...
    for(int i = 0; i<n_smp; i++){
      ...
      else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "2147.21*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF131

    }
    
    for(int i = 0; i<n_smp; i++){
        if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "2147.21*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF131
    }
   ...
   TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
    ...
    TGaxis*axis32 = new TGaxis(3.5,0,3.5,3000,0,rightmax32,510,"+L");
      ...
      c32 -> SaveAs("dPhiLep0MET_131.pdf");
    ...
    TGaxis*axis33 = new TGaxis(3.5,0,3.5,3500,0,rightmax33,510,"+L");
      ...
      c33 -> SaveAs("dPhiLep1MET_131.pdf");
    ...
    float yields_VBF131;
    int sum_entries;
    int sum_entries_noVBF131;
    float sum_yields_noVBF131;
    float sum_yields;
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     entries_VBF131 = h_hist[1]->GetEntries();
     yields_VBF131 = h_hist[1]->Integral() / 2147.21; // multiply this factor on VBF131 (plot)
     myfile<<"\t" <<h_title[1] <<"\t \t"<<entries_VBF131<<"\t \t"<<yields_VBF131<<endl;
     myfile <<"                                                                                   "<<endl;
