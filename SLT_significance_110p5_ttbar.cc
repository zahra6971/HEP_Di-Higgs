...
void SLT_significance_110p5_ttbar(){
  ...
  string h_titles[n_smp] = { "ttbar", "VBF110p5 x 13577.81" };  // only for legend 13577.81
  ...
  //   ===========================================================   pTBB   ===========================================================
    ...
    for(int i = 0; i<n_smp; i++){
      ...
      else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "13577.81*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF110p5

    }
    
    for(int i = 0; i<n_smp; i++){
        if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "13577.81*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF110p5
    }
   ...
   TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      c48 -> SaveAs("dPhiVBFjj_110p5.pdf");
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     entries_VBF110p5 = h_hist[1]->GetEntries();
     yields_VBF110p5 = h_hist[1]->Integral() / 13577.81; // multiply this factor on VBF110p5 (plot)
     myfile<<"\t" <<h_title[1] <<"\t \t"<<entries_VBF110p5<<"\t \t"<<yields_VBF110p5<<endl;
     myfile <<"                                                                                   "<<endl;
