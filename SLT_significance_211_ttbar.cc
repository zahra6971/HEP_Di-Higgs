...
void SLT_significance_211_ttbar(){
  ...
  string h_titles[n_smp] = { "ttbar", "VBF211 x 215040.95" };  // only for legend 215040.95
  ...
  //   ===========================================================   pTBB   ===========================================================
    ...
    for(int i = 0; i<n_smp; i++){
      ...
      else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "215040.95*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF211

    }
    
    for(int i = 0; i<n_smp; i++){
        if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "215040.95*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF211
    }
   ...
   TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
    ...
    TGaxis*axis32 = new TGaxis(3.5,0,3.5,3000,0,rightmax32,510,"+L");
      ...
      c32 -> SaveAs("dPhiLep0MET_211.pdf");
    ...
    TGaxis*axis33 = new TGaxis(3.5,0,3.5,3500,0,rightmax33,510,"+L");
      ...
      c33 -> SaveAs("dPhiLep1MET_211.pdf");
    ...
    float yields_VBF211;
    int sum_entries;
    int sum_entries_noVBF211;
    float sum_yields_noVBF211;
    float sum_yields;
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     entries_VBF211 = h_hist[1]->GetEntries();
     yields_VBF211 = h_hist[1]->Integral() / 215040.95; // multiply this factor on VBF211 (plot)
     myfile<<"\t" <<h_title[1] <<"\t \t"<<entries_VBF211<<"\t \t"<<yields_VBF211<<endl;
     myfile <<"                                                                                   "<<endl;
