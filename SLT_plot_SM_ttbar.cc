...
void SLT_plot_SM_ttbar(){
  ...
  string h_titles[n_smp] = { "ttbar", "VBFSM x 233468.068" };  // only for legend 233468.068
  ...
  //   ===========================================================   pTBB   ===========================================================
    ...
    for(int i = 0; i<n_smp; i++){
      ...
      if(i == 0){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )<0.3)&&(MtW<60000)&&(sqrt( ((Mw*0.001-80.4)/(Mw*0.001)) * ((Mw*0.001-80.4)/(Mw*0.001)) + ((Mt*0.001-172.5)/(Mt*0.001)) * ((Mt*0.001-172.5)/(Mt*0.001)) )<2.7)&&(dPhiHBB>0.2)&&(Mw>50000)&&(dPhiHttMET<1))", "SAMEHIST");} //ttbar
      else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "233468.068*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )<0.3)&&(MtW<60000)&&(sqrt( ((Mw*0.001-80.4)/(Mw*0.001)) * ((Mw*0.001-80.4)/(Mw*0.001)) + ((Mt*0.001-172.5)/(Mt*0.001)) * ((Mt*0.001-172.5)/(Mt*0.001)) )<2.7)&&(dPhiHBB>0.2)&&(Mw>50000)&&(dPhiHttMET<1))", "SAMEHIST");} //VBFSM

    }
    
    for(int i = 0; i<n_smp; i++){
        if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "233468.068*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )<0.3)&&(MtW<60000)&&(sqrt( ((Mw*0.001-80.4)/(Mw*0.001)) * ((Mw*0.001-80.4)/(Mw*0.001)) + ((Mt*0.001-172.5)/(Mt*0.001)) * ((Mt*0.001-172.5)/(Mt*0.001)) )<2.7)&&(dPhiHBB>0.2)&&(Mw>50000)&&(dPhiHttMET<1))", "SAMEHIST");} //VBFSM
    }
   ...
   TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h6_1 = new TH1F("h6_1","Quadratic Sum from left",20,0,4); //left
    ...
    for (int j=1; j<=20; j++) {
     ...
     TH1F *h6_2 = new TH1F("h6_2","Quadratic Sum from right",20,0,4); //right
    ...
    for (int j=20; j>=1; j--) {
      ...
      TGaxis*axis6 = new TGaxis(4,0,4,6000,0,rightmax6,510,"+L");
    ...
    //   ===========================================================   pTtautau   ===========================================================
      ...
      for (int i=0; i<n_smp; i++){
        h_nm = h_title[i].c_str();
        h_hist[i] = new TH1F(h_nm, "",50,0,1000);
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h8_1 = new TH1F("h8_1","Quadratic Sum from left",50,0,1000); //left
    ...
    for (int j=1; j<=50; j++) {
     ...
     TH1F *h8_2 = new TH1F("h8_2","Quadratic Sum from right",50,0,1000); //right
    ...
    for (int j=50; j>=1; j--) {
      ...
      TGaxis*axis8 = new TGaxis(1000,0,1000,5500,0,rightmax8,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h19_1 = new TH1F("h19_1","Quadratic Sum from left",30,0,600); //left
    ...
    for (int j=1; j<=30; j++) {
     ...
     TH1F *h19_2 = new TH1F("h19_2","Quadratic Sum from right",30,0,600); //right
    ...
    for (int j=30; j>=1; j--) {
      ...
      TGaxis*axis19 = new TGaxis(600,0,600,10000,0,rightmax19,510,"+L");
    ...
    TH1F *h9_1 = new TH1F("h9_1","Quadratic Sum from left",30,0,600); //left
    ...
    TH1F *h9_2 = new TH1F("h9_2","Quadratic Sum from right",30,0,600); //right
    ...
    for (int j=30; j>=1; j--) {
      ...
      TGaxis*axis9 = new TGaxis(600,0,600,20000,0,rightmax9,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h10_1 = new TH1F("h10_1","Quadratic Sum from left",30,0,600); //left
    ...
    TH1F *h10_2 = new TH1F("h10_2","Quadratic Sum from right",30,0,600); //right
    ...
    TGaxis*axis10 = new TGaxis(600,0,600,12000,0,rightmax10,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
          ...
          TH1F *h11_1 = new TH1F("h11_1","Quadratic Sum from left",20,0,1000); //left
     ...
     //cout << " " << endl;
          ...
          TH1F *h11_2 = new TH1F("h11_2","Quadratic Sum from right",20,0,1000); //right
      ...
      float scale11 = 25000 / rightmax11;
      h11_1->Scale(scale11);
      h11_1->Draw("SAMEHIST");
      ...
      TGaxis*axis11 = new TGaxis(1000,0,1000,25000,0,rightmax11,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h15_2 = new TH1F("h15_2","Quadratic Sum from right",25,0,5); //right
      ...
      TGaxis*axis15 = new TGaxis(5,0,5,7000,0,rightmax15,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h21_1 = new TH1F("h21_1","Quadratic Sum from left",20,0,1000); //left
     ...
     TH1F *h21_2 = new TH1F("h21_2","Quadratic Sum from right",20,0,1000); //right
      ...
      float scale21 = 15000 / rightmax21;
      h21_1->Scale(scale21);
      h21_1->Draw("SAMEHIST");
      ...
      TGaxis*axis21 = new TGaxis(1000,0,1000,15000,0,rightmax21,510,"+L");
    ...
    //   ===========================================================   pTVBFj2   ===========================================================
      ...
      for (int i=0; i<n_smp; i++){
        h_nm = h_title[i].c_str();
        h_hist[i] = new TH1F(h_nm, "",40,0,400);
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
          ...
          TH1F *h22_1 = new TH1F("h22_1","Quadratic Sum from left",40,0,400); //left
     ...
     //cout << " " << endl;
          ...
          TH1F *h22_2 = new TH1F("h22_2","Quadratic Sum from right",40,0,400); //right
      ...
      TGaxis*axis22 = new TGaxis(400,0,400,15000,0,rightmax22,510,"+L");
    ...
    TGaxis*axis33 = new TGaxis(3.5,0,3.5,5000,0,rightmax33,510,"+L");
    ...
    TH1F *h34_2 = new TH1F("h34_2","Quadratic Sum from right",20,0,3.5); //right
      ...
      float scale34 = 10000 / rightmax34;
      h34_1->Scale(scale34);
      h34_1->Draw("SAMEHIST");
    ...
    TGaxis*axis34 = new TGaxis(3.5,0,3.5,10000,0,rightmax34,510,"+L");
    ...
    TH1F *h36_1 = new TH1F("h36_1","Quadratic Sum from left",40,0,2000); //left
    ...
    TH1F *h36_2 = new TH1F("h36_2","Quadratic Sum from right",40,0,2000); //right
    ...
    double EE_r_36 = 0;
     ...
     for (int j=40; j>=1; j--) {
      ...
      TGaxis*axis36 = new TGaxis(2000,0,2000,11000,0,rightmax36,510,"+L");
    ...
    TH1F *h37_1 = new TH1F("h37_1","Quadratic Sum from left",40,0,2000); //left
    ...
    TH1F *h37_2 = new TH1F("h37_2","Quadratic Sum from right",40,0,2000); //right
    ...
    TGaxis*axis37 = new TGaxis(2000,0,2000,6000,0,rightmax37,510,"+L");
    ...
    TH1F *h41_1 = new TH1F("h41_1","Quadratic Sum from left",40,0,400); //left
    ...
    TH1F *h41_2 = new TH1F("h41_2","Quadratic Sum from right",40,0,400); //right
    ...
    TGaxis*axis41 = new TGaxis(400,0,400,8000,0,rightmax41,510,"+L");
    ...
    TH1F *h42_1 = new TH1F("h42_1","Quadratic Sum from left",30,0,600); //left
    ...
    TH1F *h42_2 = new TH1F("h42_2","Quadratic Sum from right",30,0,600); //right
      ...
      float scale42 = 15000 / rightmax42;
      h42_1->Scale(scale42);
      h42_1->Draw("SAMEHIST");
    ...
    TGaxis*axis42 = new TGaxis(600,0,600,15000,0,rightmax42,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      TGaxis*axis44 = new TGaxis(2000,0,2000,12000,0,rightmax44,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      TGaxis*axis45 = new TGaxis(600,0,600,9000,0,rightmax45,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
          ...
          TH1F *h47_1 = new TH1F("h47_1","Quadratic Sum from left",40,0,400); //left
     ...
     //cout << " " << endl;
          ...
          TH1F *h47_2 = new TH1F("h47_2","Quadratic Sum from right",40,0,400); //right
      ...
      TGaxis*axis47 = new TGaxis(400,0,400,5000,0,rightmax47,510,"+L");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      TGaxis*axis48 = new TGaxis(7,0,7,3000,0,rightmax48,510,"+L");
    ...
    //   ===========================================================   Xhh   ===========================================================
      ...
      for (int i=0; i<n_smp; i++){ hist_draw[i]="sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )>>"+h_title[i]; }
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     entries_VBFSM = h_hist[1]->GetEntries();
     yields_VBFSM = h_hist[1]->Integral() / 233468.068; // multiply this factor on VBFSM (plot)
     myfile<<"\t" <<h_title[1] <<"\t \t"<<entries_VBFSM<<"\t \t"<<yields_VBFSM<<endl;
     myfile <<"                                                                                   "<<endl;
