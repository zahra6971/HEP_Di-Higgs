...
void SLT_significance_111p5_ttbar(){
  ...
  string h_titles[n_smp] = { "ttbar", "VBF111p5 x 2919.53" };  // only for legend 2919.53
  ...
  //   ===========================================================   pTBB   ===========================================================
   ...
   TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
    ...
    for (int j=60; j>=1; j--) {
      ...
      c19 -> SaveAs("dPtLepTau_111p5.pdf");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      c12 -> SaveAs("dPhiLepTau_111p5.pdf");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h15_2 = new TH1F("h15_2","Quadratic Sum from right",25,0,5); //right
      ...
      c15 -> SaveAs("dEtaLepTau_111p5.pdf");
    ...
    TGaxis*axis26 = new TGaxis(10,0,10,4500,0,rightmax26,510,"+L");
      ...
      c26 -> SaveAs("dEtaVBFjj_111p5.pdf");
    ...
    TGaxis*axis32 = new TGaxis(3.5,0,3.5,3000,0,rightmax32,510,"+L");
      ...
      c32 -> SaveAs("dPhiLep0MET_111p5.pdf");
    ...
    TGaxis*axis33 = new TGaxis(3.5,0,3.5,3500,0,rightmax33,510,"+L");
      ...
      c33 -> SaveAs("dPhiLep1MET_111p5.pdf");
    ...
    TGaxis*axis34 = new TGaxis(3.5,0,3.5,4000,0,rightmax34,510,"+L");
      ...
      c34 -> SaveAs("dPhiHttMET_111p5.pdf");
    ...
    TGaxis*axis35 = new TGaxis(3.5,0,3.5,4200,0,rightmax35,510,"+L");
      ...
      c35 -> SaveAs("dPhiHbbMET_111p5.pdf");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      c48 -> SaveAs("dPhiVBFjj_111p5.pdf");
    ...
    // =====================================================================================================================
        /*
    int entries;
    int entries_VBF111p5;
    float yields;
    float yields_VBF111p5;
    int sum_entries;
    int sum_entries_noVBF111p5;
    float sum_yields_noVBF111p5;
    float sum_yields;
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     entries_VBF111p5 = h_hist[1]->GetEntries();
     yields_VBF111p5 = h_hist[1]->Integral() / 2919.53; // multiply this factor on VBF111p5 (plot)
     myfile<<"\t" <<h_title[1] <<"\t \t"<<entries_VBF111p5<<"\t \t"<<yields_VBF111p5<<endl;
     myfile <<"                                                                                   "<<endl;
