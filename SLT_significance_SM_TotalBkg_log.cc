...
void SLT_significance_SM_TotalBkg_log(){
  ...
  string hist_draw[n_smp];
      ...
      //   ===========================================================   pTBB   ===========================================================
        ...
        for (int i=0; i<n_smp; i++){
          ...
          h_hist[i]->SetMaximum(10000); //6500
        }
        ...
        for(int i = 0; i<n_smp; i++){
          ...
          if (i == 3 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==1))",  "SAMEHIST");} //Fake
            ...
            else if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBFSM
       ...
       for(int i = 0; i<n_smp; i++){ if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} } //VBFSM
     ...
     //cout << " ============== significance From left ============== " << endl;
       ...
       TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
        ...
        gStyle->SetOptStat(kFALSE);
          ...
          h_hist[i]->SetMaximum(12000); //6500
        }
    ...
    TH1F *h19_2 = new TH1F("h19_2","Quadratic Sum from right",60,0,1200); //right
       ...
       for (int j=60; j>=1; j--) {
          ...
          c19 -> SaveAs("dPtLepTau_SM_log.pdf");
        ...
        gStyle->SetOptStat(kFALSE);
          ...
          h_hist[i]->SetMaximum(20000); //6500
        }
    ...
    TH1F *h12_2 = new TH1F("h12_2","Quadratic Sum from right",20,0,3.5); //right
       ...
       for (int j=20; j>=1; j--) {
          ...
          c12 -> SaveAs("dPhiLepTau_SM_log.pdf");
    ...
    TH1F *h15_2 = new TH1F("h15_2","Quadratic Sum from right",25,0,5); //right
       ...
       for (int j=25; j>=1; j--) {
          ...
          float scale15 = 10000 / rightmax15;
          h15_1->Scale(scale15);
          h15_1->Draw("SAMEHIST");
          ...
          TGaxis*axis15 = new TGaxis(5,0,5,10000,0,rightmax15,510,"+L");
          ...
          c15 -> SaveAs("dEtaLepTau_SM_log.pdf");
    ...
    TH1F *h18_2 = new TH1F("h18_2","Quadratic Sum from right",30,0,6); //right
       ...
       for (int j=30; j>=1; j--) {
          ...
          c18 -> SaveAs("dRLepTau_SM_log.pdf");
    ...
    TH1F *h21_2 = new TH1F("h21_2","Quadratic Sum from right",40,0,2000); //right
       ...
       for (int j=40; j>=1; j--) {
        ...
        gStyle->SetOptStat(kFALSE);
          ...
          h_hist[i]->SetMaximum(15000); //6500
        }
    ...
    TH1F *h22_2 = new TH1F("h22_2","Quadratic Sum from right",75,0,1500); //right
       ...
       for (int j=75; j>=1; j--) {
        ...
        gStyle->SetOptStat(kFALSE);
          ...
          h_hist[i]->SetMaximum(13000); //6500
        }
    ...
    TH1F *h24_2 = new TH1F("h24_2","Quadratic Sum from right",35,-3.5,3.5); //right
       ...
       for (int j=35; j>=1; j--) {
        ...
        TGaxis*axis24 = new TGaxis(3.5,0,3.5,1400,0,rightmax24,510,"+L");
          ...
          c24 -> SaveAs("phiVBFj1_SM_log.pdf");
    ...
    TH1F *h25_2 = new TH1F("h25_2","Quadratic Sum from right",35,-3.5,3.5); //right
       ...
       for (int j=35; j>=1; j--) {
        ...
        TGaxis*axis25 = new TGaxis(3.5,0,3.5,1400,0,rightmax25,510,"+L");
          ...
          c25 -> SaveAs("phiVBFj2_SM_log.pdf");
    ...
    TH1F *h26_2 = new TH1F("h26_2","Quadratic Sum from right",20,0,10); //right
       ...
       for (int j=20; j>=1; j--) {
        ...
        TGaxis*axis26 = new TGaxis(10,0,10,4500,0,rightmax26,510,"+L");
          ...
          c26 -> SaveAs("dEtaVBFjj_SM_log.pdf");
    ...
    TH1F *h27_2 = new TH1F("h27_2","Quadratic Sum from right",21,-5.04,5.04); //right
       ...
       for (int j=21; j>=1; j--) {
        ...
        TGaxis*axis27 = new TGaxis(5.04,0,5.04,3200,0,rightmax27,510,"+L");
          ...
          c27 -> SaveAs("etaVBFj1_SM_log.pdf");
    ...
    TH1F *h28_2 = new TH1F("h28_2","Quadratic Sum from right",21,-5.04,5.04); //right
       ...
       for (int j=21; j>=1; j--) {
        ...
        TGaxis*axis28 = new TGaxis(5.04,0,5.04,3200,0,rightmax28,510,"+L");
          ...
          c28 -> SaveAs("etaVBFj2_SM_log.pdf");
    ...
    TH1F *h32_2 = new TH1F("h32_2","Quadratic Sum from right",20,0,3.5); //right
       ...
       for (int j=20; j>=1; j--) {
        ...
        TGaxis*axis32 = new TGaxis(3.5,0,3.5,5000,0,rightmax32,510,"+L");
          ...
          c32 -> SaveAs("dPhiLep0MET_SM_log.pdf");
    ...
    TH1F *h33_2 = new TH1F("h33_2","Quadratic Sum from right",20,0,3.5); //right
       ...
       for (int j=20; j>=1; j--) {
        ...
        TGaxis*axis33 = new TGaxis(3.5,0,3.5,5000,0,rightmax33,510,"+L");
          ...
          c33 -> SaveAs("dPhiLep1MET_SM_log.pdf");
    ...
    TH1F *h34_2 = new TH1F("h34_2","Quadratic Sum from right",20,0,3.5); //right
       ...
       for (int j=20; j>=1; j--) {
        ...
        TGaxis*axis34 = new TGaxis(3.5,0,3.5,10000,0,rightmax34,510,"+L");
          ...
          c34 -> SaveAs("dPhiHttMET_SM_log.pdf");
    ...
    TH1F *h35_2 = new TH1F("h35_2","Quadratic Sum from right",20,0,3.5); //right
       ...
       for (int j=20; j>=1; j--) {
        ...
        TGaxis*axis35 = new TGaxis(3.5,0,3.5,4200,0,rightmax35,510,"+L");
          ...
          c35 -> SaveAs("dPhiHbbMET_SM_log.pdf");
        ...
        gStyle->SetOptStat(kFALSE);
          ...
          for (int i=0; i<n_smp; i++){
              ...
              h_hist[i]->GetYaxis()->SetTitle("Events/ 50 GeV");
              //h_hist[i]->GetXaxis()->SetRangeUser(0, 500);
              //h_hist[i]->GetYaxis()->SetRangeUser(0, 11000); //16000
          h_hist[i]->SetMaximum(11000); //6500
        }
       ...
       for (int j=88; j>=1; j--) {
        ...
        gStyle->SetOptStat(kFALSE);
          ...
          for (int i=0; i<n_smp; i++){
            ...
            h_hist[i]->GetYaxis()->SetTitle("Events/ 0.175");//
            //h_hist[i]->GetXaxis()->SetRangeUser(0, 500);
            //h_hist[i]->GetYaxis()->SetRangeUser(0, 4000); //3000
          h_hist[i]->SetMaximum(6000); //6500
        }
    ...
    TH1F *h38_2 = new TH1F("h38_2","Quadratic Sum from right",20,0,3.5); //right
       ...
       for (int j=20; j>=1; j--) {
        ...
        TGaxis*axis38 = new TGaxis(3.5,0,3.5,6000,0,rightmax38,510,"+L");
    ...
    TH1F *h41_2 = new TH1F("h41_2","Quadratic Sum from right",85,0,850); //right
       ...
       for (int j=85; j>=1; j--) {
        ...
        TGaxis*axis41 = new TGaxis(850,0,850,7000,0,rightmax41,510,"+L");
    ...
    TH1F *h47_2 = new TH1F("h47_2","Quadratic Sum from right",100,0,2000); //right
       ...
       for (int j=100; j>=1; j--) {
          ...
          TGaxis*axis47 = new TGaxis(2000,0,2000,8000,0,rightmax47,510,"+L");
    ...
    TH1F *h60_2 = new TH1F("h60_2","Quadratic Sum from right",35,0,7); //right
       ...
       for (int j=35; j>=1; j--) {
         ...
         TGaxis*axis60 = new TGaxis(7,0,7,5000,0,rightmax60,510,"+L");
         ...
         c60 -> SaveAs("dPhiVBFjj_SM_log.pdf");
    ...
    TH1F *h50_1 = new TH1F("h50_1","Quadratic Sum from left",45,0,9); //left
    ...
    TH1F *h50_2 = new TH1F("h50_2","Quadratic Sum from right",45,0,9); //right
       ...
       for (int j=45; j>=1; j--) {
          ...
          TGaxis*axis50 = new TGaxis(9,0,9,5000,0,rightmax50,510,"+L");
          ...
          c50 -> SaveAs("dEtaHH_SM_log.pdf");
      

        //  ----------------------------- ps file -----------------------------
        
          
        TPostScript *ps = new TPostScript("VBF_plots_total_bkg_SM_log.ps",112);
    ...
    cout << " dPhiVBFjj : " <<" S = " << QuadraticSum_r_60 << " E = " << EE_r_60 << endl;
    ...
    cout << " dEtaHH : " <<" S = " << QuadraticSum_r_50 << " E = " << EE_r_50 << endl;
