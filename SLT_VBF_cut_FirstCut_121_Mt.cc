...
void SLT_VBF_cut_FirstCut_121_Mt(){

  const int n_smp = 10;
  string smp_tree[n_smp] = { "SMH", "diboson", "DY", "fake", "Z", "W", "Ztt", "singletop", "ttbar", "VBF121" };
  string smp;
  TChain  *chain_smp[n_smp];
  
  string pwd = "SLT_job_SR_data18/Ntuple/"; // path to input files
  string ana_tag = "FinalNtuple.TauLH.";
  string smp_names[n_smp] = { "SM_H", "diboson", "DY", "Fake", "Zll", "W", "Ztautau1", "singletop", "ttbar", "VBF.hh_bbtt_vbf_lh_l1cvv2cv1." };
  ...
  string h_titles[n_smp] = { "SM H", "diboson", "DY", "Fake", "Z", "Wl#nu", "Z#tau#tau", "single top", "ttbar", "VBF121 x 10390.68" };  // only for legend

  string h_title[n_smp] = { "SMH", "diboson", "DY", "Fake", "Z", "W", "Ztt", "singletop", "ttbar", "VBF121" };
  ...
  string hist_draw[n_smp];
    ...
    TCut factor = "10390.68";
    
    // SM cut flow
    /*TCut Mhh = "Mhh>540000";
    TCut mBB = "mBB>80000";
    TCut dEtaLepTau = "abs(TauEta-LepEta)<1.2";
    ...
    for (int k=0;k<n_cut1;k++) {
      ...
      h_hist[9]->SetLineColor(kRed); h_hist[9]->SetMarkerColor(kRed); //VBF121
      ...
      for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut1_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut1_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut1_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut1_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut1_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut1_1[k]), "SAMEHIST");} //VBF121
        }
    ...
    TH1F *h11 = new TH1F("h11","Quadratic Sum from left",40,0,2000); //left
     ...
     float Sum_l_1 = 0;
      ...
      for (int j=1; j<=40; j++) {
         ...
         S_l_1 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    TH1F *h12 = new TH1F("h12","Quadratic Sum from right",40,0,2000); //right
     ...
     float Sum_r_1 = 0;
      ...
      for (int j=40; j>=1; j--) {
        ...
        S_r_1 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut2_2[n_cut2] = { "dEtaHBB>0.2", "dEtaHBB>0.4", "dEtaHBB>0.6", "dEtaHBB>0.8", "dEtaHBB>1 ", "dEtaHBB>1.2", "dEtaHBB>1.4", "dEtaHBB>1.6", "dEtaHBB>1.8", "dEtaHBB>2", "dEtaHBB>2.2", "dEtaHBB>2.4", "dEtaHBB>2.6", "dEtaHBB>2.8", "dEtaHBB>3", "dEtaHBB>3.2", "dEtaHBB>3.4", "dEtaHBB>3.6", "dEtaHBB>3.8", "dEtaHBB>4", "dEtaHBB>4.2", "dEtaHBB>4.4", "dEtaHBB>4.6","dEtaHBB>4.8", "dEtaHBB>5",  "dEtaHBB>5.2" };
      ...
      for (int k=0;k<n_cut2;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut2_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut2_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut2_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut2_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut2_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut2_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h21 = new TH1F("h21","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_2 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_2 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h22 = new TH1F("h22","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_2 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_2 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut3_2[n_cut3] = { "dEtaLepTau<0.2", "dEtaLepTau<0.4", "dEtaLepTau<0.6", "dEtaLepTau<0.8", "dEtaLepTau<1 ", "dEtaLepTau<1.2", "dEtaLepTau<1.4", "dEtaLepTau<1.6", "dEtaLepTau<1.8", "dEtaLepTau<2", "dEtaLepTau<2.2", "dEtaLepTau<2.4", "dEtaLepTau<2.6", "dEtaLepTau<2.8", "dEtaLepTau<3", "dEtaLepTau<3.2", "dEtaLepTau<3.4", "dEtaLepTau<3.6", "dEtaLepTau<3.8", "dEtaLepTau<4", "dEtaLepTau<4.2", "dEtaLepTau<4.4", "dEtaLepTau<4.6","dEtaLepTau<4.8" };
      ...
      for (int k=0;k<n_cut3;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut3_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut3_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut3_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut3_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut3_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut3_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h31 = new TH1F("h31","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_3 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_3 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h32 = new TH1F("h32","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_3 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_3 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut4_2[n_cut4] = { "dEtaVBFjj>1 ", "dEtaVBFjj>1.2", "dEtaVBFjj>1.4", "dEtaVBFjj>1.6", "dEtaVBFjj>1.8", "dEtaVBFjj>2", "dEtaVBFjj>2.2", "dEtaVBFjj>2.4", "dEtaVBFjj>2.6", "dEtaVBFjj>2.8", "dEtaVBFjj>3", "dEtaVBFjj>3.2", "dEtaVBFjj>3.4", "dEtaVBFjj>3.6", "dEtaVBFjj>3.8", "dEtaVBFjj>4", "dEtaVBFjj>4.2", "dEtaVBFjj>4.4", "dEtaVBFjj>4.6","dEtaVBFjj>4.8", "dEtaVBFjj>5", "dEtaVBFjj>5.2", "dEtaVBFjj>5.4", "dEtaVBFjj>5.6", "dEtaVBFjj>5.8", "dEtaVBFjj>6" };
      ...
      for (int k=0;k<n_cut4;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut4_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut4_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut4_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut4_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut4_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut4_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h41 = new TH1F("h41","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_4 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_4 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h42 = new TH1F("h42","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_4 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_4 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut5_2[n_cut5] = { "dPhiBB<0.2", "dPhiBB<0.4", "dPhiBB<0.6", "dPhiBB<0.8", "dPhiBB<1", "dPhiBB<1.2", "dPhiBB<1.4", "dPhiBB<1.6", "dPhiBB<1.8", "dPhiBB<2", "dPhiBB<2.2", "dPhiBB<2.4", "dPhiBB<2.6", "dPhiBB<2.8", "dPhiBB<3", "dPhiBB<3.2" };
      ...
      for (int k=0;k<n_cut5;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut5_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut5_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut5_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut5_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut5_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut5_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h51 = new TH1F("h51","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_5 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_5 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h52 = new TH1F("h52","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_5 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_5 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut6_2[n_cut6] = { "dPhiHBB>0.2", "dPhiHBB>0.4", "dPhiHBB>0.6", "dPhiHBB>0.8", "dPhiHBB>1", "dPhiHBB>1.2", "dPhiHBB>1.4", "dPhiHBB>1.6", "dPhiHBB>1.8", "dPhiHBB>2", "dPhiHBB>2.2", "dPhiHBB>2.4", "dPhiHBB>2.6", "dPhiHBB>2.8", "dPhiHBB>3", "dPhiHBB>3.2" };
      ...
      for (int k=0;k<n_cut6;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut6_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut6_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut6_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut6_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut6_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut6_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h61 = new TH1F("h61","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_6 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_6 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h62 = new TH1F("h62","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_6 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_6 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut7_2[n_cut7] = { "dPhiHbbMET>0.2", "dPhiHbbMET>0.4", "dPhiHbbMET>0.6", "dPhiHbbMET>0.8", "dPhiHbbMET>1", "dPhiHbbMET>1.2", "dPhiHbbMET>1.4", "dPhiHbbMET>1.6", "dPhiHbbMET>1.8", "dPhiHbbMET>2", "dPhiHbbMET>2.2", "dPhiHbbMET>2.4", "dPhiHbbMET>2.6", "dPhiHbbMET>2.8", "dPhiHbbMET>3", "dPhiHbbMET>3.2" };
      ...
      for (int k=0;k<n_cut7;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut7_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut7_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut7_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut7_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut7_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut7_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h71 = new TH1F("h71","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_7 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_7 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h72 = new TH1F("h72","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_7 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_7 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut8_2[n_cut8] = { "dPhiHttMET<0.2", "dPhiHttMET<0.4", "dPhiHttMET<0.6", "dPhiHttMET<0.8", "dPhiHttMET<1", "dPhiHttMET<1.2", "dPhiHttMET<1.4", "dPhiHttMET<1.6", "dPhiHttMET<1.8", "dPhiHttMET<2", "dPhiHttMET<2.2", "dPhiHttMET<2.4", "dPhiHttMET<2.6", "dPhiHttMET<2.8", "dPhiHttMET<3", "dPhiHttMET<3.2" };
      ...
      for (int k=0;k<n_cut8;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut8_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut8_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut8_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut8_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut8_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut8_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h81 = new TH1F("h81","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_8 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_8 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h82 = new TH1F("h82","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_8 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_8 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut9_2[n_cut9] = { "dPhiLep0MET<0.2", "dPhiLep0MET<0.4", "dPhiLep0MET<0.6", "dPhiLep0MET<0.8", "dPhiLep0MET<1", "dPhiLep0MET<1.2", "dPhiLep0MET<1.4", "dPhiLep0MET<1.6", "dPhiLep0MET<1.8", "dPhiLep0MET<2", "dPhiLep0MET<2.2", "dPhiLep0MET<2.4", "dPhiLep0MET<2.6", "dPhiLep0MET<2.8", "dPhiLep0MET<3", "dPhiLep0MET<3.2" };
      ...
      for (int k=0;k<n_cut9;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut9_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut9_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut9_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut9_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut9_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut9_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h91 = new TH1F("h91","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_9 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_9 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h92 = new TH1F("h92","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_9 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_9 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    */
    ...
    string cut10_2[n_cut10] = { "dPhiLep1MET<0.2", "dPhiLep1MET<0.4", "dPhiLep1MET<0.6", "dPhiLep1MET<0.8", "dPhiLep1MET<1", "dPhiLep1MET<1.2", "dPhiLep1MET<1.4", "dPhiLep1MET<1.6", "dPhiLep1MET<1.8", "dPhiLep1MET<2", "dPhiLep1MET<2.2", "dPhiLep1MET<2.4", "dPhiLep1MET<2.6", "dPhiLep1MET<2.8", "dPhiLep1MET<3", "dPhiLep1MET<3.2" };
      ...
      for (int k=0;k<n_cut10;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut10_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut10_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut10_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut10_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut10_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut10_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h101 = new TH1F("h101","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_10 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_10 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h102 = new TH1F("h102","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_10 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_10 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut11_2[n_cut11] = { "abs(dPhiLepTau)<0.2", "abs(dPhiLepTau)<0.4", "abs(dPhiLepTau)<0.6", "abs(dPhiLepTau)<0.8", "abs(dPhiLepTau)<1", "abs(dPhiLepTau)<1.2", "abs(dPhiLepTau)<1.4", "abs(dPhiLepTau)<1.6", "abs(dPhiLepTau)<1.8", "abs(dPhiLepTau)<2", "abs(dPhiLepTau)<2.2", "abs(dPhiLepTau)<2.4", "abs(dPhiLepTau)<2.6", "abs(dPhiLepTau)<2.8", "abs(dPhiLepTau)<3", "abs(dPhiLepTau)<3.2" };
      ...
      for (int k=0;k<n_cut11;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut11_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut11_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut11_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut11_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut11_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut11_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h111 = new TH1F("h111","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_11 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_11 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h112 = new TH1F("h112","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_11 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_11 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut13_2[n_cut13] = { "dPtLepTau<10GeV", "dPtLepTau<20GeV", "dPtLepTau<30GeV", "dPtLepTau<40GeV", "dPtLepTau<50GeV", "dPtLepTau<60GeV", "dPtLepTau<70GeV", "dPtLepTau<80GeV", "dPtLepTau<90GeV", "dPtLepTau<100GeV", "dPtLepTau<110GeV", "dPtLepTau<120GeV", "dPtLepTau<130GeV", "dPtLepTau<140GeV", "dPtLepTau<150GeV", "dPtLepTau<160GeV", "dPtLepTau<170GeV", "dPtLepTau<180GeV", "dPtLepTau<190GeV","dPtLepTau<200GeV", "dPtLepTau<210GeV", "dPtLepTau<220GeV", "dPtLepTau<230GeV", "dPtLepTau<240GeV", "dPtLepTau<250GeV", "dPtLepTau<260GeV" };
      ...
      for (int k=0;k<n_cut13;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut13_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut13_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut13_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut13_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut13_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut13_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h131 = new TH1F("h131","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_13 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_13 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h132 = new TH1F("h132","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_13 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_13 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut16_2[n_cut16] = { "dRBB<1 ", "dRBB<1.2", "dRBB<1.4", "dRBB<1.6", "dRBB<1.8", "dRBB<2", "dRBB<2.2", "dRBB<2.4", "dRBB<2.6", "dRBB<2.8", "dRBB<3", "dRBB<3.2", "dRBB<3.4", "dRBB<3.6", "dRBB<3.8" };
      ...
      for (int k=0;k<n_cut16;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut16_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut16_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut16_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut16_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut16_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut16_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h161 = new TH1F("h161","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_16 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_16 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h162 = new TH1F("h162","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_16 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_16 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut17_2[n_cut17] = { "dRHH>1 ", "dRHH>1.2", "dRHH>1.4", "dRHH>1.6", "dRHH>1.8", "dRHH>2", "dRHH>2.2", "dRHH>2.4", "dRHH>2.6", "dRHH>2.8", "dRHH>3", "dRHH>3.2", "dRHH>3.4", "dRHH>3.6", "dRHH>3.8", "dRHH>4", "dRHH>4.2", "dRHH>4.4", "dRHH>4.6","dRHH>4.8", "dRHH>5", "dRHH>5.2", "dRHH>5.4", "dRHH>5.6", "dRHH>5.8", "dRHH>6" };
      ...
      for (int k=0;k<n_cut17;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut17_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut17_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut17_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut17_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut17_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut17_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h171 = new TH1F("h171","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_17 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_17 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h172 = new TH1F("h172","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_17 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_17 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut18_2[n_cut18] = { "dRLepTau<1 ", "dRLepTau<1.2", "dRLepTau<1.4", "dRLepTau<1.6", "dRLepTau<1.8", "dRLepTau<2", "dRLepTau<2.2", "dRLepTau<2.4", "dRLepTau<2.6", "dRLepTau<2.8", "dRLepTau<3", "dRLepTau<3.2", "dRLepTau<3.4", "dRLepTau<3.6", "dRLepTau<3.8", "dRLepTau<4", "dRLepTau<4.2", "dRLepTau<4.4", "dRLepTau<4.6","dRLepTau<4.8", "dRLepTau<5", "dRLepTau<5.2", "dRLepTau<5.4", "dRLepTau<5.6", "dRLepTau<5.8", "dRLepTau<6" };
      ...
      for (int k=0;k<n_cut18;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut18_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut18_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut18_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut18_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut18_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut18_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h181 = new TH1F("h181","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_18 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_18 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h182 = new TH1F("h182","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_18 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_18 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    */
    ...
    string cut19_2[n_cut19] = { "dRVBFjj>1 ", "dRVBFjj>1.2", "dRVBFjj>1.4", "dRVBFjj>1.6", "dRVBFjj>1.8", "dRVBFjj>2", "dRVBFjj>2.2", "dRVBFjj>2.4", "dRVBFjj>2.6", "dRVBFjj>2.8", "dRVBFjj>3", "dRVBFjj>3.2", "dRVBFjj>3.4", "dRVBFjj>3.6", "dRVBFjj>3.8", "dRVBFjj>4", "dRVBFjj>4.2", "dRVBFjj>4.4", "dRVBFjj>4.6","dRVBFjj>4.8", "dRVBFjj>5", "dRVBFjj>5.2", "dRVBFjj>5.4", "dRVBFjj>5.6", "dRVBFjj>5.8", "dRVBFjj>6" };
      ...
      for (int k=0;k<n_cut19;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut19_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut19_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut19_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut19_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut19_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut19_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h191 = new TH1F("h191","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_19 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_19 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h192 = new TH1F("h192","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_19 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_19 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut21_2[n_cut21] = { "abs(etaVBFj1)>0.2", "abs(etaVBFj1)>0.4", "abs(etaVBFj1)>0.6", "abs(etaVBFj1)>0.8", "abs(etaVBFj1)>1", "abs(etaVBFj1)>1.2", "abs(etaVBFj1)>1.4", "abs(etaVBFj1)>1.6", "abs(etaVBFj1)>1.8", "abs(etaVBFj1)>2", "abs(etaVBFj1)>2.2", "abs(etaVBFj1)>2.4", "abs(etaVBFj1)>2.6", "abs(etaVBFj1)>2.8", "abs(etaVBFj1)>3" };
      ...
      for (int k=0;k<n_cut21;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut21_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut21_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut21_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut21_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut21_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut21_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h211 = new TH1F("h211","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_21 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_21 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h212 = new TH1F("h212","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_21 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_21 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut24_2[n_cut24] = { "abs(etaVBFj2)>0.2", "abs(etaVBFj2)>0.4", "abs(etaVBFj2)>0.6", "abs(etaVBFj2)>0.8", "abs(etaVBFj2)>1", "abs(etaVBFj2)>1.2", "abs(etaVBFj2)>1.4", "abs(etaVBFj2)>1.6", "abs(etaVBFj2)>1.8", "abs(etaVBFj2)>2", "abs(etaVBFj2)>2.2", "abs(etaVBFj2)>2.4", "abs(etaVBFj2)>2.6", "abs(etaVBFj2)>2.8", "abs(etaVBFj2)>3" };
      ...
      for (int k=0;k<n_cut24;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut24_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut24_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut24_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut24_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut24_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut24_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h241 = new TH1F("h241","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_24 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_24 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h242 = new TH1F("h242","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_24 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_24 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut27_2[n_cut27] = { "HT>200GeV", "HT>210GeV", "HT>220GeV", "HT>230GeV", "HT>240GeV", "HT>250GeV", "HT>260GeV", "HT>270GeV", "HT>280GeV", "HT>290GeV", "HT>300GeV", "HT>310GeV", "HT>320GeV", "HT>330GeV", "HT>340GeV", "HT>350GeV", "HT>360GeV", "HT>370GeV", "HT>380GeV","HT>390GeV", "HT>400GeV", "HT>410GeV", "HT>420GeV", "HT>430GeV", "HT>440GeV", "HT>450GeV" };
      ...
      for (int k=0;k<n_cut27;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut27_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut27_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut27_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut27_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut27_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut27_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h271 = new TH1F("h271","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_27 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_27 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h272 = new TH1F("h272","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_27 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_27 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut28_2[n_cut28] = { "abs(LepEta)<0.2", "abs(LepEta)<0.4", "abs(LepEta)<0.6", "abs(LepEta)<0.8", "abs(LepEta)<1", "abs(LepEta)<1.2", "abs(LepEta)<1.4", "abs(LepEta)<1.6", "abs(LepEta)<1.8", "abs(LepEta)<2", "abs(LepEta)<2.2", "abs(LepEta)<2.4", "abs(LepEta)<2.6", "abs(LepEta)<2.8", "abs(LepEta)<3" };
      ...
      for (int k=0;k<n_cut28;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut28_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut28_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut28_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut28_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut28_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut28_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h281 = new TH1F("h281","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_28 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_28 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h282 = new TH1F("h282","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_28 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_28 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    */
    ...
    string cut31_2[n_cut31] = { "LepPhi>0.2", "LepPhi>0.4", "LepPhi>0.6", "LepPhi>0.8", "LepPhi>1", "LepPhi>1.2", "LepPhi>1.4", "LepPhi>1.6", "LepPhi>1.8", "LepPhi>2", "LepPhi>2.2", "LepPhi>2.4", "LepPhi>2.6", "LepPhi>2.8", "LepPhi>3" };
      ...
      for (int k=0;k<n_cut31;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut31_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut31_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut31_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut31_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut31_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut31_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h311 = new TH1F("h311","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_31 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_31 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h312 = new TH1F("h312","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_31 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_31 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut32_2[n_cut32] = { "LepPt<10GeV", "LepPt<20GeV", "LepPt<30GeV", "LepPt<40GeV", "LepPt<50GeV", "LepPt<60GeV", "LepPt<70GeV", "LepPt<80GeV", "LepPt<90GeV", "LepPt<100GeV", "LepPt<110GeV", "LepPt<120GeV", "LepPt<130GeV", "LepPt<140GeV", "LepPt<150GeV", "LepPt<160GeV", "LepPt<170GeV", "LepPt<180GeV", "LepPt<190GeV","LepPt<200GeV", "LepPt<210GeV", "LepPt<220GeV", "LepPt<230GeV", "LepPt<240GeV", "LepPt<250GeV", "LepPt<260GeV" };
      ...
      for (int k=0;k<n_cut32;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut32_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut32_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut32_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut32_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut32_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut32_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h321 = new TH1F("h321","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_32 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_32 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h322 = new TH1F("h322","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_32 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_32 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut33_2[n_cut33] = { "mBB>10GeV", "mBB>20GeV", "mBB>30GeV", "mBB>40GeV", "mBB>50GeV", "mBB>60GeV", "mBB>70GeV", "mBB>80GeV", "mBB>90GeV", "mBB>100GeV", "mBB>110GeV", "mBB>120GeV", "mBB>130GeV", "mBB>140GeV", "mBB>150GeV" };
      ...
      for (int k=0;k<n_cut33;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut33_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut33_1[k]),  "SAMEHIST");} //Wlv
          else if( i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut33_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut33_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut33_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut33_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h331 = new TH1F("h331","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_33 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_33 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h332 = new TH1F("h332","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_33 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_33 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut35_2[n_cut35] = { "MET>10GeV", "MET>20GeV", "MET>30GeV", "MET>40GeV", "MET>50GeV", "MET>60GeV", "MET>70GeV", "MET>80GeV", "MET>90GeV", "MET>100GeV", "MET>110GeV", "MET>120GeV", "MET>130GeV", "MET>140GeV", "MET>150GeV", "MET>160GeV", "MET>170GeV", "MET>180GeV", "MET>190GeV","MET>200GeV", "MET>210GeV", "MET>220GeV", "MET>230GeV", "MET>240GeV", "MET>250GeV", "MET>260GeV" };
      ...
      for (int k=0;k<n_cut35;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut35_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut35_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut35_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut35_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut35_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut35_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h351 = new TH1F("h351","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_35 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_35 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h352 = new TH1F("h352","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_35 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_35 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut36_2[n_cut36] = { "METCent>-1.5", "METCent>-1.3", "METCent>-1.1", "METCent>-0.9", "METCent>-0.7", "METCent>-0.5", "METCent>-0.3", "METCent>-0.1", "METCent>0.1", "METCent>0.3", "METCent>0.5", "METCent>0.7", "METCent>0.9", "METCent>1.1", "METCent>1.3" };
      ...
      for (int k=0;k<n_cut36;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut36_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut36_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut36_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut36_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut36_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut36_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h361 = new TH1F("h361","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_36 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_36 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h362 = new TH1F("h362","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_36 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_36 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut37_2[n_cut37] = { "mMMC<80GeV", "mMMC<90GeV", "mMMC<100GeV", "mMMC<110GeV", "mMMC<120GeV", "mMMC<130GeV", "mMMC<140GeV", "mMMC<150GeV", "mMMC<160GeV", "mMMC<170GeV", "mMMC<180GeV", "mMMC<190GeV","mMMC<200GeV" };
      ...
      for (int k=0;k<n_cut37;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut37_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut37_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut37_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut37_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut37_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut37_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h371 = new TH1F("h371","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_37 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_37 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h372 = new TH1F("h372","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_37 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_37 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut38_2[n_cut38] = { "Mhh>200GeV", "Mhh>210GeV", "Mhh>220GeV", "Mhh>230GeV", "Mhh>240GeV", "Mhh>250GeV", "Mhh>260GeV", "Mhh>270GeV", "Mhh>280GeV", "Mhh>290GeV", "Mhh>300GeV", "Mhh>310GeV", "Mhh>320GeV", "Mhh>330GeV", "Mhh>340GeV", "Mhh>350GeV", "Mhh>360GeV", "Mhh>370GeV", "Mhh>380GeV", "Mhh>390GeV", "Mhh>400GeV", "Mhh>410GeV", "Mhh>420GeV", "Mhh>430GeV", "Mhh>440GeV", "Mhh>450GeV", "Mhh>460GeV", "Mhh>470GeV", "Mhh>480GeV", "Mhh>490GeV", "Mhh>500GeV", "Mhh>510GeV", "Mhh>520GeV", "Mhh>530GeV", "Mhh>540GeV", "Mhh>550GeV", "Mhh>560GeV", "Mhh>570GeV", "Mhh>580GeV", "Mhh>590GeV", "Mhh>600GeV", "Mhh>610GeV", "Mhh>620GeV", "Mhh>630GeV", "Mhh>640GeV", "Mhh>650GeV" };
      ...
      for (int k=0;k<n_cut38;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut38_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut38_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut38_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut38_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut38_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut38_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h381 = new TH1F("h381","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_38 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_38 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h382 = new TH1F("h382","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_38 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_38 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut39_2[n_cut39] = { "MT2>10GeV", "MT2>110GeV", "MT2>120GeV", "MT2>130GeV", "MT2>140GeV", "MT2>150GeV", "MT2>160GeV", "MT2>170GeV", "MT2>180GeV", "MT2>190GeV", "MT2>200GeV", "MT2>210GeV", "MT2>220GeV", "MT2>230GeV", "MT2>240GeV", "MT2>250GeV", "MT2>260GeV", "MT2>270GeV", "MT2>280GeV", "MT2>290GeV", "MT2>300GeV", "MT2>310GeV", "MT2>320GeV", "MT2>330GeV" };
      ...
      for (int k=0;k<n_cut39;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut39_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut39_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut39_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut39_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut39_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut39_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h391 = new TH1F("h391","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_39 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_39 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h392 = new TH1F("h392","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_39 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_39 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    */
    ...
    string cut40_2[n_cut40] = { "MtW<30GeV", "MtW<40GeV", "MtW<50GeV", "MtW<60GeV", "MtW<70GeV", "MtW<80GeV", "MtW<90GeV", "MtW<100GeV", "MtW<110GeV", "MtW<120GeV", "MtW<130GeV", "MtW<140GeV", "MtW<150GeV", "MtW<160GeV", "MtW<170GeV", "MtW<180GeV", "MtW<190GeV","MtW<200GeV", "MtW<210GeV", "MtW<220GeV", "MtW<230GeV", "MtW<240GeV", "MtW<250GeV", "MtW<260GeV" };
      ...
      for (int k=0;k<n_cut40;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut40_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut40_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut40_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut40_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut40_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut40_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h401 = new TH1F("h401","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_40 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_40 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h402 = new TH1F("h402","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_40 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_40 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut41_2[n_cut41] = { "mVBFjj>50GeV", "mVBFjj>100GeV", "mVBFjj>150GeV", "mVBFjj>200GeV", "mVBFjj>250GeV", "mVBFjj>300GeV", "mVBFjj>350GeV", "mVBFjj>400GeV", "mVBFjj>450GeV", "mVBFjj>500GeV", "mVBFjj>550GeV", "mVBFjj>600GeV", "mVBFjj>650GeV", "mVBFjj>700GeV", "mVBFjj>750GeV", "mVBFjj>800GeV", "mVBFjj>850GeV", "mVBFjj>900GeV", "mVBFjj>950GeV","mVBFjj>1000GeV", "mVBFjj>1050GeV", "mVBFjj>1100GeV", "mVBFjj>1150GeV", "mVBFjj>1200GeV", "mVBFjj>1250GeV", "mVBFjj>1300GeV" };
      ...
      for (int k=0;k<n_cut41;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut41_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut41_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut41_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut41_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut41_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut41_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h411 = new TH1F("h411","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_41 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_41 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h412 = new TH1F("h412","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_41 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_41 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    */
    ...
    string cut42_2[n_cut42] = { "Mvis<10GeV", "Mvis<20GeV", "Mvis<30GeV", "Mvis<40GeV", "Mvis<50GeV", "Mvis<60GeV", "Mvis<70GeV", "Mvis<80GeV", "Mvis<90GeV", "Mvis<100GeV", "Mvis<110GeV", "Mvis<120GeV", "Mvis<130GeV", "Mvis<140GeV", "Mvis<150GeV", "Mvis<160GeV", "Mvis<170GeV", "Mvis<180GeV", "Mvis<190GeV","Mvis<200GeV", "Mvis<210GeV", "Mvis<220GeV", "Mvis<230GeV", "Mvis<240GeV", "Mvis<250GeV", "Mvis<260GeV" };
      ...
      for (int k=0;k<n_cut42;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut42_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut42_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut42_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut42_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut42_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut42_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h421 = new TH1F("h421","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_42 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_42 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h422 = new TH1F("h422","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_42 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_42 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    */
    ...
    string cut43_2[n_cut43] = { "Mw>10GeV", "Mw>20GeV", "Mw>30GeV", "Mw>40GeV", "Mw>50GeV", "Mw>60GeV", "Mw>70GeV", "Mw>80GeV", "Mw>90GeV", "Mw>100GeV", "Mw>110GeV", "Mw>120GeV", "Mw>130GeV", "Mw>140GeV", "Mw>150GeV", "Mw>160GeV", "Mw>170GeV", "Mw>180GeV", "Mw>190GeV","Mw>200GeV", "Mw>210GeV", "Mw>220GeV", "Mw>230GeV", "Mw>240GeV", "Mw>250GeV", "Mw>260GeV" };
      ...
      for (int k=0;k<n_cut43;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut43_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut43_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut43_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut43_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut43_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut43_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h431 = new TH1F("h431","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_43 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_43 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h432 = new TH1F("h432","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_43 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_43 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut48_2[n_cut48] = { "pTB1>10GeV", "pTB1>20GeV", "pTB1>30GeV", "pTB1>40GeV", "pTB1>50GeV", "pTB1>60GeV", "pTB1>70GeV", "pTB1>80GeV", "pTB1>90GeV", "pTB1>100GeV", "pTB1>110GeV", "pTB1>120GeV", "pTB1>130GeV", "pTB1>140GeV", "pTB1>150GeV", "pTB1>160GeV", "pTB1>170GeV", "pTB1>180GeV", "pTB1>190GeV","pTB1>200GeV", "pTB1>210GeV", "pTB1>220GeV", "pTB1>230GeV", "pTB1>240GeV", "pTB1>250GeV", "pTB1>260GeV" };
      ...
      for (int k=0;k<n_cut48;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut48_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut48_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut48_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut48_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut48_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut48_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h481 = new TH1F("h481","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_48 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_48 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h482 = new TH1F("h482","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_48 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_48 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut49_2[n_cut49] = { "pTB2>30GeV", "pTB2>40GeV", "pTB2>50GeV", "pTB2>60GeV", "pTB2>70GeV", "pTB2>80GeV", "pTB2>90GeV", "pTB2>100GeV", "pTB2>110GeV", "pTB2>120GeV", "pTB2>130GeV", "pTB2>140GeV", "pTB2>150GeV", "pTB2>160GeV", "pTB2>170GeV", "pTB2>180GeV", "pTB2>190GeV","pTB2>200GeV", "pTB2>210GeV", "pTB2>220GeV", "pTB2>230GeV" };
      ...
      for (int k=0;k<n_cut49;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut49_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut49_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut49_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut49_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut49_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut49_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h491 = new TH1F("h491","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_49 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_49 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h492 = new TH1F("h492","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_49 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_49 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut50_2[n_cut50] = { "pTBB>10GeV", "pTBB>20GeV", "pTBB>30GeV", "pTBB>40GeV", "pTBB>50GeV", "pTBB>60GeV", "pTBB>70GeV", "pTBB>80GeV", "pTBB>90GeV", "pTBB>100GeV", "pTBB>110GeV", "pTBB>120GeV", "pTBB>130GeV", "pTBB>140GeV", "pTBB>150GeV", "pTBB>160GeV", "pTBB>170GeV", "pTBB>180GeV", "pTBB>190GeV","pTBB>200GeV", "pTBB>210GeV", "pTBB>220GeV", "pTBB>230GeV", "pTBB>240GeV", "pTBB>250GeV", "pTBB>260GeV" };
      ...
      for (int k=0;k<n_cut50;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut50_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut50_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut50_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut50_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut50_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut50_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h501 = new TH1F("h501","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_50 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_50 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h502 = new TH1F("h502","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_50 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_50 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut52_2[n_cut52] = { "pTtautau>30GeV", "pTtautau>40GeV", "pTtautau>50GeV", "pTtautau>60GeV", "pTtautau>70GeV", "pTtautau>80GeV", "pTtautau>90GeV", "pTtautau>100GeV", "pTtautau>110GeV", "pTtautau>120GeV", "pTtautau>130GeV", "pTtautau>140GeV", "pTtautau>150GeV", "pTtautau>160GeV", "pTtautau>170GeV", "pTtautau>180GeV", "pTtautau>190GeV","pTtautau>200GeV", "pTtautau>210GeV", "pTtautau>220GeV", "pTtautau>230GeV", "pTtautau>240GeV", "pTtautau>250GeV", "pTtautau>260GeV" };
      ...
      for (int k=0;k<n_cut52;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut52_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut52_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut52_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut52_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut52_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut52_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h521 = new TH1F("h521","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_52 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_52 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h522 = new TH1F("h522","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_52 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_52 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut53_2[n_cut53] = { "pTVBFj1>10GeV", "pTVBFj1>20GeV", "pTVBFj1>30GeV", "pTVBFj1>40GeV", "pTVBFj1>50GeV", "pTVBFj1>60GeV", "pTVBFj1>70GeV", "pTVBFj1>80GeV", "pTVBFj1>90GeV", "pTVBFj1>100GeV", "pTVBFj1>110GeV", "pTVBFj1>120GeV", "pTVBFj1>130GeV", "pTVBFj1>140GeV", "pTVBFj1>150GeV", "pTVBFj1>160GeV", "pTVBFj1>170GeV", "pTVBFj1>180GeV", "pTVBFj1>190GeV","pTVBFj1>200GeV", "pTVBFj1>210GeV", "pTVBFj1>220GeV", "pTVBFj1>230GeV", "pTVBFj1>240GeV", "pTVBFj1>250GeV", "pTVBFj1>260GeV" };
      ...
      for (int k=0;k<n_cut53;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut53_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut53_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut53_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut53_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut53_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut53_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h531 = new TH1F("h531","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_53 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_53 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h532 = new TH1F("h532","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_53 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_53 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut54_2[n_cut54] = { "pTVBFj2>10GeV", "pTVBFj2>20GeV", "pTVBFj2>30GeV", "pTVBFj2>40GeV", "pTVBFj2>50GeV", "pTVBFj2>60GeV", "pTVBFj2>70GeV", "pTVBFj2>80GeV", "pTVBFj2>90GeV", "pTVBFj2>100GeV", "pTVBFj2>110GeV", "pTVBFj2>120GeV", "pTVBFj2>130GeV", "pTVBFj2>140GeV", "pTVBFj2>150GeV", "pTVBFj2>160GeV", "pTVBFj2>170GeV", "pTVBFj2>180GeV", "pTVBFj2>190GeV","pTVBFj2>200GeV", "pTVBFj2>210GeV", "pTVBFj2>220GeV", "pTVBFj2>230GeV", "pTVBFj2>240GeV", "pTVBFj2>250GeV", "pTVBFj2>260GeV" };
      ...
      for (int k=0;k<n_cut54;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut54_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut54_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut54_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut54_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut54_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut54_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h541 = new TH1F("h541","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_54 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_54 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h542 = new TH1F("h542","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_54 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_54 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut55_2[n_cut55] = { "abs(TauEta)>0.2", "abs(TauEta)>0.4", "abs(TauEta)>0.6", "abs(TauEta)>0.8", "abs(TauEta)>1", "abs(TauEta)>1.2", "abs(TauEta)>1.4", "abs(TauEta)>1.6", "abs(TauEta)>1.8", "abs(TauEta)>2", "abs(TauEta)>2.2", "abs(TauEta)>2.4", "abs(TauEta)>2.6", "abs(TauEta)>2.8", "abs(TauEta)>3" };
      ...
      for (int k=0;k<n_cut55;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut55_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut55_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut55_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut55_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut55_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut55_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h551 = new TH1F("h551","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_55 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_55 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h552 = new TH1F("h552","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_55 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_55 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut58_2[n_cut58] = { "TauPhi<0.2", "TauPhi<0.4", "TauPhi<0.6", "TauPhi<0.8", "TauPhi<1", "TauPhi<1.2", "TauPhi<1.4", "TauPhi<1.6", "TauPhi<1.8", "TauPhi<2", "TauPhi<2.2", "TauPhi<2.4", "TauPhi<2.6", "TauPhi<2.8", "TauPhi<3" };
      ...
      for (int k=0;k<n_cut58;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut58_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut58_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut58_1[k]), "SAMEHIST");} //ttbar
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut58_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut58_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut58_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h581 = new TH1F("h581","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_58 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_58 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h582 = new TH1F("h582","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_58 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_58 = h_hist[9]->GetBinContent(j); //VBF121
    ...
    string cut59_2[n_cut59] = { "TauPt<10GeV", "TauPt<20GeV", "TauPt<30GeV", "TauPt<40GeV", "TauPt<50GeV", "TauPt<60GeV", "TauPt<70GeV", "TauPt<80GeV", "TauPt<90GeV", "TauPt<100GeV", "TauPt<110GeV", "TauPt<120GeV", "TauPt<130GeV", "TauPt<140GeV", "TauPt<150GeV", "TauPt<160GeV", "TauPt<170GeV", "TauPt<180GeV", "TauPt<190GeV","TauPt<200GeV", "TauPt<210GeV", "TauPt<220GeV", "TauPt<230GeV", "TauPt<240GeV", "TauPt<250GeV", "TauPt<260GeV" };
      ...
      for (int k=0;k<n_cut59;k++) {
        ...
        for(int i = 0; i<n_smp; i++){
          if (i == 3){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && FakeTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut59_1[k]),  "SAMEHIST");} //Fake
          else if (i == 5){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut59_1[k]),  "SAMEHIST");} //Wlv
          else if(i == 8){chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && TrueTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut59_1[k]), "SAMEHIST");} //ttbar
          else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut59_1[k]), "SAMEHIST");} //VBF121
          else chain_smp[i]->Draw(hist_draw[i].c_str(), weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut59_1[k]),  "SAMEHIST");
        }
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), factor*weight*(TwoBTaggedJets && TwoOppositeSignTau && MT2 && dRLepTau && mBB && mVBFjj && LepEta && dPhiLep0MET && Mvis && MtW && cut59_1[k]), "SAMEHIST");} //VBF121
        }
      ...
      TH1F *h591 = new TH1F("h591","Quadratic Sum from left",40,0,2000); //left
       ...
       float Sum_l_59 = 0;
        ...
        for (int j=1; j<=40; j++) {
           ...
           S_l_59 = h_hist[9]->GetBinContent(j); //VBF121
      ...
      TH1F *h592 = new TH1F("h592","Quadratic Sum from right",40,0,2000); //right
       ...
       float Sum_r_59 = 0;
        ...
        for (int j=40; j>=1; j--) {
          ...
          S_r_59 = h_hist[9]->GetBinContent(j); //VBF121
