...
void SLT_significance_SM_TotalBkg(){
  ...
  string h_titles[n_smp] = { "SM H", "diboson", "DY", "Fake_ttbar", "Fake_W", "Zee/#mu#mu", "W", "Z#tau#tau", "single top", "ttbar", "VBFSM x 248633.79" };  // only for legend 248633.79
...
/*
      //   ===========================================================   pTBB   ===========================================================
        ...
        for (int i=0; i<n_smp; i++){
          ...
          h_hist[i]->GetYaxis()->SetRangeUser(0, 7000); //3200
        }
    ...
    for(int i = 0; i<n_smp; i++){ if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "248633.79*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");}  }//VBFSM
     ...
     //cout << " ============== significance From left ============== " << endl;
        ...
        //   ===========================================================   pTB2   ===========================================================
          ...
          for (int i=0; i<n_smp; i++){
            ...
            //h_hist[i]->GetXaxis()->SetRangeUser(0, 500);
            h_hist[i]->GetYaxis()->SetRangeUser(0, 10000); //7200
          }
       ...
       for (int j=20; j>=1; j--) {
        ...
        //   ===========================================================   Mhh   ===========================================================
          ...
          for(int i = 0; i<n_smp; i++){
            ...
            if (i == 3 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==1)&&(sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )<0.3)&&(mVBFjj>350000)&&(Mvis<120000)&&(sqrt( ((Mw*0.001-80.4)/(Mw*0.001)) * ((Mw*0.001-80.4)/(Mw*0.001)) + ((Mt*0.001-172.5)/(Mt*0.001)) * ((Mt*0.001-172.5)/(Mt*0.001)) )<2.3)&&(dEtaLepTau<1.8)&&(dEtaBB<2.2))",  "SAMEHIST");} //Fake_ttbar
    ...
    TH1F *h60_2 = new TH1F("h60_2","Quadratic Sum from right",35,0,7); //right
       ...
       for (int j=35; j>=1; j--) {
         ...
         TGaxis*axis60 = new TGaxis(7,0,7,2000,0,rightmax60,510,"+L");
       ...
       //   ===========================================================   X_HH   ===========================================================
         ...
         for (int i=0; i<n_smp; i++){
           h_nm = h_title[i].c_str();
             ...
             h_hist[i]->GetXaxis()->SetTitle("X_HH");
           h_hist[i]->GetYaxis()->SetTitle("Events/ 0.112");//
           //h_hist[i]->GetXaxis()->SetRangeUser(0, 7);
           h_hist[i]->GetYaxis()->SetRangeUser(0, 14000); //2500
         }
         ...
         for (int i=0; i<n_smp; i++){
             hist_draw[i]="sqrt( ((mMMC*0.001-118)/(mMMC*0.001)) * ((mMMC*0.001-118)/(mMMC*0.001)) + ((mBB*0.001-120)/(mBB*0.001)) * ((mBB*0.001-120)/(mBB*0.001)) )>>"+h_title[i];
         }
   ...
   TH1F *h50_1 = new TH1F("h50_1","Quadratic Sum from left",40,0,4.48); //left
   ...
   TH1F *h50_2 = new TH1F("h50_2","Quadratic Sum from right",40,0,4.48); //right
      ...
      for (int j=40; j>=1; j--) {
         ...
         float rightmax50 = 1.1*h50_1->GetMaximum();
         float scale50 = 14000 / rightmax50;
         h50_1->Scale(scale50);
         h50_1->Draw("SAMEHIST");
         ...
         TGaxis*axis50 = new TGaxis(4.48,0,4.48,14000,0,rightmax50,510,"+L");
         axis50->SetTitle("Quadratic Sum of significance");
         axis50->SetTitleSize(0.03);
         axis50->SetLabelSize(0.025);
         axis50->Draw();
