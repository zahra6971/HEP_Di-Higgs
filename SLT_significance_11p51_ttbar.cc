...
void SLT_significance_11p51_ttbar(){
  ...
  string h_titles[n_smp] = { "ttbar", "VBF11p51 x 42439.38" };  // only for legend 42439.38
  ...
  //   ===========================================================   pTBB   ===========================================================
    ...
    for(int i = 0; i<n_smp; i++){
      ...
      else if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "42439.38*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF11p51

    }
    
    for(int i = 0; i<n_smp; i++){
        if(i == 1){chain_smp[i]->Draw(hist_draw[i].c_str(), "42439.38*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF11p51
    }
   ...
   TH1F *h1_2 = new TH1F("h1_2","Quadratic Sum from right",60,0,1200); //right
    ...
    for (int j=60; j>=1; j--) {
      ...
      c19 -> SaveAs("dPtLepTau_11p51.pdf");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      c12 -> SaveAs("dPhiLepTau_11p51.pdf");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     TH1F *h15_2 = new TH1F("h15_2","Quadratic Sum from right",25,0,5); //right
      ...
      c15 -> SaveAs("dEtaLepTau_11p51.pdf");
    ...
    TGaxis*axis26 = new TGaxis(10,0,10,4500,0,rightmax26,510,"+L");
      ...
      c26 -> SaveAs("dEtaVBFjj_11p51.pdf");
    ...
    TGaxis*axis32 = new TGaxis(3.5,0,3.5,3000,0,rightmax32,510,"+L");
      ...
      c32 -> SaveAs("dPhiLep0MET_11p51.pdf");
    ...
    TGaxis*axis33 = new TGaxis(3.5,0,3.5,3500,0,rightmax33,510,"+L");
      ...
      c33 -> SaveAs("dPhiLep1MET_11p51.pdf");
    ...
    TGaxis*axis34 = new TGaxis(3.5,0,3.5,4000,0,rightmax34,510,"+L");
      ...
      c34 -> SaveAs("dPhiHttMET_11p51.pdf");
    ...
    TGaxis*axis35 = new TGaxis(3.5,0,3.5,4200,0,rightmax35,510,"+L");
      ...
      c35 -> SaveAs("dPhiHbbMET_11p51.pdf");
    ...
    for(int i = 0; i<n_smp; i++){
     ...
     //cout << " " << endl;
      ...
      c48 -> SaveAs("dPhiVBFjj_11p51.pdf");
    ...
    // =====================================================================================================================
        /*
    int entries;
    int entries_VBF11p51;
    float yields;
    float yields_VBF11p51;
    int sum_entries;
    int sum_entries_noVBF11p51;
    float sum_yields_noVBF11p51;
    float sum_yields;
    ...
    myfile <<"                                                                                    "<<endl;
     ...
     entries_VBF11p51 = h_hist[1]->GetEntries();
     yields_VBF11p51 = h_hist[1]->Integral() / 42439.38; // multiply this factor on VBF11p51 (plot)
     myfile<<"\t" <<h_title[1] <<"\t \t"<<entries_VBF11p51<<"\t \t"<<yields_VBF11p51<<endl;
     myfile <<"                                                                                   "<<endl;
