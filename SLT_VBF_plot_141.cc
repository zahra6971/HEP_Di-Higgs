...
void SLT_VBF_plot_141(){
    
    const int n_smp = 11;
    string smp_tree[n_smp] = { "SMH", "diboson", "DY", "ttbar", "W", "Z", "W", "Ztt", "singletop", "ttbar", "VBF141" };
    string smp;
    TChain  *chain_smp[n_smp];
    
    string pwd = "SLT_job_SR_data18/Ntuple/"; // path to input files
    string ana_tag = "FinalNtuple.TauLH.";
    string smp_names[n_smp] = { "SM_H", "diboson", "DY", "ttbar", "W", "Zll", "W", "Ztautau1", "singletop", "ttbar", "VBF.hh_bbtt_vbf_lh_l1cvv4cv1." };
    ...
    string h_titles[n_smp] = { "SM H", "diboson", "DY", "Fake_ttbar", "Fake_W", "Zee/#mu#mu", "W", "Z#tau#tau", "single top", "ttbar", "VBF141 x 1071.801", };  // only for legend
      
    string h_title[n_smp] = { "SMH", "diboson", "DY", "Fake_ttbar", "Fake_W", "Z", "W", "Ztt", "singletop", "ttbar", "VBF141", };
    ...
    string hist_draw[n_smp];
      ...
      //   ===========================================================   pTBB   ===========================================================
        ...
        h_hist[0]->SetLineColor(kOrange+7); h_hist[0]->SetMarkerColor(kOrange+7); h_hist[0]->SetFillColor(kOrange+7); //SM_H
          ...
          h_hist[10]->SetLineColor(kRed); h_hist[10]->SetMarkerColor(kRed); //VBF141
        ...
        for(int i = 0; i<n_smp; i++){
          ...
          if (i == 3 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==1))",  "SAMEHIST");} //Fake
            ...
            else if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF141
        ...
        for(int i = 0; i<n_smp; i++){
            if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF141
        }
       ...
       float Sum_r_1 = 0;
        ...
        //   ===========================================================   dPhiBB   ===========================================================
          ...
          for (int i=0; i<n_smp; i++){
            ...
            //h_hist[i]->GetXaxis()->SetRangeUser(0, 500);
            h_hist[i]->GetYaxis()->SetRangeUser(0, 2800);
          }
         ...
         float Sum_r_5 = 0;
          ...
          TGaxis*axis5 = new TGaxis(3.5,0,3.5,2800,0,rightmax5,510,"+L");
        ...
        //   ===========================================================   dEtaBB   ===========================================================
          ...
          for (int i=0; i<n_smp; i++){
            ...
            //h_hist[i]->GetXaxis()->SetRangeUser(0, 500);
            h_hist[i]->GetYaxis()->SetRangeUser(0, 3500); //3200
          }
         ...
         float Sum_r_6 = 0;
          ...
          TGaxis*axis6 = new TGaxis(3,0,3,3500,0,rightmax6,510,"+L");
        ...
        TGaxis*axis32 = new TGaxis(3.5,0,3.5,6000,0,rightmax32,510,"+L");
          ...
          c32 -> SaveAs("dPhiLep0MET_141.pdf");
        ...
        TGaxis*axis33 = new TGaxis(3.5,0,3.5,3500,0,rightmax33,510,"+L");
          ...
          c33 -> SaveAs("dPhiLep1MET_141.pdf");
        ...
        TGaxis*axis34 = new TGaxis(3.5,0,3.5,8000,0,rightmax34,510,"+L");
        ...
        //   ===========================================================   Mhh   ===========================================================
          ...
          for(int i = 0; i<n_smp; i++){
            ...
            else if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(mBB>90000)&&(mMMC<160000)&&(Mt>190000)&&(mVBFjj>360000)&&(Mw>50000)&&(MtW<110000))", "SAMEHIST");} //VBF141
          ...
          for(int i = 0; i<n_smp; i++){
              if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(mBB>90000)&&(mMMC<160000)&&(Mt>190000)&&(mVBFjj>360000)&&(Mw>50000)&&(MtW<110000))", "SAMEHIST");} //VBF141
          }
        ...
        //   ===========================================================   dPhiHBB   ===========================================================
          ...
          for (int i=0; i<n_smp; i++){
            ...
            h_hist[i]->GetYaxis()->SetTitle("Events/ 0.175");//
            //h_hist[i]->GetXaxis()->SetRangeUser(0, 500);
            h_hist[i]->GetYaxis()->SetRangeUser(0, 5500); //3000
          }
        ...
        TGaxis*axis38 = new TGaxis(3.5,0,3.5,5500,0,rightmax38,510,"+L");
       ...
       */
        ...
        //   ===========================================================   Mt   ===========================================================
          ...
          for(int i = 0; i<n_smp; i++){
            ...
            else if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(mMMC<160000)&&(mBB>70000)&&(dRHH>1.2)&&(abs(TauEta-LepEta)<1.8)&&(MtW<110000))", "SAMEHIST");} //VBF141
          ...
          for(int i = 0; i<n_smp; i++){
              if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(mMMC<160000)&&(mBB>70000)&&(dRHH>1.2)&&(abs(TauEta-LepEta)<1.8)&&(MtW<110000))", "SAMEHIST");} //VBF141
          }
        ...
        TH1F *h50_2 = new TH1F("h50_2","Quadratic Sum from right",40,0,8); //right
         ...
         float Sum_r_50 = 0;
          ...
          c50 -> SaveAs("dEtaHH_141.pdf");
        
       
        //  ----------------------------- ps file -----------------------------
        
        
        TPostScript *ps = new TPostScript("VBFplots_total_bkg_141.ps",112);
    ...
    //   ===========================================================   Mhh   ===========================================================
      ...
      for(int i = 0; i<n_smp; i++){
        ...
        if (i == 3 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==1)&&(mBB>90000)&&(mMMC<160000)&&(Mt>190000)&&(mVBFjj>360000)&&(Mw>50000)&&(MtW<110000))",  "SAMEHIST");} //Fake_ttbar
        else if (i == 4 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==1)&&(mBB>90000)&&(mMMC<160000)&&(Mt>190000)&&(mVBFjj>360000)&&(Mw>50000)&&(MtW<110000))",  "SAMEHIST");} //Fake_W
        else if (i == 6 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==0)&&(mBB>90000)&&(mMMC<160000)&&(Mt>190000)&&(mVBFjj>360000)&&(Mw>50000)&&(MtW<110000))",  "SAMEHIST");} //Wlv
        else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==0)&&(mBB>90000)&&(mMMC<160000)&&(Mt>190000)&&(mVBFjj>360000)&&(Mw>50000)&&(MtW<110000))", "SAMEHIST");} //ttbar
        else if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(mBB>90000)&&(mMMC<160000)&&(Mt>190000)&&(mVBFjj>360000)&&(Mw>50000)&&(MtW<110000))", "SAMEHIST");} //VBF141
    ...
    TH1F *h36_1 = new TH1F("h36_1","Quadratic Sum from left",30,0,3000); //left
     ...
     float Sum_l_36 = 0;
      ...
      for (int j=1; j<=30; j++) {
         ...
         S_l_36 = h_hist[10]->GetBinContent(j); //VBF141
         //cout << " S of each bin = " << S_l_36 << endl;
         B_l_36_9 = h_hist[9]->GetBinContent(j);
         //cout << " B of ttbar of each bin = " << B_l_36_9 << endl;
         B_l_36_8 = h_hist[8]->GetBinContent(j);
    ...
    TH1F *h36_2 = new TH1F("h36_2","Quadratic Sum from right",30,0,3000); //right
     ...
     float Sum_r_36 = 0;
      ...
      for (int j=30; j>=1; j--) {
        ...
        S_r_36 = h_hist[10]->GetBinContent(j); //VBF141
        //cout << " S of each bin = " << S_r_36 << endl;
        B_r_36_9 = h_hist[9]->GetBinContent(j);
        //cout << " B of ttbar of each bin = " << B_r_36_9 << endl;
        B_r_36_8 = h_hist[8]->GetBinContent(j);
    ...
    //   ===========================================================   Mt   ===========================================================
      ...
      for(int i = 0; i<n_smp; i++){
        ...
        if (i == 3 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==1)&&(mMMC<160000))",  "SAMEHIST");} //Fake_ttbar
        else if (i == 4 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==1)&&(mMMC<160000))",  "SAMEHIST");} //Fake_W
        else if (i == 6 ){chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==0)&&(mMMC<160000))",  "SAMEHIST");} //Wlv
        else if(i == 9){chain_smp[i]->Draw(hist_draw[i].c_str(), "(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(isFakeTau==0)&&(mMMC<160000))", "SAMEHIST");} //ttbar
        else if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(mMMC<160000))", "SAMEHIST");} //VBF141
        else chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(mMMC<160000))",  "SAMEHIST");
      ...
      for(int i = 0; i<n_smp; i++){
          if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(1071.801)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0)&&(mMMC<160000))", "SAMEHIST");} //VBF141
      }
    ...
    TH1F *h44_1 = new TH1F("h44_1","Quadratic Sum from left",40,0,2000); //left
     ...
     float Sum_l_44 = 0;
      ...
      for (int j=1; j<=40; j++) {
         ...
         S_l_44 = h_hist[10]->GetBinContent(j); //VBF141
         //cout << " S of each bin = " << S_l_44 << endl;
         B_l_44_9 = h_hist[9]->GetBinContent(j);
         //cout << " B of ttbar of each bin = " << B_l_44_9 << endl;
         B_l_44_8 = h_hist[8]->GetBinContent(j);
    ...
    TH1F *h44_2 = new TH1F("h44_2","Quadratic Sum from right",40,0,2000); //right
     ...
     float Sum_r_44 = 0;
      ...
      for (int j=40; j>=1; j--) {
        ...
        S_r_44 = h_hist[10]->GetBinContent(j); //VBF141
        //cout << " S of each bin = " << S_r_44 << endl;
        B_r_44_9 = h_hist[9]->GetBinContent(j);
        //cout << " B of ttbar of each bin = " << B_r_44_9 << endl;
        B_r_44_8 = h_hist[8]->GetBinContent(j);
    ...
    //   ===========================================================   etaVBFj2   ===========================================================
      ...
      for(int i = 0; i<n_smp; i++){
        ...
        else if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(10390.68)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF121
        else chain_smp[i]->Draw(hist_draw[i].c_str(),"(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))",  "SAMEHIST");
      ...
      for(int i = 0; i<n_smp; i++){
          if(i == 10){chain_smp[i]->Draw(hist_draw[i].c_str(), "(10390.68)*(weight)*((BTag==2)&&((LepQ)*(TauQ)<0))", "SAMEHIST");} //VBF121
      }
     ...
     float Sum_l_28 = 0;
      ...
      for (int j=1; j<=21; j++) {
         ...
         S_l_28 = h_hist[10]->GetBinContent(j); //VBF141
         //cout << " S of each bin = " << S_l_28 << endl;
         B_l_28_9 = h_hist[9]->GetBinContent(j);
         //cout << " B of ttbar of each bin = " << B_l_28_9 << endl;
         B_l_28_8 = h_hist[8]->GetBinContent(j);
     ...
     float Sum_r_28 = 0;
      ...
      for (int j=21; j>=1; j--) {
        ...
        S_r_28 = h_hist[10]->GetBinContent(j); //VBF141
        //cout << " S of each bin = " << S_r_28 << endl;
        B_r_28_9 = h_hist[9]->GetBinContent(j);
        //cout << " B of ttbar of each bin = " << B_r_28_9 << endl;
        B_r_28_8 = h_hist[8]->GetBinContent(j);
    ...
    TGaxis*axis28 = new TGaxis(5.04,0,5.04,1600,0,rightmax28,510,"+L");
      axis28->SetTitle("Quadratic Sum of significance");
      axis28->SetTitleSize(0.03);
      axis28->SetLabelSize(0.025);
      axis28->Draw();
